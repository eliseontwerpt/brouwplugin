...
class Seeder_eliseontwerpt_brouwerbouwer_bjcp_categories extends Seeder
	...
	public function run()
	{
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_categories')->insert([
			...
			'description'			=>	"This category contains modern American ales of average strength and light color that are moderately malty to moderately bitter. ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_categories')->insert([
			'categorie_id'			=>	"19",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_categories')->insert([
			...
			'description'			=>	"This category includes modern American strong ales with a varying balance of malt and listofhops. The category is defined mostly by alcohol strength and a lack of roast. ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_categories')->insert([
			'categorie_id'			=>	"23",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_categories')->insert([
			'categorie_id'			=>	"34",
			'name'			=>	"SPECIALTY BEER",
			'description'			=>	"This is a special category for clone beers.",
		]);
		/**
		 *
		 * ------eliseontwerpt_brouwerbouwer_bjcp_sub_categories------
		 *
		 **/
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"1",
			'sub_categorie_id'			=>	"1A",
			...
			'commercial_examples'			=>	"Bud Light, Coors Light, Keystone Light, Michelob Light, Miller Lite, Old Milwaukee Light",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.2",
			'bugu_max'			=>	"0.36",
			'overall_impression'			=>	"A very pale, highly-carbonated, light_x005F_x0002_bodied, well-attenuated lager with a very neutral flavor profile and low bitterness. Served very cold, it can be a very refreshing and thirst quenching drink.",
			...
			'flavor'			=>	"Relatively neutral palate with a crisp and dry finish and a moderately-low to low grainy or corn-like flavor that might be perceived as sweetness due to the low bitterness. Hop flavor ranges from none to moderately-low levels, and can have a floral, spicy, or herbal quality (although often not strong enough to distinguish). Hop bitterness at low to medium-lowlevel. Balance may vary from slightly malty to slightly bitter, but is relatively close to even. High levels of carbonation may accentuate the crispness of the dry finish. Clean lager fermentation character.",
			...
			'style_comparison'			=>	"Stronger, more flavor and body than a Light American Lager. Less bitterness and flavor than an International Lager. Significantly less flavor, listofhops, and bitterness than traditional European Pilsners.",
			'commercial_examples'			=>	"Budweiser, Coors Original, Grain Belt Premium Lager, Miller High Life, Pabst Blue Ribbon, Special Export",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.19",
			'bugu_max'			=>	"0.36",
			'overall_impression'			=>	"A clean, well-attenuated, flavorful American “lawnmower” beer. Easily drinkable and refreshing, with more character than typical American lagers.required. Hop aroma medium low to none, and can be of any variety although floral, spicy, or herbal notes are most common. Overall, a subtle aroma with neither listofhops nor malt dominating. Low fruity esters are optional.",
			...
			'flavor'			=>	"Low to medium-low hop bitterness. Low to moderate maltiness and sweetness, varying with gravity and attenuation. Usually well-attenuated. Neither malt nor listofhops dominate the palate. A low to moderate corny flavor is commonly found, as is light DMS (optional). Finish can vary from somewhat dry to faintly sweet. Low fruity esters are optional. Low to medium_x005F_x0002_low hop flavor (any variety, but typically floral, spicy, or herbal).",
			'mouthfeel'			=>	"Generally light and crisp, although body can reach medium. Smooth mouthfeel with medium to high attenuation",
			'comments'			=>	" higher attenuation levels can lend a “thirst quenching” quality. High carbonation. ",
			'history'			=>	"Pre-prohibition Cream Ales were slightly stronger, hoppier (including some dry hopping) and more bitter (25-30+ IBUs). These versions should be entered in the historical category. Most commercial_examples are in the 1.050–1.053 OG range, and bitterness rarely rises above 20 IBUs.",
			'characteristic_ingredients'			=>	"A sparkling or present-use ale that existed in the 1800s and survived prohibition. An ale version of the American lager style. Produced by ale brewers to compete with lager brewers in Canada and the Northeast, Mid-Atlantic, and Midwest states. Originally known as sparkling or present use ales, lager strains were (and sometimes still are) used by some brewers, but were not historically mixed with ale strains. Many examples are kräusened to achieve carbonation. Cold conditioning isn’t traditional, although modern brewers sometimes use it.",
			'style_comparison'			=>	"American ingredients most commonly used. A grain bill of six-row malt, or a combination of six-row and North American two-row, is common. Adjuncts can include up to 20% maize in the mash, and up to 20% glucose or other sugars in the boil. Any variety of listofhops can be used for bittering and finishing.",
			'commercial_examples'			=>	"Similar to a Standard American Lager, but with more character.",
			'tags'			=>	"Genesee Cream Ale, Liebotschaner Cream Ale, Little Kings Cream Ale, New Glarus Spotted Cow, Old Style, Sleeman Cream Ale",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"1",
			'sub_categorie_id'			=>	"1D",
			...
			'aroma'			=>	"Low to moderate grainy, bready, or doughy wheat character. A light to moderate malty sweetness is acceptable. Esters can be moderate to none, although should reflect relatively neutral yeast strains",
			'appearance'			=>	" banana is inappropriate. Hop aroma may be low to moderate, and can have a citrusy, spicy, floral, or fruity character. No clove phenols.",
			'flavor'			=>	"Usually pale yellow to gold. Clarity may range from brilliant to hazy with yeast approximating the German weissbier style of beer. Big, long-lasting white head.",
			'mouthfeel'			=>	"Light to moderately-strong bready, doughy, or grainy wheat flavor, which can linger into the finish. May have a moderate malty sweetness or finish quite dry. Low to moderate hop bitterness, which sometimes lasts into the finish. Balance is usually even, but may be slightly bitter. Low to moderate hop flavor (citrusy, spicy, floral, or fruity). Esters can be moderate to none, but should not include banana. No clove phenols. May have a slightly crisp finish.",
			'comments'			=>	"Medium-light to medium body. Medium-high to high carbonation. Slight creaminess is optional",
			'history'			=>	" wheat beers sometimes have a soft, ‘fluffy’ impression.",
			'characteristic_ingredients'			=>	"Different variations exist, from an easy-drinking fairly sweet beer to a dry, aggressively-hopped beer with a strong wheat flavor. American rye beers should be entered in the Alternative Fermentables specialty category.",
			'style_comparison'			=>	"An American craft beer adaptation of the German weissbier style using a cleaner yeast and more listofhops, first widely popularized by Widmer in the mid-1980s.",
			'commercial_examples'			=>	"Clean American ale or lager yeast (German weissbier yeast is inappropriate). Large proportion of wheat malt (often 30–50%, which is lower than is typical in German weissbiers). American, German, or New World listofhops are typical.",
			'tags'			=>	"More hop character and less yeast character than German weissbier. Never with the banana and clove character of German weissbier. Generally can have the same range and balance as Blonde Ales, but with a wheat character as the primary malt flavor.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"2",
			'sub_categorie_id'			=>	"2A",
			...
			'commercial_examples'			=>	"Asahi Super Dry, Birra Moretti, Corona Extra, Devils Backbone Gold Leaf Lager, Full Sail Session Premium Lager, Heineken, Red Stripe, Singha",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'flavor'			=>	"Low to moderate malt profile which can vary from dry to grainy-sweet. Low to moderate levels of caramel and toasty_x005F_x0002_bready notes can be evident. Low to medium-low corny sweetness is optional, but not a fault. Hop bitterness is low to moderate, and hop flavor is low to moderate with a spicy, herbal, or floral character. The balance can be fairly malty to nearly even, with the bitterness becoming more noticeable but not objectionable. The bitterness level can increase if the malt character increases to match. Clean fermentation profile. Finish is moderately dry with a moderately malty aftertaste.",
			'mouthfeel'			=>	"Light to medium body. Medium to high carbonation. Smooth",
			'comments'			=>	" some examples can be creamy.",
			'history'			=>	"A wide spectrum of mass-market Amber lagers developed either independently in various countries, or describing rather generic amber beers that may have had more historical relevance but who eventually changed into an indistinguishable product in modern times.",
			'characteristic_ingredients'			=>	"Varies by country, but generally represents an adaptation of the mass-market International Lager or an evolution of indigenous styles into a more generic product.",
			'style_comparison'			=>	"Two-row or six-row base malt. Color malts such as victory, amber, etc. Caramel malt adjuncts. European or American listofhops or a combination of both.",
			'commercial_examples'			=>	"Less well-developed malt flavor than a Vienna lager, often with an adjunct taste.",
			'tags'			=>	"Brooklyn Lager, Capital Winter Skål, Dos Equis Amber, Schell’s Oktoberfest, Yuengling Lager",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"2",
			'sub_categorie_id'			=>	"2C",
			...
			'appearance'			=>	" may have a light corn character. Medium-low to no roast and caramel malt aroma. Hop aroma may range from none to light spicy or floral hop presence. While a clean fermentation profile is generally most desirable, low levels of yeast character (such as a light apple fruitiness) are not a fault. A light amount of DMS or corn aroma is not a fault.",
			'flavor'			=>	"Deep amber to dark brown with bright clarity and ruby highlights. Foam stand may not be long lasting, and is beige to light tan in color.",
			'mouthfeel'			=>	"Low to medium malty sweetness with medium-low to no caramel and/or roasted malt flavors (and may include hints of coffee, molasses or cocoa). Hop flavor ranges from none to low levels, and is typically floral, spicy, or herbal. Low to medium hop bitterness. May have a very light fruitiness. Moderately crisp finish. The balance is typically somewhat malty. Burnt or moderately strong roasted malt flavors are a defect. ",
			'comments'			=>	"Light to medium-light body. Smooth with a light creaminess. Medium to high carbonation.",
			'history'			=>	"A broad range of international lagers that are darker than pale, and not assertively bitter and/or roasted. ",
			'characteristic_ingredients'			=>	"Darker versions of International Pale Lagers often created by the same large, industrial breweries and meant to appeal to a broad audience. Often either a colored or sweetened adaptation of the standard pale industrial lager, or a more broadly accessible (and inexpensive) version of more traditional dark lagers.",
			'style_comparison'			=>	"Two- or six-row barley, corn, rice, or sugars as adjuncts. Light use of caramel and darker malts. Commercial versions may use coloring agents.",
			'commercial_examples'			=>	"Less flavor and richness than Munich Dunkel, Schwarzbier, or other dark lagers. Frequently uses adjuncts, as is typical of other International Lagers.",
			'tags'			=>	"Baltika #4 Original, Devils Backbone Old Virginia Dark, Dixie Blackened Voodoo, Saint Pauli Girl Dark, San Miguel Dark, Session Black Dark Lager, Shiner Bock",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"3",
			'sub_categorie_id'			=>	"3A",
			...
			'aroma'			=>	"Light to moderate bready-rich malt combined with light to moderate spicy or herbal hop bouquet",
			'appearance'			=>	" the balance between the malt and listofhops may vary. Faint hint of caramel is acceptable. Light (but never intrusive) diacetyl and light, fruity hop-derived esters are acceptable, but need not be present. No sulfur.",
			'flavor'			=>	"Light gold to deep gold color. Brilliant to very clear, with a long-lasting, creamy white head. ",
			'mouthfeel'			=>	"Medium-low to medium bready-rich malt flavor with a rounded, hoppy finish. Low to medium-high spicy or herbal hop flavor. Bitterness is prominent but never harsh. Flavorful and refreshing. Diacetyl or fruity esters are acceptable at low levels, but need not be present and should never be overbearing.",
			'comments'			=>	"Medium-light to medium body. Moderate carbonation. ",
			'history'			=>	"The Czech name of the style is světlé výčepní pivo. ",
			'characteristic_ingredients'			=>	"Josef Groll initially brewed two types of beer in 1842–3, a výčepní and a ležák, with the smaller beer having twice the production",
			'style_comparison'			=>	" Evan Rail speculates that these were probably 10 °P and 12 °P beers, but that the výčepní could have been weaker. This is the most consumed type of beer in the ",
			'commercial_examples'			=>	"Soft water with low sulfate and carbonate content, Saazer-type listofhops, Czech Pilsner malt, Czech lager yeast. Low ion water provides a distinctively soft, rounded hop profile despite high hopping rates. ",
			'tags'			=>	"A lighter-bodied, lower-intensity, refreshing, everyday version of Czech Premium Pale Lager.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"3",
			'sub_categorie_id'			=>	"3B",
			...
			'aroma'			=>	"Medium to medium-high bready-rich malt and medium-low to medium-high spicy, floral, or herbal hop bouquet",
			'appearance'			=>	" though the balance between the malt and listofhops may vary, the interplay is rich and complex. Light diacetyl, or very low fruity hop-derived esters are acceptable, but need not be present. ",
			'flavor'			=>	"Gold to deep gold color. Brilliant to very clear clarity. Dense, long-lasting, creamy white head. ",
			'mouthfeel'			=>	"Rich, complex, bready maltiness combined with a pronounced yet soft and rounded bitterness and floral and spicy hop flavor. Malt and hop flavors are medium to medium_x005F_x0002_high, and the malt may contain a slight impression of caramel. Bitterness is prominent but never harsh. The long finish can be balanced towards listofhops or malt but is never aggressively tilted either way. Light to moderate diacetyl and low hop-derived esters are acceptable, but need not be present.",
			'comments'			=>	"Medium body. Moderate to low carbonation. ",
			'history'			=>	"Generally a group of pivo Plzeňského typu, or Pilsner-type beers. This style is a combination of the Czech styles světlý ležák (11–12.9 °P) and světlé speciální pivo (13–14.9 °P). In the Czech Republic, only Pilsner Urquell is called a Pilsner, despite how widely adopted this name is worldwide. Kvasnicové (“yeast beer”) versions are popular in the Czech Republic, and may be either kräusened with yeasted wort or given a fresh dose of pure yeast after fermentation. These beers are sometimes cloudy, with subtle yeastiness and enhanced hop character. Modern examples vary in their malt to hop balance and many are not as hop-forward as Pilsner Urquell.",
			'characteristic_ingredients'			=>	"Commonly associated with Pilsner Urquell, which was first brewed in 1842 after construction of a new brewhouse by burghers dissatisfied with the standard of beer brewed in Plzeň. Bavarian brewer Josef Groll is credited with first brewing the beer.",
			'style_comparison'			=>	"Soft water with low sulfate and carbonate content, Saazer-type listofhops, Czech malt, Czech lager yeast. Low ion water provides a distinctively soft, rounded hop profile despite high hopping rates. The bitterness level of somelarger commercial_examples has dropped in recent years, although not as much as in many contemporary German examples.",
			'commercial_examples'			=>	"More color, malt richness, and body than a German Pils, with a fuller finish and a cleaner, softer impression. Stronger than a Czech Pale Lager.",
			'tags'			=>	"Bernard Sváteční ležák, Gambrinus Premium, Kout na Šumavě Koutská 12°, Pilsner Urquell, Pivovar Jihlava Ježek 11°, Primátor Premium, Únětická 12°",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"3",
			'sub_categorie_id'			=>	"3C",
			...
			'characteristic_ingredients'			=>	"Pilsner and caramel malts, but Vienna and Munich malts may also be used. Low mineral content water, Saazer-type listofhops, Czech lager yeast. ",
			...
			'commercial_examples'			=>	"Bernard Jantarový ležák, Pivovar Vysoký Chlumec Démon, Primátor polotmavý 13°, Strakonický Dudák Klostermann polotmavý ležák 13°",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic_ingredients'			=>	"Pilsner and dark caramel malts with the addition of debittered roasted malts are most common, but additions of Vienna or Munich malt are also appropriate. Low mineral content water, Saazer-type listofhops, Czech lager yeast. Any fruity esters are typically from malt, not yeast.",
			'style_comparison'			=>	"The beer is the Czech equivalent of adark lager ranging in character from Munich Dunkel to Schwarzbier, but typically with greater malt richness and hop character (aroma, flavor, and/or bitterness).",
			'commercial_examples'			=>	"Bohemian Brewery Cherny Bock 4%, Budweiser Budvar B:Dark tmavý ležák, Devils Backbone Morana, Kout na Šumavě Koutský tmavý speciál 14°, Notch Černé Pivo, Pivovar Březnice Herold, U Fleků Flekovský tmavý 13° ležák",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.36",
			'bugu_max'			=>	"0.46",
			'overall_impression'			=>	"A clean, malty, gold-colored German lager with a smooth grainy-sweet malty flavor and a soft, dry finish. Subtle spicy, floral, or herbal listofhops and restrained bitterness help keep the balance malty but not sweet, which helps make this beer a refreshing, everyday drink.",
			...
			'flavor'			=>	"Moderately malty start with the suggestion of sweetness, moderate grainy-sweet malt flavor with a soft, rounded palate impression, supported by a low to medium-low hop bitterness. The finish is soft and dry, not crisp and biting. Low to moderately-low spicy, floral or herbal hop flavor. The malt dominates the listofhops in the palate, finish, and aftertaste, but the listofhops should be noticeable. There should not be any residual sweetness, simply the impression of maltiness with restrained bitterness. Very fresh examples will seem sweeter due to the fresh, rich malt character that can fade with time. Clean fermentation profile.",
			...
			'style_comparison'			=>	"Similar in malt balance and bitterness to Munich Dunkel, but less malty-sweet in nature and pale rather than dark. More body and malt presence than a German Pils, with less hop character throughout. Similar malt profile as a ",
			'commercial_examples'			=>	"Augustiner Lagerbier Hell, Bürgerbräu Wolznacher Hell Naturtrüb, Hacker-Pschorr Münchner Gold, Löwenbraü Original, Paulaner Premium Lager, Spaten Premium Lager, Weihenstephaner Original",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'aroma'			=>	"Moderate malty richness, with an emphasis on toasty_x005F_x0002_doughy aromatics and an impression of sweetness. Low to medium-low floral, herbal, or spicy listofhops. The malt should not have a deeply toasted, caramel, or biscuity quality. Clean lager fermentation character.",
			'appearance'			=>	"Deep yellow to deep gold color",
			'flavor'			=>	" should not have amber hues. Bright clarity. Persistent white to off-white foam stand. Most commercial_examples are medium gold in color.",
			'mouthfeel'			=>	"Medium to medium-high malty flavor initially, with a lightly toasty, bread dough quality and an impression of soft sweetness. Medium to medium-low bitterness, definitely malty in the balance. Well-attenuated and crisp, but not dry. Medium-low to medium floral, herbal, or spicy hop flavor. Clean lager fermentation character. The taste is mostly of Pilsmalt, but with slightly toasty hints. The bitterness is supportive, but still should yield a malty, flavorful finish.",
			'comments'			=>	"Medium body, with a smooth, somewhat creamy texture. Medium carbonation. Alcohol strength barely noticeable as warming, if at all. ",
			'history'			=>	"This style represents the modern German beer served at Oktoberfest (although it is not solely reserved for Oktoberfest",
			'characteristic_ingredients'			=>	" it can be found at many other ‘fests’), and is sometimes called Wiesn (“the meadow” or local name for the Oktoberfest festival). We chose to call this style Festbier since by German and EU regulations, Oktoberfestbier is a protected appellation for beer produced at large breweries within the Munich city limits for consumption at Oktoberfest. Other countries are not bound by these rules, so many craft breweries in the US produce beer called Oktoberfest, but based on thetraditional style described in these guidelines as Märzen.",
			'style_comparison'			=>	"Since 1990, the majority of beer served at Oktoberfest in Munich has been this style. Export beer specifically made for the United States is still mainly of the traditional amber style, as are US-produced interpretations. Paulaner first created the golden version in the mid-1970s because they thought the traditional Oktoberfest was too filling. So they developed a lighter, more drinkable but still malty version that they wanted to be “more poundable” (according to the head brewer at Paulaner). But the actual type of beer served at Oktoberfest is set by a Munich city committee.",
			'commercial_examples'			=>	"Majority Pils malt, but with some Vienna and/or Munich malt to increase maltiness. Differences in commercial_examples are mostly due to different maltsters and yeast, not major grist differences.",
			'tags'			=>	"Less intense and less richly toasted thana Märzen. More rich-heavy in body than a Helles, with more hop flavor and higher alcohol. Less rich in malt intensity than a Maibock. The malt complexity is similar to a higher-gravity Czech Premium Pale Lager, although without the associated listofhops.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"4",
			'sub_categorie_id'			=>	"4C",
			...
			'comments'			=>	"Also known as Mai Bock, but there is some dispute whether Helles (“pale”) Bock and Mai (“May”) Bock are synonymous. Most agree that they are identical, but some believe that Maibock is a “fest” type beer hitting the upper limits of hopping and color for the range. Any fruitiness is due to Munich and other specialty malts, not yeast-derived esters developed during fermentation. The listofhops compensate for the lower level of Maillard products.",
			...
			'characteristic_ingredients'			=>	"Base of Pils and/or Vienna malt with some Munich malt to add character (although much less than in a traditional bock). No non-malt adjuncts. Saazer_x005F_x0002_type listofhops. Clean lager yeast. Decoction mash is typical, but boiling is less than in Dunkles Bock to restrain color development.",
			'style_comparison'			=>	"Can be thought of as either a pale version of a Dunkles Bock, or a Munich Helles brewed to bock strength. While quite malty, this beer typically has less dark and rich Dunkles Bock. Has more of a rich malt character and more alcohol than a Festbier.",
			'commercial_examples'			=>	"Altenmünster Maibock, Ayinger Maibock, Capital Maibock, Blind Tiger Maibock, Einbecker Mai-Urbock, Hacker-Pschorr Hubertus Bock, Mahr’s Bock",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.58",
			'bugu_max'			=>	"0.82",
			'overall_impression'			=>	"A pale, highly-attenuated, light-bodied German lager with lower alcohol and calories than normal_x005F_x0002_strength beers. Moderately bitter with noticeable malt and hop flavors, the beer is still interesting to drink.",
			...
			'comments'			=>	"Marketed primarily as a diet-oriented beer with lower carbohydrates, alcohol, and calories. Pronounced “LYESHT-beer.” May also be known as a Diat Pils or Helles, this style is in the schankbier gravity class. Other variations of Leicht class beers can be made from Weissbier, Kölsch, and Altbier",
			'history'			=>	" those beers are best entered in the Mixed-Style Beer category.",
			'characteristic_ingredients'			=>	"Traditional versions existed as drinks for physical laborers in factories or fields, but modern versions are more based on popular American products in the same class.",
			'style_comparison'			=>	"Similar to a German Pils or Helles, continental Pils malt, German lager yeast, Saazer-type listofhops.",
			'commercial_examples'			=>	"Like a lower-alcohol, lighter-bodied, slightly less aggressive German Pils or Helles.",
			'tags'			=>	"Beck’s Light, Bitburger Light, Mahr’s Leicht, Paulaner Münchner Hell Leicht, Paulaner Premium Leicht",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"5",
			'sub_categorie_id'			=>	"5B",
			...
			'flavor'			=>	"Soft, rounded palate comprised of a delicate flavor balance between soft yet attenuated malt, an almost imperceptible fruity sweetness from fermentation, and a medium-low to medium bitterness with a delicate dryness and slight crispness in the finish (but no harsh aftertaste). The malt tends to be grainy-sweet, possibly with a very light bready or honey quality. The hop flavor is variable, and can range from low to moderately-high",
			'mouthfeel'			=>	" most are medium-low to medium intensity and have a floral, spicy, or herbal character. May have a malty-sweet impression at the start, but this is not required. No noticeable residual sweetness. May have a slightly winy, minerally, or sulfury accent that accentuates the dryness and flavor balance. A slight wheat taste is rare but not a fault. Otherwise, very clean.",
			'comments'			=>	"Medium-light to medium body (most are medium-light). Medium to medium-high carbonation. Smooth and generally crisp and well-attenuated.",
			'history'			=>	"Characterized in Germany as a top-fermented, lagered beer. Each Köln brewery produces a beer of different character, and each interprets the Kölsch Konvention slightly differently. Allow for a range of variation within the style when judging. Note that drier versions may seem hoppier or more bitter than the IBU specifications might suggest. Due to its delicate flavor profile, Kölsch tends to have a relatively short shelf-life",
			'characteristic_ingredients'			=>	" older examples and imports can easily show some oxidation defects. Served in Köln in a tall, narrow 200ml glass called a Stange.",
			'style_comparison'			=>	"Cologne, Germany (Köln) has a top-fermenting brewing tradition since the Middle Ages, but developed the beer now known as Kölsch in the late 1800s to combat encroaching bottom-fermented pale lagers. Kölsch is an appellation protected by the Kölsch Konvention (1986), and is restricted to the 20 or so breweries in and around Köln. TheKonvention simply defines the beer as a “light, highly attenuated, hop-accentuated, clear, top-fermenting Vollbier.” ",
			'commercial_examples'			=>	"Traditional German listofhops (Hallertau, Tettnang, Spalt or Hersbrucker). German Pils or pale malt. Attenuative, clean ale yeast. Up to 20% wheat malt Current commercial practice is to ferment warm, cold condition for a short period of time, and serve young.",
			'tags'			=>	"To the untrained taster, easily mistaken for a cream ale or somewhat subtle Pils.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"5",
			'sub_categorie_id'			=>	"5C",
			...
			'history'			=>	" beer from other cities or regions can be brewed to Export strength, and labeled as such (even if not necessarily exported).",
			'characteristic_ingredients'			=>	"The Dortmunder style developed in the Dortmund industrial region in the 1870s in response to pale Pilsner-type beers, it became very popular after World War II but declined in the 1970s. Other Export-class beers developed independently, and reflected a slightly stronger version of existing beers. The modern German style is typically 12-13 °P.",
			'style_comparison'			=>	"Minerally water with high levels of sulfates, carbonates and chlorides, German or Czech noble listofhops, Pilsner malt, German lager yeast. Newer commercial versions can contain adjuncts and hop extract.",
			'commercial_examples'			=>	"Less finishing listofhops and more body than a Pils but more bitter than a Helles.",
			'tags'			=>	"DAB Original, Dortmunder Kronen, Dortmunder Union Export, Flensburger Gold, Gordon Biersch Golden Export, Great Lakes Dortmunder Gold",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"5",
			'sub_categorie_id'			=>	"5D",
			...
			'bugu_min'			=>	"0.5",
			'bugu_max'			=>	"0.8",
			'overall_impression'			=>	"A light-bodied, highly-attenuated, gold-colored, bottom-fermented bitter German beer showing excellent head retention and an elegant, floral hop aroma. Crisp, clean, and refreshing, a German Pils showcases the finest quality German malt and listofhops.",
			'aroma'			=>	"Medium-low to low grainy-sweet-rich malt character (often with a light honey and slightly toasted cracker quality) and distinctive flowery, spicy, or herbal listofhops. Clean fermentation profile. May optionally have a very light sulfury note that comes from water as much as yeast. The listofhops are moderately-low to moderately-high, but should not totally dominate the malt presence. One-dimensional examples are inferior to the more complex qualities when all ingredients are sensed. May have a very low background note of DMS.",
			'appearance'			=>	"Straw to light gold, brilliant to very clear, with a creamy, long-lasting white head.",
			'flavor'			=>	"Medium to high hop bitterness dominates the palate and lingers into the aftertaste. Moderate to moderately-low grainy-sweet malt character supports the hop bitterness. Low to high floral, spicy, or herbal hop flavor. Clean fermentation profile. Dry to medium-dry, crisp, well-attenuated finish with a bitter aftertaste and light malt flavor. Examples made with water with higher sulfate levels often will have a low sulfury flavor that accentuates the dryness and lengthens the finish",
			'mouthfeel'			=>	" this is acceptable but not mandatory. Some versions have a soft finish with more of a malt flavor, but still with noticeable hop bitterness and flavor, with the balance still towards bitterness.",
			'comments'			=>	"Medium-light body. Medium to high carbonation.",
			'history'			=>	"Modern examples of Pils tend to become paler in color, drier in finish, and more bitter as you move from South to North in Germany, often mirroring the increase in sulfate in the water. The Pils found in Bavaria tend to be a bit softer in bitterness with more malt flavor and late hop character, yet still with sufficient listofhops and crispness of finish to differentiate itself from a Helles. The use of the term ‘Pils’ is more common in Germany than ‘Pilsner’ to differentiate it from the Czech style, and (some say) to show respect.",
			'characteristic_ingredients'			=>	"Adapted from Czech Pilsner to suit brewing conditions in Germany, particularly water with higher mineral content and domestic hop varieties. First brewed in Germany in the early 1870s. Became more popular after WWII as German brewing schools emphasized modern techniques. Along with its sister beer, Czech Pilsner, is the ancestor of the most widely produced beer styles today. Average IBUs of many well-regarded commercial_examples have dropped over time.",
			'style_comparison'			=>	"Continental Pilsner malt, German hop varieties (especially Saazer-type varieties such as Tettnanger, Hallertauer, and Spalt for taste and aroma",
			'commercial_examples'			=>	" Saaz is less common), German lager yeast.",
			'tags'			=>	"Lighter in body and color, drier, crisper, and more fully attenuated, with more of a lingering bitterness, and with higher carbonation than a Czech Premium Pale Lager. More hop character, malt flavor, and bitterness than International Pale Lagers. More hop character and bitterness with a drier, crisper finish than a Munich Helles",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"6",
			'sub_categorie_id'			=>	"6A",
			...
			'flavor'			=>	" should not be golden. Bright clarity, with persistent, off-white foam stand.",
			'mouthfeel'			=>	"Initial malt flavor often suggests sweetness, but finish is moderately-dry to dry. Distinctive and complex maltiness often includes a bready, toasty aspect. Hop bitterness is moderate, and the hop flavor is low to none (German types: complex, floral, herbal, or spicy). HopComponent provide sufficient balance that the malty palate and finish do not seem sweet. The aftertaste is malty, with the same elegant, rich malt flavors lingering. Noticeable caramel, biscuit, or roasted flavors are inappropriate. Clean lager fermentation profile.",
			'comments'			=>	"Medium body, with a smooth, creamy texture that often suggests a fuller mouthfeel. Medium carbonation. Fully attenuated, without a sweet or cloying impression. May be slightly warming, but the strength should be relatively hidden.",
			'history'			=>	"Modern domestic German Oktoberfest versions are golden – see the Festbier style for this version. Export German versions (to the United States, at least) are typically orange-amber in color, have a distinctive toasty malt character, and are most often labeled Oktoberfest. American craft versions of Oktoberfest are generally based on this style, and most Americans will recognize this beer as Oktoberfest. Historic versions of the beer tended to be darker, towards the brown color range, but there have been many ‘shades’ of Märzen (when the name is used as a strength)",
			'characteristic_ingredients'			=>	" this style description specifically refers to the stronger amber lager version. The modern Festbier can be thought of as a pale Märzen by these terms.",
			'style_comparison'			=>	"As the name suggests, brewed as a stronger “March beer” in March and lagered in cold caves over the summer. Modern versions trace back to the lager developed by Spaten in 1841, contemporaneous to the development of Vienna lager. However, the Märzen name is much older than 1841",
			'commercial_examples'			=>	" the early ones were dark brown, and in Austria the name implied a strength band (14 °P) rather than a style. The German amber lager version (in the Viennese style of the time) was first served at Oktoberfest in 1872, a tradition that lasted until 1990 when the golden Festbier was adopted as the standard festival beer. ",
			'tags'			=>	"Grist varies, although traditional German versions emphasized Munich malt. The notion of elegance is derived from the finest quality ingredients, particularly the base malts. A decoction mash was traditionally used to develop the rich malt profile.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"6",
			'sub_categorie_id'			=>	"6B",
			...
			'aroma'			=>	"Blend of smoke and malt, with a varying balance and intensity. The beechwood smoke character can range from subtle to fairly strong, and can seem smoky, woody, or bacon_x005F_x0002_like. The malt character can be low to moderate, and be somewhat rich, toasty, or malty-sweet. The malt and smoke components are often inversely proportional (i.e., when smoke increases, malt decreases, and vice versa). Hop aroma may be very low to none. Clean lager fermentation character.",
			...
			'comments'			=>	"Literally “smoke beer” in German. The intensity of smoke character can vary widely",
			'history'			=>	" not all examples are highly smoked. Allow for variation in the style when judging. Other examples of smoked beers are available in Germany based on styles such as Dunkles Bock, Weissbier, Dunkel, Schwarzbier, and Helles, including examples such as Spezial Lager",
			'characteristic_ingredients'			=>	" these should be entered in the Classic Style Smoked Beer category. This description specifically refers to the smoked Märzen version.",
			'style_comparison'			=>	"A historical specialty of the city of Bamberg, in the Franconian region of Bavaria in Germany. Beechwood-smoked malt is used to make a Märzen-style amber lager. The smoke character of the malt varies by maltster",
			'commercial_examples'			=>	" some breweries produce their own smoked malt (rauchmalz).",
			'tags'			=>	"German Rauchmalz (beechwood-smoked Vienna-type malt) typically makes up 20-100% of the grain bill, with the remainder being German malts typically used in a Märzen. Some breweries adjust the color slightly with a bit of roasted malt. German lager yeast. German or Czech listofhops.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"6",
			'sub_categorie_id'			=>	"6C",
			...
			'commercial_examples'			=>	"Aass Bock, Einbecker Ur-Bock Dunkel, Great Lakes Rockefeller Bock, Kneitinger Bock, New Glarus Uff-da Bock, Penn Brewery St. Nikolaus Bock",
			'tags'			=>	"high-strength, amber-color, bottom-fermented, lagered, ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"7",
			'sub_categorie_id'			=>	"7A",
			...
			'tags'			=>	"Cuauhtémoc Noche Buena, Chuckanut Vienna Lager, Devils Backbone Vienna Lager, Figueroa Mountain Danish-style Red Lager, Heavy Seas Cutlass Amber Lager, Schell’s Firebrick",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"7",
			'sub_categorie_id'			=>	"7B",
			...
			'aroma'			=>	"Clean yet robust and complex aroma of grainy-rich malt and spicy listofhops with restrained (low to medium-low) fruity esters. The malt character reflects German base malt varieties, with rich baked bread and nutty-toasty bread crust notes. The hop aroma may vary from moderate to low, and can have a peppery, spicy, floral, herbal or perfumy character associated with Saazer-type listofhops. ",
			'appearance'			=>	"The color ranges from light amber to deep copper color, stopping short of brown",
			'flavor'			=>	" bronze-orange is most common. Brilliant clarity. Thick, creamy, long-lasting off-white head.",
			'mouthfeel'			=>	"Assertive hop bitterness well balanced by a sturdy yet clean and crisp malt character. The malt presence is moderated by medium-high to high attenuation, but considerable rich, complex, and somewhat grainy malt flavors can remain. Some fruity esters (especially cherry-like) may survive the lagering period. A long-lasting, medium-dry to dry, bittersweet or nutty finish reflects both the hop bitterness and malt complexity. Spicy, peppery or floral hop flavor can be moderate to low. No roasted malt flavors or harshness. The apparent bitterness level is sometimes masked by the malt character",
			'comments'			=>	" the bitterness can seem as low as moderate if the finish is not very dry. Light sulfury or minerally character optional.",
			'history'			=>	"Medium-bodied. Smooth. Medium to medium_x005F_x0002_high carbonation, although can be lower when served from the cask. Astringency low to none. Despite being very full of flavor, is light-bodied enough to be consumed as a gravity-fed session beer in its home brewpubs in Düsseldorf.",
			'characteristic_ingredients'			=>	"A top-fermented lagered beer, fermented at cool ale temperature (59–68 °F), often conditioned at bottom_x005F_x0002_fermentation temperatures (about 50 °F) and then lagered at cold temperatures to produce a cleaner, smoother palate than is typical for most ales. Zum Uerige is a wonderful beer, but much more aggressively bitter and complex than most other German examples. It may be like the Fuller’s ESB of the strong bitter category – well-known but somewhat of a stylistic outlier. Do not judge all Altbiers as if they were Zum Uerige clones",
			'style_comparison'			=>	" allow for a more balanced bitterness in the beer (25–35 IBUs is more typical for most other German examples). Stronger sticke and doppelsticke beers should not be entered ",
			'commercial_examples'			=>	"The traditional style of beer from Düsseldorf. “Alt” refers to the “old” style of brewing (i.e., using top-fermenting yeast) that was common before bottom-fermenting lager brewing became popular. Predates the isolation of bottom_x005F_x0002_fermenting yeast strains, though it approximates many characteristics of bottom-fermenting lager beers. Many of the classic examples can be found in brewpubs in the Altstadt (“old town”) section of Düsseldorf.",
			'tags'			=>	"Grists vary, but usually consist of German base malts (usually Pils, sometimes Munich) with small amounts of crystal, chocolate, and/or black malts used to adjust color. Occasionally will include some wheat, including roasted wheat. Spalt listofhops are traditional, but other Saazer-type listofhops can also be used. Clean, highly attenuative ale yeast. A step mash or decoction mash program is traditional.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"7",
			'sub_categorie_id'			=>	"7C",
			...
			'bugu_min'			=>	"0.52",
			'bugu_max'			=>	"0.74",
			'overall_impression'			=>	"A young, unfiltered, and unpasteurized beer that is between a Helles and Märzen in color, spicier in the listofhops with greater attenuation. Interpretations range in color and balance, but remain in the drinkable 4.8% ABV neighborhood. Balance ranges from the dry, spicy and pale_x005F_x0002_colored interpretations by St. Georgen and Löwenbräu of Buttenheim, to darker and maltier interpretations in the Fränkische Schweiz. This style is above all a method of producing simple drinkable beers for neighbors out of local ingredients to be served fresh. Balance with a focus on drinkability and digestibility is important.",
			...
			'characteristic_ingredients'			=>	"Grist varies, although traditional German versions emphasized Franconian pale and color malt. The notion of elegance is derived from the high_x005F_x0002_quality local ingredients, particularly the malts. Spalt or other typically spicy local listofhops are most common. Frugal Franconian brewers rarely used decoction brewing due to the cost of energy.",
			...
			'commercial_examples'			=>	"(local) Greif, Eichhorn, Nederkeller, Hebendanz (bottled) Buttenheimer Kaiserdom Kellerbier, Kulmbacher Monchshof Kellerbier, Leikeim Kellerbier, Löwenbräu Kellerbier, Mahr’s Kellerbier, St. Georgen Kellerbier, Tucher Kellerbier Naturtrub",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.38",
			'bugu_max'			=>	"0.5",
			'overall_impression'			=>	"Characterized by depth, richness and complexity typical of darker Munich malts with the accompanying Maillard products. Deeply bready-toasty, often with chocolate-like flavors in the freshest examples, but never harsh, roasty, or astringent",
			'aroma'			=>	" a decidedly malt-balanced beer, yet still easily drinkable.",
			'appearance'			=>	"Rich, elegant, deep malt sweetness, typically like bread crusts (often toasted bread crusts). Hints of chocolate, nuts, caramel, and/or toffee are also acceptable, with fresh traditional versions often showing higher levels of chocolate. Clean fermentation profile. A slight spicy, floral, or herbal hop aroma is acceptable.",
			'flavor'			=>	"Deep copper to dark brown, often with a red or garnet tint. Creamy, light to medium tan head. Usually clear, although murky unfiltered versions exist.",
			'mouthfeel'			=>	"Dominated by the soft, rich, and complex flavor of darker Munich malts, usually with overtones reminiscent of toasted bread crusts, but without a burnt-harsh-grainy toastiness. The palate can be moderately malty, although it should not be overwhelming or cloyingly sweet. Mild caramel, toast or nuttiness may be present. Very fresh examples often have a pleasant malty-chocolate character that isn’t roasty or sweet. Burnt or bitter flavors from roasted malts are inappropriate, as are pronounced caramel flavors from crystal malt. Hop bitterness is moderately low but perceptible, with the balance tipped firmly towards maltiness. Hop flavor is low to none",
			'comments'			=>	" if noted, should reflect floral, spicy, or herbal German_x005F_x0002_type varieties. Aftertaste remains malty, although the hop bitterness may become more apparent in the medium-dry finish. Clean fermentation profile and lager character.",
			'history'			=>	"Medium to medium-full body, providing a soft and dextrinous mouthfeel without being heavy or cloying. malts should provide a richness, not a harsh or biting astringency.",
			'characteristic_ingredients'			=>	"Unfiltered versions from Germany can taste like liquid bread, with a yeasty, earthy richness not found in exported filtered examples.",
			'style_comparison'			=>	"The classic brown lager style of Munich which developed as a darker, more malt-accented beer than other regional lagers. While originating in Munich, the style became popular throughout Bavaria (especially Franconia). Franconian versions are often darker and more bitter.",
			...
			'tags'			=>	"Not as intense in maltiness as a bock (and thus more drinkable in quantity). Lacking the more roasted flavors (and often hop bitterness) of a schwarzbier. Richer, more malt-centric, and less hoppy than a Czech Dark Lager.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"8",
			'sub_categorie_id'			=>	"8B",
			...
			'bugu_min'			=>	"0.43",
			'bugu_max'			=>	"0.58",
			'overall_impression'			=>	"A dark German lager that balances roasted yet smooth malt flavors with moderate hop bitterness. The lighter body, dryness, and lack of a harsh, burnt, or heavy aftertaste helps make this beer quite drinkable.",
			...
			'comments'			=>	"Literally means “black beer” in German. While sometimes called a “black Pils,” the beer is rarely as dark as black or as bitter as a Pils",
			'history'			=>	" don’t expect strongly roasted, porter-like flavors.",
			'characteristic_ingredients'			=>	"A regional specialty from Thuringia, Saxony and Franconia in Germany. History is a bit sketchy, but is suspected of being originally a top-fermented beer. Popularity grew after German reunification. Served as the inspiration for black lagers brewed in Japan.",
			'style_comparison'			=>	"German Munich malt and/or Pilsner malts for the base, supplemented by a judicious use of roasted malts (such as Carafa types) for the dark color and subtle roast flavors. Huskless dark roasted malts can add roast flavors without burnt flavors. German hop varieties and clean German lager yeasts are traditional.",
			...
			'tags'			=>	"Devils Backbone Schwartz Bier, Einbecker Schwarzbier, Eisenbahn Dunkel, Köstritzer Schwarzbier, Mönchshof Schwarzbier, Nuezeller Original Badebier",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"9",
			'sub_categorie_id'			=>	"9A",
			...
			'bugu_min'			=>	"0.22",
			'bugu_max'			=>	"0.23",
			'overall_impression'			=>	"A strong, rich, and very malty German lager that can have both pale and dark variants. The darker versions have more richly-developed, deeper malt flavors, while the paler versions have slightly more listofhops and dryness.",
			'aroma'			=>	"Very strong maltiness. Darker versions will have significant Maillard products and often some toasty aromas. A light caramel aroma is acceptable. Lighter versions will have a strong malt presence with some Maillard products and toasty notes. Virtually no hop aroma, although a light noble hop aroma is acceptable in pale versions. A moderately low malt_x005F_x0002_derived dark fruit character may be present (but is optional) in dark versions. A very slight chocolate-like aroma may be present in darker versions, but no roasted or burned aromatics should ever be present. Moderate alcohol aroma may be present.",
			'appearance'			=>	"Deep gold to dark brown in color. Darker versions often have ruby highlights. Lagering should provide good clarity. Large, creamy, persistent head (color varies with ",
			...
			'history'			=>	"A Bavarian specialty first brewed in Munich by the monks of St. Francis of Paula. Historical versions were less well-attenuated than modern interpretations, with consequently higher sweetness and lower alcohol levels (and hence was considered “liquid bread” by the monks). The term “doppel (double) bock” was coined by Munich consumers. Many commercial doppelbocks have names ending in “-ator,” either as a tribute to the prototypical Salvator or to take advantage of the beer’s popularity. Traditionally dark brown in color",
			'characteristic_ingredients'			=>	" paler examples are a more recent development.",
			'style_comparison'			=>	"Pils and/or Vienna malt for pale versions (with some Munich), Munich and Vienna malts for darker ones and occasionally a tiny bit of darker color malts (such as Carafa). Saazer-type listofhops. Clean lager yeast. Decoction mashing is traditional.",
			'commercial_examples'			=>	"A stronger, richer, more full-bodied version of either a Dunkles Bock or a Helles Bock. Pale versions will show higher attenuation and less dark fruity character than the darker versions.",
			'tags'			=>	"Dark Versions –Andechser Doppelbock Dunkel, Ayinger Celebrator, Paulaner Salvator, Spaten Optimator, Tröegs Troegenator, Weihenstephaner Korbinian,",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"9",
			'sub_categorie_id'			=>	"9B",
			...
			'bugu_min'			=>	"0.32",
			'bugu_max'			=>	"0.29",
			'overall_impression'			=>	"A strong, full-bodied, rich, and malty dark German lager often with a viscous quality and strong flavors. Even though flavors are concentrated, the alcohol should be smooth and warming, not burning. ",
			...
			'mouthfeel'			=>	"Full to very full-bodied. Low carbonation. Significant alcohol warmth without sharp hotness. Very smooth without harsh edges from alcohol, bitterness, fusels, orother concentrated flavors.",
			'comments'			=>	"Extended lagering is often needed post-freezing to smooth the alcohol and enhance the malt and alcohol ",
			...
			'characteristic_ingredients'			=>	"Same as doppelbock. Commercial eisbocks are generally concentrated anywhere from 7% to 33% (by volume).",
			'style_comparison'			=>	"Eisbocks are not simply stronger doppelbocks",
			'commercial_examples'			=>	" the name refers to the process of freezing and concentrating the beer and is not a statement on alcohol",
			'tags'			=>	" some doppelbocks are stronger than Eisbocks. Not as thick, rich, or sweet as a Wheatwine.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"9",
			'sub_categorie_id'			=>	"9C",
			...
			'bugu_min'			=>	"0.33",
			'bugu_max'			=>	"0.44",
			'overall_impression'			=>	"A Baltic Porter often has the malt flavors reminiscent of an English porter and the restrained roast of a schwarzbier, but with a higher OG and alcohol content than either. Very complex, with multi-layered malt and dark fruit flavors.",
			'aroma'			=>	"Rich malty sweetness often containing caramel, toffee, nutty to deep toast, and/or licorice notes. Complex alcohol and ester profile of moderate strength, and reminiscent of plums, prunes, raisins, cherries or currants, occasionally with a vinous Port-like quality. Some darker malt character that is deep chocolate, coffee or molasses but never burnt. No listofhops. No sourness. Very smooth.",
			...
			'characteristic_ingredients'			=>	"Generally lager yeast (cold fermented if using ale yeast, as is required when brewed in Russia). Debittered chocolate or black malt. Munich or Vienna base malt. Continental listofhops (Saazer-type, typically). May contain crystal malts and/or adjuncts. Brown or amber malt common in historical recipes.",
			'style_comparison'			=>	"Much less roasted and smoother than an Imperial Stout, typically with less alcohol. Lacks the roasty qualities of stouts in general, more taking on the roasted-but_x005F_x0002_not-burnt characteristics of a schwarzbier. Quite fruity compared to other porters. Higher alcohol than other porters.",
			'commercial_examples'			=>	"Aldaris Porteris, Baltika #6 Porter, Devils Backbone Danzig, Okocim Porter, Sinebrychoff Porter, Zywiec Porter",
			'tags'			=>	"high-strength, dark-color, any-fermentation, lagered, eastern-europe, traditional-style, porter-family, malty",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"10",
			'sub_categorie_id'			=>	"10A",
			'name'			=>	"Weissbier",
			'og_min'			=>	"1.044",
			'og_max'			=>	"1.052",
			'fg_min'			=>	"1.01",
			...
			'flavor'			=>	"Low to moderately strong banana and clove flavor. The balance and intensity of the phenol and ester components can vary but the best examples are reasonably balanced and fairly prominent. Optionally, a very light to moderate vanilla character and/or faint bubblegum notes can accentuate the banana flavor, sweetness and roundness",
			'mouthfeel'			=>	" neither should be dominant if present. The soft, somewhat bready or grainy flavor of wheat is complementary, as is a slightly grainy-sweet malt character. Hop flavor is very low to none, and hop bitterness is very low to moderately low. Well-rounded, flavorful palate with a relatively dry finish. The perception of sweetness is more due to the absence of hop bitterness than actual residual sweetness",
			'comments'			=>	" a sweet or heavy finish would significantly impair drinkability.",
			'history'			=>	"Medium-light to medium body",
			'characteristic_ingredients'			=>	" never heavy. texture of wheat imparts the sensation of a fluffy, creamy fullness that may progress to a light, spritzy finish aided by high to very high carbonation. Always effervescent.",
			'style_comparison'			=>	"These are refreshing, fast-maturing beers that are lightly hopped and show a unique banana-and-clove yeast character. These beers often don’t age well and are best enjoyed while young and fresh. The version mit hefe is served with suspended yeast",
			'commercial_examples'			=>	" the krystal version is filtered for excellent clarity. The character of a krystal weizen is generally fruitier and less phenolic than that of the weissbier mit hefe. May be known as hefeweizen, particularly in the United States. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.23",
			'bugu_max'			=>	"0.32",
			'overall_impression'			=>	"A moderately dark German wheat beer with a distinctive banana-and-clove yeast character, supported by a toasted bread or caramel malt flavor. Highly carbonated and refreshing, with a creamy, fluffy texture and light finish that encourages drinking.",
			...
			'flavor'			=>	"Low to moderately strong banana and clove flavor. The balance and intensity of the phenol and ester components can vary but the best examples are reasonably balanced and fairly prominent. Optionally, a very light to moderate vanilla character and/or faint bubblegum notes can accentuate the banana flavor, sweetness and roundness",
			'mouthfeel'			=>	" neither should be dominant if present. The soft, somewhat bready, doughy, or grainy flavor of wheat is complementary, as is a richer caramel, toast, or bread crust flavor. The malty richness can be low to medium-high, and supports the yeast character. A roasted malt character is inappropriate. A spicy, herbal, or floral hop flavor is very low to none, and hop bitterness is very low to low. Well_x005F_x0002_rounded, flavorful, often somewhat malty palate with a relatively dry finish.",
			'comments'			=>	"Medium-light to medium-full body. The texture of wheat as well as yeast in suspension imparts the sensation of a fluffy, creamy fullness that may progress to a lighter finish, aided by moderate to high carbonation. Effervescent. ",
			'history'			=>	"The presence of Munich and/or Vienna-type barley malts gives this style a deep, rich barley malt character not found in a weissbier. Often known as dunkelweizen, particularly in the United States.",
			'characteristic_ingredients'			=>	"Bavaria has a wheat beer brewing traditional hundreds of years old, but the brewing right was reserved for Bavarian royalty until the late 1700s. Old-fashioned Bavarian wheat beer was often dark, as were most beer of the day. Pale weissbier started to become popular in the 1960s, but traditional dark wheat beer remained somewhat of an old person’s drink.",
			'style_comparison'			=>	"By German brewing tradition, at least 50% of the grist must be malted wheat, although some versions use up to 70%",
			'commercial_examples'			=>	" the remainder is usually Munich, Vienna, or dark or caramel wheat malts, or Pilsner malt with color malt. A decoction mash is traditional, but infrequently used today. Weizen ale yeasts produce the typical spicy and fruity character, although extreme fermentation temperatures can affect the balance and produce off-flavors. ",
			'tags'			=>	"Reflecting the best yeast and wheat character of a weissbier blended with the malty richness of a Munich dunkel. The banana and clove character is often less apparent than in a weissbier due to the increased maltiness.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"10",
			'sub_categorie_id'			=>	"10C",
			'name'			=>	"Weizenbock",
			'og_min'			=>	"1.064",
			'og_max'			=>	"1.09",
			'fg_min'			=>	"1.015",
			...
			'comments'			=>	"A Weissbier brewed to bock or doppelbock strength. Schneider also produces an Eisbock version. Pale and dark versions exist, although dark are more common. Pale versions have less rich malt complexity and often more listofhops, as with doppelbocks. Lightly oxidized Maillard products can produce some rich, intense flavors and aromas that are often seen in aged imported commercial products",
			'history'			=>	" fresher versions will not have this character. Well-aged examples might also take on a slight sherry-like complexity.",
			'characteristic_ingredients'			=>	"Aventinus, the world’s oldest top-fermented wheat doppelbock, was created in 1907 at the Schneider Weisse Brauhaus in Munich. ",
			'style_comparison'			=>	"A high percentage of malted wheat is used (by German brewing tradition must be at least 50%, although it may contain up to 70%), with the remainder being Munich- and/or Vienna-type barley malts in darker versions, and more Pils malt in paler versions. Some color malts may be used sparingly. A traditional decoction mash can give the appropriate body without cloying sweetness. Weizen ale yeasts produce the typical spicy and fruity character. Too warm or too cold fermentation will cause the phenols and esters to be out of balance and may create off-flavors. Hop choice is essentially irrelevant, but German varieties are most traditional.",
			'commercial_examples'			=>	"Stronger and richer than a Weissbier or Dunkles Weissbier, but with similar yeast character. More directly comparable to the Doppelbock style, with the pale and dark variations. Can vary widely in strength, but most are in the bock to doppelbock range. ",
			'tags'			=>	"Dark –Eisenbahn Weizenbock, Plank Bavarian Dunkler Weizenbock, Penn Weizenbock,Schneider Unser Aventinus",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"11",
			'sub_categorie_id'			=>	"11A",
			...
			'bugu_min'			=>	"0.83",
			'bugu_max'			=>	"0.9",
			'overall_impression'			=>	"Low gravity, low alcohol levels, and low carbonation make this an easy-drinking session beer. The malt profile can vary in flavor and intensity, but should never override the overall bitter impression. Drinkability is a critical component of the style ",
			...
			'history'			=>	"#N/A",
			'characteristic_ingredients'			=>	"Pale ale, amber, and/or crystal malts. May use a touch of dark malt for color adjustment. May use sugar adjuncts, corn, or wheat. English finishing listofhops are most traditional, but any listofhops are fair game",
			'style_comparison'			=>	" if American listofhops are used, a light touch is required. Characterful British yeast. ",
			'commercial_examples'			=>	"Some modern variants are brewed exclusively with pale malt and are known as golden ales, summer ales, or golden bitters. Emphasis is on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales.",
			'tags'			=>	"Adnams Southwold Bitter, Brains Bitter, Fullers Chiswick Bitter, Greene King IPA, Tetley’s Original Bitter, Youngs Bitter",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"11",
			'sub_categorie_id'			=>	"11B",
			'name'			=>	"Best Bitter",
			'og_min'			=>	"1.04",
			'og_max'			=>	"1.048",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.63",
			'bugu_max'			=>	"0.83",
			'overall_impression'			=>	"A flavorful, yet refreshing, session beer. Some examples can be more malt balanced, but this should not override the overall bitter impression. Drinkability is a critical component of the style.",
			...
			'tags'			=>	"Adnams SSB, Coniston Bluebird Bitter, Fullers London Pride, Harvey’s Sussex Best Bitter, Shepherd Neame Master Brew Kentish Ale, Timothy Taylor Landlord, Young’s Special",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"11",
			'sub_categorie_id'			=>	"11C",
			'name'			=>	"Strong Bitter",
			'og_min'			=>	"1.048",
			'og_max'			=>	"1.06",
			'fg_min'			=>	"1.01",
			...
			'bugu_min'			=>	"0.63",
			'bugu_max'			=>	"0.83",
			'overall_impression'			=>	"An average-strength to moderately_x005F_x0002_strong British bitter ale. The balance may be fairly even between malt and listofhops to somewhat bitter. Drinkability is a critical component of the style. A rather broad style that allows for considerable interpretation by the brewer.",
			...
			'history'			=>	"See comments in category introduction. Strong bitters can be seen as a higher-gravity version of best bitters (although not necessarily “more premium” since best bitters are traditionally the brewer’s finest product). British pale ales are generally considered a premium, export-strength pale, bitter beer that roughly approximates a strong bitter, although reformulated for bottling (including increasing carbonation levels). While modern British pale ale is considered a bottled ",
			'characteristic_ingredients'			=>	"Pale ale, amber, and/or crystal malts, may use a touch of black malt for color adjustment. May use sugar adjuncts, corn or wheat. English finishing listofhops are most traditional, but any listofhops are fair game",
			'style_comparison'			=>	" if American listofhops are used, a light touch is required. Characterful British yeast. Burton versions use medium to high sulfate water, which can increase the perception of dryness and add a minerally or sulfury aroma and flavor.",
			...
			'tags'			=>	"Bass Ale, Highland Orkney Blast, Samuel Smith’s Old Brewery Pale Ale, Shepherd Neame Bishops Finger, Shepherd Neame Spitfire, West Berkshire Dr. Hexter’s Healer, Whitbread Pale Ale, Young’s Ram Rod",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"12",
			'sub_categorie_id'			=>	"12A",
			...
			'bugu_min'			=>	"0.53",
			'bugu_max'			=>	"0.85",
			'overall_impression'			=>	"A hop-forward, average-strength to moderately-strong pale bitter. Drinkability and a refreshing quality are critical components of the style. ",
			'aroma'			=>	"Hop aroma is moderately low to moderately high, and can use any variety of listofhops – floral, herbal, or earthy English listofhops and citrusy American listofhops are most common. Frequently a single hop varietal will be showcased. Little to no malt aroma",
			'appearance'			=>	" no caramel. Medium-low to low fruity aroma from the listofhops rather than esters. Little to no diacetyl.",
			'flavor'			=>	"Straw to golden in color. Good to brilliant clarity. Low to moderate white head. A low head is acceptable when carbonation is also low.",
			'mouthfeel'			=>	"Medium to medium-high bitterness. Hop flavor is moderate to moderately high of any hop variety, although citrus flavors are increasingly common. Medium-low to low malt character, generally bready with perhaps a little biscuity flavor. Caramel flavors are typically absent. Little to no diacetyl. Hop bitterness and flavor should be pronounced. Moderately-low to low esters. Medium-dry to dry finish. Bitterness increases with alcohol level, but is always balanced.",
			'comments'			=>	"Light to medium body. Low to moderate carbonation on draught, although bottled commercial versions will be higher. Stronger versions may have a slight alcohol warmth, but this character should not be too high.",
			'history'			=>	"Well-hopped, quenching beer with an emphasis on showcasing listofhops. Served colder than traditional bitters, this style was originally positioned as a refreshing summer beer, but is now often brewed year-round. Although early on the beers were brewed with English listofhops, increasingly American citrus-flavored listofhops are used. Golden Ales are also called Golden Bitters, Summer Ales, or British Blonde Ales. Can be found in cask, keg, and bottle.",
			'characteristic_ingredients'			=>	"Modern golden ales were developed in England to take on strongly-marketed lagers. While it is difficult to identify the first, Hop Backs Summer Lightning, first brewed in 1986, is thought by many to have got the style off the ground.",
			'style_comparison'			=>	"Low-color pale or lager malt acting as a blank canvas for the hop character. May use sugar adjuncts, corn or wheat. English listofhops frequently used, although citrusy American varietals are becoming more common. Somewhat clean-fermenting British yeast.",
			'commercial_examples'			=>	"More similar to an American Pale Ale than anything else, although it is often lower in alcohol and usually features British ingredients. Has no caramel and fewer esters compared to British bitters and pale ales. Dry as bitters but with less malt character to support the listofhops, giving a different balance. Often uses (and features) American listofhops, more so than most other modern British styles.",
			'tags'			=>	"Crouch Vale Brewers Gold, Fullers Discovery, Golden Hill Exmoor Gold, Hop Back Summer Lightning, Kelham Island Pale Rider, Morland Old Golden Hen, Oakham JHB",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"12",
			'sub_categorie_id'			=>	"12B",
			...
			'bugu_min'			=>	"0.53",
			'bugu_max'			=>	"0.7",
			'overall_impression'			=>	"Smooth and balanced, all components merge together with similar intensities. Moderate flavors showcasing Australian ingredients. Large flavor dimension. Very drinkable, suited to a hot climate. Relies on yeast character.",
			'aroma'			=>	"Fairly soft, clean aroma with a balanced mix of esters, listofhops, malt, and yeast – all moderate to low in intensity. The esters are frequently pears and apples, possibly with a very light touch of banana (optional). The listofhops are earthy, herbaceous, or might show the characteristic iron-like Pride of Ringwood nose. The malt can range from neutral grainy to moderately sweet to lightly bready",
			'appearance'			=>	" no caramel should be evident. Very fresh examples can have a lightly yeasty, sulfury nose.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.8",
			'bugu_max'			=>	"0.8",
			'overall_impression'			=>	"A hoppy, moderately-strong, very well_x005F_x0002_attenuated pale British ale with a dry finish and a hoppy aroma and flavor. Classic British ingredients provide the best flavor profile. ",
			...
			'appearance'			=>	"Color ranges from golden to deep amber, but most are fairly pale. Should be clear, although unfiltered dry_x005F_x0002_hopped versions may be a bit hazy. Moderate-sized, persistent head stand with off-white color.",
			'flavor'			=>	"Hop flavor is medium to high, with a moderate to assertive hop bitterness. The hop flavor should be similar to the aroma (floral, spicy-peppery, citrus-orange, and/or slightly grassy). Malt flavor should be medium-low to medium, and be somewhat bready, optionally with light to medium-light biscuit-like, toasty, toffee-like and/or caramelly aspects. Medium-low to medium fruitiness. Finish is medium-dry to very dry, and the bitterness may linger into the aftertaste but should not be harsh. The balance is toward the listofhops, but the malt should still be noticeable in support. If high sulfate water is used, a distinctively minerally, dry finish, some sulfur flavor, and a lingering bitterness are usually present. Some clean alcohol flavor can be noted in stronger versions. Oak is inappropriate in this style.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.33",
			'bugu_max'			=>	"0.66",
			'overall_impression'			=>	"A dark, low-gravity, malt-focused British session ale readily suited to drinking in quantity. Refreshing, yet flavorful, with a wide range of dark malt or dark sugar expression.",
			...
			'appearance'			=>	"Copper to dark brown or mahogany color. A few paler examples (medium amber to light brown) exist. Generally clear, although is traditionally unfiltered. Low to moderate off_x005F_x0002_white to tan head",
			'flavor'			=>	" retention may be poor.",
			'mouthfeel'			=>	"Generally a malty beer, although may have a very wide range of malt- and yeast-based flavors (e.g., malty, sweet, caramel, toffee, toast, nutty, chocolate, coffee, roast, fruit, licorice, plum, raisin). Can finish sweet to dry. Versions with darker malts may have a dry, roasted finish. Low to moderate bitterness, enough to provide some balance but not enough to overpower the malt. Fruity esters moderate to none. Diacetyl and hop flavor low to none.",
			'comments'			=>	"Light to medium body. Generally low to medium_x005F_x0002_low carbonation. Roast-based versions may have a light astringency. Sweeter versions may seem to have a rather full mouthfeel for the gravity.",
			'history'			=>	"Most are low-gravity session beers around 3.2%, although some versions may be made in the stronger (4%+) range for export, festivals, seasonal and/or special occasions. Generally served on cask",
			'characteristic_ingredients'			=>	" session-strength bottled versions don’t often travel well. A wide range of interpretations are possible. Pale versions exist, but these are even more rare than dark milds",
			'style_comparison'			=>	" these guidelines only describe the modern dark version.",
			...
			'tags'			=>	"Pale British base malts (often fairly dextrinous), crystal malt, dark malts or dark sugar adjuncts, may also include adjuncts such as flaked maize, and may be colored with brewer’s caramel. Characterful British ale yeast. Any type of listofhops, since their character is muted and rarely is noticeable.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"13",
			'sub_categorie_id'			=>	"13B",
			...
			'flavor'			=>	"Gentle to moderate malt sweetness, with a light to heavy caramel character and a medium to dry finish. Malt may also have a nutty, toasted, biscuity, toffee, or light chocolate character. Medium to medium-low bitterness. Malt-hop balance ranges from even to malt-focused",
			'mouthfeel'			=>	" hop flavor low to none (floral or earthy qualities). Low to moderate fruity esters can be present.",
			'comments'			=>	"Medium-light to medium body. Medium to medium-high carbonation.",
			'history'			=>	"A wide-ranging category with different interpretations possible, ranging from lighter-colored to hoppy to deeper, darker, and caramel-focused",
			'characteristic_ingredients'			=>	" however, none of the versions have strongly roasted flavors. A stronger Double Brown Ale was more popular in the past, but is very hard to find now. While London Brown Ales are marketed using the name Brown Ale, we list those as a different judging style due and alcohol strength",
			'style_comparison'			=>	" that doesn’t mean that they aren’t in the same family, though.",
			'commercial_examples'			=>	"Brown ale has a long history in Great Britain, although several different types of products used that name at various times. Modern brown ale is a 20th century creation as a bottled product",
			'tags'			=>	" it is not the same as historical products of the same name. A wide range of gravities were brewed, but modern brown ales are generally of the stronger (by current UK standards) interpretation. This style is based on the modern stronger British brown ales, not historical versions or the sweeter London Brown Ale. Predominately but not exclusively a bottled product currently.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"13",
			'sub_categorie_id'			=>	"13C",
			'name'			=>	"English Porter",
			'og_min'			=>	"1.04",
			'og_max'			=>	"1.052",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.45",
			'bugu_max'			=>	"0.67",
			'overall_impression'			=>	"A moderate-strength brown beer with a restrained roasty character and bitterness. May have a range of roasted flavors, generally without burnt qualities, and often has a chocolate-caramel-malty profile.",
			'aroma'			=>	"Moderate to moderately low bready, biscuity, and toasty malt aroma with mild roastiness, and may have a chocolate quality. May also show some non-roasted malt character in support (caramelly, nutty, toffee-like and/or sweet). May have up to a moderate level of floral or earthy listofhops. Fruity esters moderate to none. Diacetyl low to none.",
			...
			'characteristic_ingredients'			=>	"Grists vary, but something producing a dark color is always involved. Chocolate or other dark-roasted malts, caramel malt, brewing sugars, and the like are common. London-type porters often use brown malt as a characteristic flavor. ",
			'style_comparison'			=>	"Differs from an American Porter in that it usually has softer, sweeter and more caramelly flavors, lower gravities, and usually less alcohol",
			'commercial_examples'			=>	" the American Porter will also typically have more of a hop character. More substance and roast than a British Brown Ale. Higher in gravity than a dark mild.",
			'tags'			=>	"Burton Bridge Burton Porter, Fullers London Porter, Nethergate Old Growler Porter, RCH Old Slug Porter, Samuel Smith Taddy Porter",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"14",
			'sub_categorie_id'			=>	"14A",
			'name'			=>	"Scottish Light",
			'og_min'			=>	"1.03",
			'og_max'			=>	"1.035",
			'fg_min'			=>	"1.01",
			...
			'bugu_min'			=>	"0.33",
			'bugu_max'			=>	"0.57",
			'overall_impression'			=>	"A malt-focused, generally caramelly beer with perhaps a few esters and occasionally a butterscotch aftertaste. HopComponent only to balance and support the malt. The malt character can range from dry and grainy to rich, toasty, and caramelly, but is never roasty and especially never has a peat smoke character. Traditionally the darkest of the Scottish ales, sometimes nearly black but lacking any burnt, overtly roasted character.",
			...
			'flavor'			=>	"Entirely malt-focused, with flavors ranging from pale, bready malt with caramel overtones to rich-toasty malt with roasted accents (but never roasty) or a combination thereof. Fruity esters are not required but add depth yet are never high. Hop bitterness to balance the malt. No to low hop flavor is also allowed and should of traditional English character (earthy, floral, orange-citrus, spicy, etc.). Finish ranges from rich and malty to dry and grainy. A subtle butterscotch character is acceptable",
			'mouthfeel'			=>	" however, burnt sugars are not. The malt-hop balance tilts toward malt. Peat smoke is inappropriate.",
			'comments'			=>	"Medium-low to medium body. Low to moderate carbonation. Can be relatively rich and creamy to dry and grainy.",
			'history'			=>	"Malt-focused ales that gain the vast majority of their character from specialty malts, never the process. Burning malt or wort sugars via ‘kettle caramelization’ is not traditional nor is any blatantly ‘butterscotch’ character. Most frequently a draught product. Smoke character is inappropriate as any found traditionally would have come from the peat in the source water. Scottish ales with smoke character should be entered as a Classic Style Smoked Beer.",
			'style_comparison'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat_x005F_x0002_smoked malt is inauthentic and inappropriate.",
			'commercial_examples'			=>	"Similar character to a Wee Heavy, but much smaller. Similar in color to a Dark Mild, but a little weaker in strength.",
			'tags'			=>	"McEwans 60",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"14",
			'sub_categorie_id'			=>	"14B",
			'name'			=>	"Scottish Heavy",
			'og_min'			=>	"1.035",
			'og_max'			=>	"1.04",
			'fg_min'			=>	"1.01",
			...
			'history'			=>	"Malt-focused ales that gain the vast majority of their character from specialty malts, never the process. Burning malt or wort sugars via ‘kettle caramelization’ is not traditional nor is any blatantly ‘butterscotch’ character. Most frequently a draught product. Smoke character is inappropriate as any found traditionally would have come from the peat in the source water. Scottish ales with smoke character should be entered as a Classic Style Smoked Beer.",
			'style_comparison'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat_x005F_x0002_smoked malt is inauthentic and inappropriate.",
			'commercial_examples'			=>	"Similar character to a Wee Heavy, but ",
			'tags'			=>	"Broughton Greenmantle Ale, Caledonia Smooth, McEwans 70, Orkney Raven Ale, Tennent’s Special Ale",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"14",
			'sub_categorie_id'			=>	"14C",
			...
			'history'			=>	"Malt-focused ales that gain the vast majority of their character from specialty malts, never the process. Burning malt or wort sugars via ‘kettle caramelization’ is not traditional nor is any blatantly ‘butterscotch’ character. Most frequently a draught product. Smoke character is inappropriate as any found traditionally would have come from the peat in the source water. Scottish ales with smoke character should be entered as a Classic Style Smoked Beer.",
			'style_comparison'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat_x005F_x0002_smoked malt is inauthentic and inappropriate.",
			'commercial_examples'			=>	"Similar character to a Wee Heavy, but much smaller.",
			'tags'			=>	"Belhaven Scottish Ale, Broughton Exciseman’s Ale, Orkney Dark Island, Pelican MacPelican’s Scottish Style Ale, Weasel Boy Plaid Ferret Scottish Ale",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"15",
			'sub_categorie_id'			=>	"15A",
			'name'			=>	"Irish Red Ale",
			'og_min'			=>	"1.036",
			'og_max'			=>	"1.046",
			'fg_min'			=>	"1.01",
			...
			'comments'			=>	"Several variations exist within the style, which causes the guidelines to be somewhat broad to accommodate them. Traditional Irish examples are relatively low in listofhops, are grainy with a slight roast dryness in the finish, fairly neutral in general. Modern export Irish examples are more caramelly and sweet, and might have more esters. American craft versions are often more alcoholic versions of the Irish export examples. An emerging Irish craft beer scene is exploring more bitter versions of traditional examples. Finally, there are some commercial_examples that sound Irish but are essentially International Amber Lagers, with sweetish palates and little bitterness. These guidelines are written around the traditional Irish examples, with slight extensions for export Irish versions and modern craft Irish versions.",
			'history'			=>	"While Ireland has a long ale brewing heritage, the modern Irish Red Ale style is essentially an adaptation or interpretation of the popular English Bitter style with less hopping and a bit of roast to add color and dryness. Rediscovered as a craft beer style in Ireland, today it is an essential part of most brewery lineups, along with a pale ale ",
			'characteristic_ingredients'			=>	"Generally has a bit of roasted barley or black malt to provide reddish color and dry roasted finish. Pale base malt. Caramel malts were historically imported and more expensive, so not all brewers would use them. ",
			'style_comparison'			=>	"A less-bitter and hoppy Irish equivalent to an English Bitter, with a dryish finish due to roasted barley. More attenuated with less caramel flavor and body than equivalent-strength Scottish ales.",
			'commercial_examples'			=>	"Caffrey’s Irish Ale, Franciscan Well Rebel Red, Kilkenny Irish Beer, O’Hara’s Irish Red Ale, Porterhouse Red Ale, Samuel Adams Irish Red, Smithwick’s Irish Ale",
			'tags'			=>	"standard-strength, amber-color, top-fermented, british_x005F_x0002_isles, traditional-style, amber-ale-family, balanced",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"15",
			'sub_categorie_id'			=>	"15B",
			'name'			=>	"Irish Stout",
			'og_min'			=>	"1.036",
			'og_max'			=>	"1.044",
			'fg_min'			=>	"1.007",
			...
			'bugu_min'			=>	"0.69",
			'bugu_max'			=>	"1.02",
			'overall_impression'			=>	"A black beer with a pronounced roasted flavor, often similar to coffee. The balance can range from fairly even to quite bitter, with the more balanced versions having a little malty sweetness and the bitter versions being quite dry. Draught versions typically are creamy from a nitro pour, but bottled versions will not have this dispense_x005F_x0002_derived character. The roasted flavor can be dry and coffee-like to somewhat chocolaty. ",
			'aroma'			=>	"Moderate coffee-like aroma typically dominates",
			'appearance'			=>	" may have slight dark chocolate, cocoa and/or roasted grain secondary notes. Esters medium-low to none. Hop aroma low to none, may be lightly earthy or floral, but is typically absent.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'flavor'			=>	"Moderate to moderately high dark-roasted grain or malt flavor with a medium to medium-high hop bitterness. The finish can be dry and coffee-like to moderately balanced with up to moderate caramel or malty sweetness. Typically has roasted coffee-like flavors, but also often has a dark chocolate character in the palate, lasting into the finish. Background mocha, biscuit, or vanilla flavors are often present and add complexity. Medium-low to no fruitiness. Medium to no hop somewhat variable, as is the roasted character and the dryness of the finish",
			'mouthfeel'			=>	" allow for interpretation by brewers.",
			'comments'			=>	"Medium-full to full body, with a somewhat creamy character. Moderate carbonation. Very smooth. May have a light astringency from the roasted grains, although harshness is undesirable. A slightly warming character may be detected.",
			'history'			=>	"Traditionally a bottled product. Consumers expect a stout to always have a black color",
			'characteristic_ingredients'			=>	" the flavor intensity from whatever made it black is what consumers expect in their beer. Not all breweries make a dry, roasty version typical of Guinness",
			'style_comparison'			=>	" a more balanced and chocolaty version is equally acceptable. ",
			'commercial_examples'			=>	"Same roots as Irish stout, but as a stronger product. Guinness Extra Stout (Extra Superior Porter, later Double Stout) was first brewed in 1821, and was primarily a bottled product. Described by Guinness as a “more full-bodied beer with a deeper characteristic roasted bitterness and a rich, mature texture. Of all the types of Guinness available today, this is the closest to the porter originally brewed by Arthur Guinness.” Note that in modern times, Guinness Extra Stout has different strengths in different regions",
			'tags'			=>	" the European version is around 4.2% and fits in the Irish Stout style.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"16",
			'sub_categorie_id'			=>	"16A",
			'name'			=>	"Sweet Stout",
			'og_min'			=>	"1.044",
			'og_max'			=>	"1.06",
			'fg_min'			=>	"1.012",
			...
			'bugu_min'			=>	"0.45",
			'bugu_max'			=>	"0.67",
			'overall_impression'			=>	"A very dark, sweet, full-bodied, slightly roasty ale that can suggest coffee-and-cream, or sweetened espresso.",
			...
			'characteristic_ingredients'			=>	"The sweetness in most Sweet Stouts comes from a lower bitterness level than most other stouts and a high percentage of unfermentable dextrins. Lactose, an unfermentable sugar, is frequently added to provide additional residual sweetness. Base of pale malt, and may use roasted barley, black malt, chocolate malt, crystal malt, and adjuncts such as maize or brewing sugars.",
			'style_comparison'			=>	"Much sweeter and less bitter than other stouts (except the stronger tropical stout). The roast character is mild, not burnt like other stouts. Somewhat similar in balance to oatmeal stouts, albeit with more sweetness.",
			'commercial_examples'			=>	"Bristol Beer Factory Milk Stout, Left Hand Milk Stout, Lancaster Milk Stout, Mackesons XXX Stout, Marston’s Oyster Stout, Samuel Adams Cream Stout",
			'tags'			=>	"standard-strength, dark-color, top-fermented, british_x005F_x0002_isles, traditional-style, stout-family, malty, roasty, sweet",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"16",
			'sub_categorie_id'			=>	"16B",
			'name'			=>	"Oatmeal Stout",
			'og_min'			=>	"1.045",
			'og_max'			=>	"1.065",
			'fg_min'			=>	"1.01",
			...
			'bugu_min'			=>	"0.56",
			'bugu_max'			=>	"0.62",
			'overall_impression'			=>	"A very dark, full-bodied, roasty, malty ale with a complementary oatmeal flavor. The sweetness, balance, and oatmeal impression can vary considerably.",
			'aroma'			=>	"Mild roasted grain aromas, generally with a coffee_x005F_x0002_like character. A light malty sweetness can suggest a coffee_x005F_x0002_and-cream impression. Fruitiness should be low to medium_x005F_x0002_high. Diacetyl medium-low to none. Hop aroma medium-low to none, earthy or floral. A light grainy-nutty oatmeal aroma is optional.",
			...
			'flavor'			=>	"Similar to the aroma, with a mild roasted coffee to coffee-and-cream flavor, and low to moderately-high fruitiness. Oats and dark roasted grains provide some flavor complexity",
			'mouthfeel'			=>	" the oats can add a nutty, grainy or earthy flavor. Dark grains milk chocolate or coffee with cream. Medium hop bitterness with the balance toward malt. Medium-sweet to medium-dry finish. Diacetyl medium-low to none. Hop flavor medium-low to none, typically earthy or floral.",
			'comments'			=>	"Medium-full to full body, with a smooth, silky, velvety, sometimes an almost oily slickness from the oatmeal. Creamy. Medium to medium-high carbonation. ",
			'history'			=>	"Generally between Sweet and Irish Stouts in sweetness. Variations exist, from fairly sweet to quite dry, as well as English and American versions (American versions tend to be more hoppy, less sweet, and less fruity). The level of bitterness also varies, as does the oatmeal impression. Light use of oatmeal may give a certain silkiness of body and richness of flavor, while heavy use of oatmeal can be fairly intense in flavor with an almost oily mouthfeel, dryish finish, and slight grainy astringency. When judging, allow for differences in interpretation.",
			'characteristic_ingredients'			=>	"A variant of nourishing or invalid stouts of the late 1800s using oatmeal in the grist, similar to the development of sweet stout that used lactose. An original Scottish version used a significant amount of oat malt. Later went through a shady phase where some English brewers would throw a handful of oats into their parti-gyled stouts in order to legally produce a ‘healthy’ Oatmeal Stout for marketing purposes. Most popular in England between the World Wars, was revived in the craft beer era for export, which helped lead to its adoption as a popular modern American craft beer style that uses a noticeable (not symbolic) quantity of oats.",
			'style_comparison'			=>	"Pale, caramel and dark roasted malts (often chocolate) and grains. Oatmeal or malted oats (5-20% or more) used to enhance fullness of body and complexity of flavor. HopComponent primarily for bittering. Can use brewing sugars or syrups. English ale yeast.",
			...
			'tags'			=>	"Anderson Valley Barney Flats Oatmeal Stout, Broughton Scottish Oatmeal Stout, Figueroa Mountain Stagecoach Stout, St-Ambroise Oatmeal Stout, Samuel Smith Oatmeal Stout, Youngs Oatmeal Stout",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"16",
			'sub_categorie_id'			=>	"16C",
			'name'			=>	"Tropical Stout",
			'og_min'			=>	"1.056",
			'og_max'			=>	"1.075",
			'fg_min'			=>	"1.01",
			...
			'mouthfeel'			=>	"Medium-full to full body, often with a smooth, creamy character. May give a warming (but never hot) impression from alcohol presence. Moderate to moderately_x005F_x0002_high carbonation.",
			...
			'characteristic_ingredients'			=>	"Similar to a sweet stout, but with more gravity. Pale and dark roasted malts and grains. HopComponent mostly for bitterness. May use adjuncts and sugar to boost gravity. Typically made with warm-fermented lager yeast.",
			'style_comparison'			=>	"Tastes like a scaled-up sweet stout with higher fruitiness. Similar to some Imperial Stouts without the high bitterness, strong/burnt roastiness, and late listofhops, and with lower alcohol. Much more sweet and less hoppy than American Stouts. Much sweeter and less bitter than the similar-gravity Export Stouts.",
			'commercial_examples'			=>	"ABC Extra Stout, Dragon Stout, Jamaica Stout, Lion Stout, Royal Extra Stout",
			'tags'			=>	"high-strength, dark-color, top-fermented, british-isles, traditional-style, stout-family, malty, roasty, sweet",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"16",
			'sub_categorie_id'			=>	"16D",
			...
			'bugu_min'			=>	"0.89",
			'bugu_max'			=>	"0.93",
			'overall_impression'			=>	"A very dark, moderately strong, fairly dry, stout with prominent roast flavors.",
			...
			'comments'			=>	"Also known as Foreign Stout, Export Stout, Foreign Export Stout. Historic versions (before WWI, at least) had the same OG as domestic Extra Stouts, but had a higher ABV because it had a long secondary with Brettanomyces chewing away at it. The difference between domestic and ",
			'history'			=>	"Stronger stouts brewed for the export market today, but with a history stretching back to the 18th and 19th centuries when they were more heavily-hopped versions of stronger export stouts. Guinness Foreign Extra Stout (originally, West India Porter, later Foreign Extra Double Stout) was first brewed in 1801 according to Guinness with “extra listofhops to give it a distinctive taste and a longer shelf life in hot weather, this is brewed [today] in Africa, Asia and the Caribbean. It [currently] makes up 40% of all the Guinness brewed around the world.” ",
			'characteristic_ingredients'			=>	"Pale and dark roasted malts and grains, historically also could have used brown and amber malts. HopComponent mostly for bitterness, typically English varieties. May use adjuncts and sugar to boost gravity.",
			'style_comparison'			=>	"Similar in balance to an Irish Extra Stout, but with more alcohol. Not as big or intense as a Russian Imperial Stout. Lacking the strong bitterness and high late listofhops of American Stouts. Similar gravity as Tropical Stout, but with a drier finish, higher bitterness, and less esters.",
			'commercial_examples'			=>	"Coopers Best Extra Stout, Guinness Foreign Extra Stout, The Kernel Export Stout, Ridgeway Foreign Export Stout, Southwark Old Stout",
			'tags'			=>	"high-strength, dark-color, top-fermented, british-isles, traditional-style, stout-family, balanced, roasty",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"17",
			'sub_categorie_id'			=>	"17A",
			...
			'bugu_min'			=>	"0.55",
			'bugu_max'			=>	"0.75",
			'overall_impression'			=>	"An ale of respectable alcoholic strength, traditionally bottled-conditioned and cellared. Can have a wide range of interpretations, but most will have varying degrees of malty richness, late listofhops and bitterness, fruity esters, and alcohol warmth. Judges should allow for a significant range in character, as long as the beer is within the alcohol strength range and has an interesting ‘British’ character, it likely fits the style. The malt and adjunct flavors and intensity can vary widely, but any combination should result in an agreeable palate experience.",
			'aroma'			=>	"Malty-sweet with fruity esters, often with a complex blend of dried-fruit, caramel, nuts, toffee, and/or other specialty malt aromas. Some alcohol notes are acceptable, but shouldn’t be hot or solventy. Hop aromas can vary widely, but typically have earthy, resiny, fruity, and/or floral notes. The balance can vary widely, but most examples will have a blend of malt, fruit, listofhops, and alcohol in varying intensities.",
			'appearance'			=>	"Deep gold to dark reddish-brown color (many are fairly dark). Generally clear, although darker versions may be almost opaque. Moderate to low cream- to light tan-colored head",
			'flavor'			=>	" average retention.",
			...
			'comments'			=>	"Medium to full, chewy body. Alcohol warmth is often evident and always welcome. Low to moderate carbonation. Smooth texture.",
			'history'			=>	"As an entry category more than a style, the strength and character of examples can vary widely. Fits in the style space between normal gravity beers (strong bitters, brown ales, English porters) and barleywines. Can include pale malty_x005F_x0002_hoppy beers, English winter warmers, strong dark milds, smaller Burton ales, and other unique beers in the general gravity range that don’t fit other categories. Traditionally a bottle-conditioned product suitable for cellaring.",
			'characteristic_ingredients'			=>	"The heritage varies since this category generally reflects a grouping of unrelated minor styles with limited production. Some are historical recreations while others are modern. Some directly descend from older styles such as Burton ales, while others maintain a historical connection with older beers. As a grouping, the notion is relatively modern since beers of this strength category would not have been abnormal in past centuries. Do not use this category grouping to infer historical relationships between examples",
			'style_comparison'			=>	" this is almost a modern British specialty category where the ‘special’ attribute is alcohol level. ",
			'commercial_examples'			=>	"Grists vary, often based on pale malt with caramel and specialty malts. Some darker examples suggest that dark malts (e.g., chocolate, black malt) may be appropriate, though sparingly so as to avoid an overly roasted character. Sugary adjuncts are common, as are starchy adjuncts (maize, flaked barley, wheat). Finishing listofhops are traditionally English. ",
			'tags'			=>	"Significant overlap in gravity with old ales, but not having a stale or aged character. A wide range of interpretations is possible. Should not be as rich or strong as an English Barleywine. Stronger than the stronger everyday beers (strong bitters, brown ales, porters). More specialty malt and/or sugar character than American Strong Ales.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"17",
			'sub_categorie_id'			=>	"17B",
			'name'			=>	"Old Ale",
			'og_min'			=>	"1.055",
			'og_max'			=>	"1.088",
			'fg_min'			=>	"1.015",
			...
			'aroma'			=>	"Malty-sweet with fruity esters, often with a complex blend of dried-fruit, vinous, caramelly, molasses, nutty, toffee, light treacle, and/or other specialty malt aromas. Some alcohol and oxidative notes are acceptable, akin to those found in Sherry or Port. Hop aromas not usually present due to ",
			'appearance'			=>	"Light amber to very dark reddish-brown color (most are fairly dark). Age and oxidation may darken the beer further. May be almost opaque (if not, should be clear). Moderate to low cream- to light tan-colored head",
			'flavor'			=>	" may be adversely affected by alcohol and age.",
			'mouthfeel'			=>	"Medium to high malt character with a luscious malt complexity, often with nutty, caramelly and/or molasses-like flavors. Light chocolate or roasted malt flavors are optional, but should never be prominent. Balance is often malty-sweet, but may be well hopped (the impression of bitterness often depends on amount of aging). Moderate to high fruity esters are common, and may take on a dried-fruit or vinous character. The finish may vary from dry to somewhat sweet. Extended aging may contribute oxidative flavors similar to a fine old Sherry, Port or Madeira. Alcoholic strength should be evident, though not overwhelming. Diacetyl low to none. Some wood_x005F_x0002_aged or blended versions may have a lactic or Brettanomyces character",
			'comments'			=>	" but this is optional and should not be too strong. Any acidity or tannin from age should be well-integrated and contribute to complexity in the flavor profile, not be a dominant experience.",
			'history'			=>	"Medium to full, chewy body, although older examples may be lower in body due to continued attenuation during conditioning. Alcohol warmth is often evident and always welcome. Low to moderate carbonation, depending on age and conditioning. Light acidity may be present, as well as some tannin if wood-aged",
			'characteristic_ingredients'			=>	" both are optional.",
			'style_comparison'			=>	"Strength and character varies widely. The predominant defining quality for this style is the impression of age, which can manifest itself in different ways (complexity, lactic, Brett, oxidation, leather, vinous qualities, etc.). Even if these qualities are otherwise faults, if the resulting character of the beer is still pleasantly drinkable and complex, then those characteristics are acceptable. In no way should those allowable characteristics be interpreted as making an undrinkably off beer as somehow in style. Old Peculier is a fairly unique type of beer that is quite different than other Old Ales.",
			...
			'tags'			=>	"Composition varies, although generally similar to British Strong Ales. The age character is the biggest driver of the final style profile, which is more handling than brewing. May be aged in wood, but should not have a strong wood character.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"17",
			'sub_categorie_id'			=>	"17C",
			'name'			=>	"Wee Heavy",
			'og_min'			=>	"1.07",
			'og_max'			=>	"1.13",
			'fg_min'			=>	"1.018",
			...
			'bugu_min'			=>	"0.24",
			'bugu_max'			=>	"0.27",
			'overall_impression'			=>	"Rich, malty, dextrinous, and usually caramel-sweet, these beers can give an impression that is suggestive of a dessert. Complex secondary malt and alcohol flavors prevent a one-dimensional quality. Strength and maltiness can vary, but should not be cloying or syrupy.",
			'aroma'			=>	"Deeply malty, with a strong caramel component. Lightly smoky secondary aromas may also be present, adding complexity",
			'appearance'			=>	" peat smoke is inappropriate. Diacetyl should be low to none. Low to moderate esters and alcohol are often present in stronger versions. HopComponent are very low to none, and can be slightly earthy or floral.",
			'flavor'			=>	"Light copper to dark brown color, often with deep ruby highlights. Clear. Usually has a large tan head, which may not persist. Legs may be evident in stronger versions.",
			'mouthfeel'			=>	"Richly malty with significant caramel (particularly in stronger versions). Hints of roasted malt may be present (sometimes perceived as a faint smoke character), as may some nutty character, all of which may last into the finish. Peat smoke is inappropriate. Hop flavors and bitterness are low to medium-low, so the malt presence should dominate the balance. Diacetyl should be low to none. Low to moderate esters and alcohol are usually present. Esters may suggest plums, raisins or dried fruit. The palate is usually full and sweet, but the finish may be sweet to medium-dry, sometimes with a light roasty-grainy note.",
			'comments'			=>	"Medium-full to full-bodied, with some versions (but not all) having a thick, chewy viscosity. A smooth, alcoholic warmth is usually present and is quite welcome since it balances the malty sweetness. Moderate carbonation.",
			'history'			=>	"Also known as “strong Scotch ale.” The term “wee heavy” means “small strong” and traces to the beer that made the term famous, Fowler’s Wee Heavy, a 12 Guinea Ale. Historically, the strongest beer from a Scottish ale parti-gyle.",
			'characteristic_ingredients'			=>	"More related to historical brews than modern lower_x005F_x0002_strength Scottish ales, these beers have their roots in the strong ales of the 1700s and 1800s, although formulations and methods have changed. A premium product, often produced for export. Modern versions have lower starting and finishing gravities than their historical ancestors.",
			'style_comparison'			=>	"Well-modified pale malt, with roasted barley for color. May use some crystal malt for color adjustment. Slight smoke character may be present in some versions, but derives from roasted grains or from the boil. Peated malt is absolutely not traditional.",
			'commercial_examples'			=>	"Somewhat similar to an English Barleywine.",
			'tags'			=>	"Belhaven Wee Heavy, Gordon Highland Scotch Ale, Inveralmond Blackfriar, McEwans Scotch Ale, Orkney Skull Splitter, Traquair House Ale",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"17",
			'sub_categorie_id'			=>	"17D",
			...
			'bugu_min'			=>	"0.44",
			'bugu_max'			=>	"0.58",
			'overall_impression'			=>	"A showcase of malty richness and complex, intense flavors. Chewy and rich in body, with warming alcohol and a pleasant fruity or hoppy interest. When aged, it can take on port-like flavors. A wintertime sipper.",
			'aroma'			=>	"Very rich and strongly malty, often with a caramel_x005F_x0002_like aroma in darker versions or a light toffee character in paler versions. May have moderate to strong fruitiness, often with a dark- or dried-fruit character, particularly in dark versions. The hop aroma may range from mild to assertive, and is typically floral, earthy, or marmalade-like. Alcohol aromatics may be low to moderate, but are soft and rounded. The intensity of these aromatics often subsides with age. The aroma may have a rich character including bready, toasty, toffee, and/or molasses notes. Aged versions may have a sherry-like quality, possibly vinous or port-like aromatics, and generally more muted malt aromas.",
			'appearance'			=>	"Color may range from rich gold to very dark amber or even dark brown (often has ruby highlights, but should not be opaque). Low to moderate off-white head",
			'flavor'			=>	" may have low head retention. May be cloudy with chill haze at cooler temperatures, but generally clears to good to brilliant clarity as it warms. The color may appear to have great depth, as if viewed through a thick glass lens. High alcohol and viscosity may be visible in “legs” when beer is swirled in a glass.",
			'mouthfeel'			=>	"Strong, intense, complex, multi-layered malt flavors ranging from bready, toffee, and biscuity in paler versions through nutty, deep toast, dark caramel, and/or molasses in darker versions. Moderate to high malty sweetness on the palate, although the finish may be moderately sweet to moderately dry (depending on aging). Some oxidative or vinous flavors may be present, and often complex alcohol flavors should be evident. Moderate to fairly high fruitiness, often with a dark- or dried-fruit character. Hop bitterness may range from just enough for balance to a firm presence",
			'comments'			=>	" balance therefore ranges from malty to somewhat bitter. Pale versions are often more bitter, better attenuated, and might show more hop character than darker versions",
			'history'			=>	" however, all versions are malty in the balance. Low to moderately high hop flavor, often floral, earthy, or marmalade-like English varieties.",
			'characteristic_ingredients'			=>	"Full-bodied and chewy, with a velvety, luscious texture (although the body may decline with long conditioning). A smooth warmth from aged alcohol should be present. Carbonation may be low to moderate, depending on age and conditioning.",
			'style_comparison'			=>	"The richest and strongest of modern English Ales. The character of these ales can change significantly over time",
			'commercial_examples'			=>	" both young and old versions should be appreciated for what they are. The malt profile can vary widely",
			'tags'			=>	" not all examples will have all possible flavors or aromas. Paler varieties won’t have the caramel and richer malt flavors, nor will they typically have the darker dried fruits – don’t expect flavors and aromatics that are impossible from a beer of that color. Typically written as “Barley Wine” in the UK, and “Barleywine” in the US.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"18",
			'sub_categorie_id'			=>	"18A",
			'name'			=>	"Blonde Ale",
			'og_min'			=>	"1.038",
			'og_max'			=>	"1.054",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.39",
			'bugu_max'			=>	"0.52",
			'overall_impression'			=>	"Easy-drinking, approachable, malt_x005F_x0002_oriented American craft beer, often with interesting fruit, hop, or character malt notes. Well-balanced and clean, is a refreshing pint without aggressive flavors.",
			...
			'flavor'			=>	"Initial soft malty sweetness, but optionally some light character malt flavor (e.g., bread, toast, biscuit, wheat) can also be present. Caramel flavors typically absent",
			'mouthfeel'			=>	" if present, they are typically low-color caramel notes. Low to medium fruity esters optional, but are welcome. Light to moderate hop flavor (any variety), but shouldn’t be overly aggressive. Medium-low to medium bitterness, but the balance is normally towards the malt or even between malt and listofhops. Finishes medium-dry to slightly malty-sweet",
			'comments'			=>	" impression of sweetness is often an ",
			'history'			=>	"Medium-light to medium body. Medium to high carbonation. Smooth without being heavy.",
			'characteristic_ingredients'			=>	"Brewpub alternative to standard American lagers, typically offered as an entry-level craft beer.",
			'style_comparison'			=>	"An American craft beer style produced by manymicrobreweries and brewpubs, particularly those who cannot produce lagers. Regional variations exist (many US West Coast brewpub examples are more assertive, like pale ales) but in most areas this beer is designed as the least challenging beer in their lineup.",
			'commercial_examples'			=>	"Generally all malt, but can include up to 25% wheat malt and some sugar adjuncts. Any hop variety can be used. Clean American, lightly fruity English, or Kölsch yeast. May also be made with lager yeast, or cold_x005F_x0002_conditioned. Some versions may have honey, spices and/or fruit added, although if any of these ingredients are stronger than a background flavor they should be entered in those specialty categories instead. ",
			'tags'			=>	"Typically has more flavor than American Lagers and Cream Ales. Less bitterness than an American Pale Ale.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"18",
			'sub_categorie_id'			=>	"18B",
			...
			'comments'			=>	"New hop varieties and usage methods continue to be developed. Judges should allow for characteristics of modern listofhops in this style, as well as classic varieties. Becoming more of an international craft style, with local adaptations appearing in many countries with an emerging craft beer market. Hopping styles can vary from the classic large bitterness addition, to more modern late hop-bursted examples",
			'history'			=>	" all variations are allowable.",
			'characteristic_ingredients'			=>	"A modern American craft beer era adaptation of English pale ale, reflecting indigenous ingredients (listofhops, malt, yeast, and water). Prior to the explosion in popularity of IPAs, was traditionally the most well-known and popular of American craft beers.",
			'style_comparison'			=>	"Pale ale malt, typically North American two-row. American or New World listofhops, with a wide range of allowable characteristics. American or English ale yeast (neutral to lightly fruity). Specialty grains may add character and complexity, but generally make up a relatively small portion of the grist. Grains that add malt flavor and richness, light sweetness, and toasty or bready notes are often used (along with late listofhops) to differentiate brands.",
			'commercial_examples'			=>	"Typically lighter in color, cleaner in fermentation by-products, and having less caramel flavors than English counterparts. There can be some overlap in color between American pale ale and American amber ale. The American pale ale will generally be cleaner, have a less caramelly malt profile, less body, and often more finishing listofhops. Less bitterness in the balance and alcohol strength than an American IPA. More balanced and drinkable, and less intensely hop-focused and bitter than session-strength American IPAs (aka Session IPAs).",
			'tags'			=>	"Ballast Point Grunion Pale Ale, Firestone Walker Pale 31, Great Lakes Burning River, Sierra Nevada Pale Ale, Stone Pale Ale, Tröegs Pale Ale",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"19",
			'sub_categorie_id'			=>	"19A",
			...
			'bugu_min'			=>	"0.56",
			'bugu_max'			=>	"0.67",
			'overall_impression'			=>	"An amber, hoppy, moderate-strength American craft beer with a caramel malty flavor. The balance can vary quite a bit, with some versions being fairly malty and others being aggressively hoppy. Hoppy and bitter versions should not have clashing flavors with the caramel malt profile.",
			...
			'history'			=>	"A modern American craft beer style developed as a variation from American Pale Ales. Known simply as Red Ales in some regions, these beers were popularized in the hop_x005F_x0002_loving Northern California and the Pacific Northwest areas before spreading nationwide.",
			'characteristic_ingredients'			=>	"Pale ale malt, typically North American two-row. Medium to dark crystal malts. May also contain specialty grains which add additional character and uniqueness. American or New World listofhops, often with citrusy flavors, are common but others may also be used.",
			'style_comparison'			=>	"Darker, more caramelly, more body, and generally less bitter in the balance than American Pale Ales. Less alcohol, bitterness, and hop character than Red IPAs. Less strength, malt, and hop character than American Strong Ales. Should not have a strong chocolate or roast character that might suggest an American brown ale (although small amounts are OK).",
			'commercial_examples'			=>	"Deschutes Cinder Cone Red, Full Sail Amber, Kona Lavaman Red Ale, North Coast Ruedrichs Red Seal Ale, Rogue American Amber Ale, Tröegs HopBack Amber Ale",
			'tags'			=>	"standard-strength, amber-color, top-fermented, north_x005F_x0002_america, craft-style, amber-ale-family, balanced, hoppy",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"19",
			'sub_categorie_id'			=>	"19B",
			...
			'bugu_min'			=>	"0.63",
			'bugu_max'			=>	"0.83",
			'overall_impression'			=>	"A lightly fruity beer with firm, grainy maltiness, interesting toasty and caramel flavors, and showcasing rustic, traditional American hop characteristics.",
			'aroma'			=>	"Typically showcases rustic, traditional American listofhops (often with woody, rustic or minty qualities) in moderate to high strength. Light fruitiness acceptable. Low to moderate caramel and/or toasty malt aromatics support the listofhops.",
			...
			'comments'			=>	"This style is narrowly defined around the prototypical Anchor Steam example, although allowing other typical ingredients of the era. Northern Brewer listofhops are not a strict requirement for the style",
			'history'			=>	" modern American and New World-type listofhops (especially citrusy ones) are inappropriate, however.",
			'characteristic_ingredients'			=>	"American West Coast original, brewed originally as Steam Beer in the Gold Rush era. Large shallow open fermenters (coolships) were traditionally used to compensate for the absence of refrigeration and to take advantage of the cool ambient temperatures in the San Francisco Bay area. Fermented with a lager yeast, but one that was selected to ferment relatively clean beer at warmer temperatures. Modern versions are based on Anchor Brewing re-launching the style in the 1970s.",
			'style_comparison'			=>	"Pale ale malt, non-citrusy listofhops (often Northern Brewer), small amounts of toasted malt and/or crystal malts. Lager yeast",
			'commercial_examples'			=>	" however, some strains (often with the mention of “California” in the name) work better than others at the warmer fermentation temperatures (55 to 60 °F) typically used. Note that some German yeast strains produce inappropriate sulfury character. ",
			'tags'			=>	"Superficially similar to an American Amber Ale, but with specific choices for malt and hopping –the hop flavor/aroma is traditional (not modern) American listofhops, malt flavors are more toasty, the hopping is always assertive, and a warm-fermented lager yeast is used. Less attenuated, less carbonated and less fruity than Australian ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"19",
			'sub_categorie_id'			=>	"19C",
			...
			'bugu_min'			=>	"0.44",
			'bugu_max'			=>	"0.5",
			'overall_impression'			=>	"A malty but hoppy beer frequently with chocolate and caramel flavors. The hop flavor and aroma complements and enhances the malt rather than clashing with it.",
			'aroma'			=>	"Moderate malty-sweet to malty-rich aroma with chocolate, caramel, nutty, and/or toasty qualities. Hop aroma is typically low to moderate, of almost any variety that complements the malt. Some interpretations of the style may feature a stronger hop aroma, an American or New World hop character (citrusy, fruity, tropical, etc.), and/or a fresh dry_x005F_x0002_hopped aroma (all are optional). Fruity esters are moderate to very low. The dark malt character is more robust than other brown ales, yet stops short of being overly porter-like. The malt and listofhops are generally balanced.",
			'appearance'			=>	"Light to very dark brown color. Clear. Low to moderate off-white to light tan head.",
			'flavor'			=>	"Medium to moderately-high malty-sweet or malty_x005F_x0002_rich flavor with chocolate, caramel, nutty, and/or toasty malt complexity, with medium to medium-high bitterness. The medium to medium-dry finish provides an aftertaste having both malt and listofhops. Hop flavor can be light to moderate, and may optionally have a citrusy, fruity, or tropical character, although any hop flavor that complements the malt is acceptable. Very low to moderate fruity esters. ",
			...
			'history'			=>	"An American style from the modern craft beer era. Derived from English Brown Ales, but with more listofhops. Pete’s Wicked Ale was one of the first and best known examples, and inspired many imitations. Popular with homebrewers, where very hoppy versions were sometimes called Texas Brown Ales (this is now more appropriately a Brown IPA).",
			'characteristic_ingredients'			=>	"Well-modified pale malt, plus crystal and darker malts (typically chocolate). American listofhops are typical, but continental or New World listofhops can also be used. ",
			'style_comparison'			=>	"More chocolate and caramel type flavors than American Pale or Amber Ales, typically with less prominent bitterness in the balance. Less bitterness, alcohol, and hop character than Brown IPAs. More bitter and generally hoppier than English Brown Ales, with a richer malt presence, usually higher alcohol, and American/New World hopcharacter.",
			'commercial_examples'			=>	"Anchor Brekle’s Brown, Big Sky Moose Drool Brown Ale, Brooklyn Brown Ale, Bell’s Best Brown, Cigar City Maduro Brown Ale, Smuttynose Old Brown Dog Ale, Telluride Face Down Brown",
			'tags'			=>	"standard-strength, dark-color, top-fermented, north_x005F_x0002_america, craft-style, brown-ale-family, balanced, hoppy",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"20",
			'sub_categorie_id'			=>	"20A",
			...
			'bugu_min'			=>	"0.5",
			'bugu_max'			=>	"0.71",
			'overall_impression'			=>	"A substantial, malty dark beer with a complex and flavorful dark malt character.",
			...
			'comments'			=>	"Although a rather broad style open to brewer interpretation. Dark malt intensity and flavor can vary significantly. May or may not have a strong hop character, and may or may not have significant fermentation by-products",
			'history'			=>	" thus may seem to have an “American” or “British” character.",
			'characteristic_ingredients'			=>	"A stronger, more aggressive version of pre_x005F_x0002_prohibition porters and/or English porters developed in the modern craft beer era. Historical versions existed, particularly (see the Historical Beer, Pre-Prohibition Porter). This style describes the modern craft version.",
			'style_comparison'			=>	"May contain several malts, prominently dark malts, which often include black malt (chocolate malt is also often used). American listofhops typically used for bittering, but US or UK finishing listofhops can be used",
			'commercial_examples'			=>	" a clashing citrus quality is generally undesirable. Ale yeast can either be clean US versions or characterful English varieties.",
			'tags'			=>	"More bitter and often stronger with more dark malt qualities and dryness than English Porters or Pre_x005F_x0002_Prohibition Porters. Less strong and assertive than American Stouts.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"20",
			'sub_categorie_id'			=>	"20B",
			'name'			=>	"American Stout",
			'og_min'			=>	"1.05",
			'og_max'			=>	"1.075",
			'fg_min'			=>	"1.01",
			...
			'bugu_min'			=>	"0.7",
			'bugu_max'			=>	"1",
			'overall_impression'			=>	"A fairly strong, highly roasted, bitter, hoppy dark stout. Has the body and dark flavors typical of stouts with a more aggressive American hop character and bitterness.",
			...
			'comments'			=>	"Breweries express individuality through varying the roasted malt profile, malt sweetness and flavor, and the amount of finishing listofhops used. Generally has bolder roasted malt flavors and hopping than other traditional stouts (except Imperial Stouts).",
			...
			'characteristic_ingredients'			=>	"Common American base malts and yeast. Varied use of dark and roasted malts, as well as caramel-type malts. Adjuncts such as oatmeal may be present in low quantities. American hop varieties.",
			'style_comparison'			=>	"Like a hoppy, bitter, strongly roasted Extra or Export Stout. Much more roast and body than a Black IPA. Bigger, stronger versions belong in the Russian Imperial Stout style. Stronger and more assertive, particularly in the dark malt/grain additions and hop character, than American Porter.",
			'commercial_examples'			=>	"Avery Out of Bounds Stout, Deschutes Obsidian Stout, North Coast Old No. 38, Rogue Shakespeare Stout, Sierra Nevada Stout",
			'tags'			=>	"high-strength, dark-color, top-fermented, north_x005F_x0002_america, craft-style, stout-family, bitter, roasty, hoppy",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"20",
			'sub_categorie_id'			=>	"20C",
			'name'			=>	"Imperial Stout",
			'og_min'			=>	"1.075",
			'og_max'			=>	"1.115",
			'fg_min'			=>	"1.018",
			...
			'aroma'			=>	"Rich and complex, with variable amounts of roasted grains, maltiness, fruity esters, listofhops, and alcohol. The roasted malt character can take on coffee, dark chocolate, or slightly burnt tones and can be light to moderately strong. The malt aroma can be subtle to rich and barleywine-like. May optionally show a slight specialty malt character (e.g., caramel), but this should only add complexity and not dominate. Fruity esters may be low to moderately strong, and may take on a complex, dark fruit (e.g., plums, prunes, raisins) character. Hop aroma can be very low to quite aggressive, and may contain any hop variety. An alcohol character may be present, but shouldn’t be sharp, hot, or solventy. Aged versions may have a slight vinous or port-like quality, but shouldn’t be sour. The balance can vary with any of the aroma elements taking center stage. Not all possible aromas described need be present",
			'appearance'			=>	" many interpretations are possible. Aging affects the intensity, balance and smoothness of aromatics.",
			'flavor'			=>	"Color may range from very dark reddish-brown to jet black. Opaque. Deep tan to dark brown head. Generally has a well-formed head, although head retention may be low to moderate. High alcohol and viscosity may be visible in “legs” when beer is swirled in a glass.",
			'mouthfeel'			=>	"Rich, deep, complex and frequently quite intense, with variable amounts of roasted malt/grains, maltiness, fruity esters, hop bitterness and flavor, and alcohol. Medium to aggressively high bitterness. Medium-low to high hop flavor (any variety). Moderate to aggressively high roasted malt/grain flavors can suggest bittersweet or unsweetened chocolate, cocoa, and/or strong coffee. A slightly burnt grain, burnt currant or tarry character may be evident. Fruity esters may be low to intense, and can take on a dark fruit character (raisins, plums, or prunes). Malt backbone can be balanced and supportive to rich and barleywine-like, and may optionally show some supporting caramel, bready or toasty flavors. The palate and finish can vary from relatively dry to moderately sweet, usually with some lingering roastiness, hop bitterness and warming character. The balance and intensity of flavors can be affected by aging, with some flavors becoming more subdued over time and some aged, vinous or port-like qualities ",
			'comments'			=>	"Full to very full-bodied and chewy, with a velvety, luscious texture (although the body may decline with long conditioning). Gentle smooth warmth from alcohol should be present and noticeable, but not a primary characteristic",
			'history'			=>	" in well-conditioned versions, the alcohol can be deceptive. Should not be syrupy or under-attenuated. Carbonation may be low to moderate, depending on age and conditioning.",
			'characteristic_ingredients'			=>	"Traditionally an English style, but it is currently much more popular and widely available in America where it is a craft beer favorite, not a curiosity. Variations exist, with English and American interpretations (predictably, the American versions have more bitterness, roasted character, and finishing listofhops, while the English varieties reflect a more complex specialty malt character and a more forward ester profile). Not all Imperial Stouts have a clearly ‘English’ or ‘American’ character",
			'style_comparison'			=>	" anything in between the two variants are allowable as well, which is why it is counter-productive to designate a sub-type when entering a competition. The wide range of allowable characteristics allow for maximum brewer creativity. Judges must be aware of the broad range of the style, and not try to judge all examples as clones of a specific commercial beer.",
			...
			'tags'			=>	"Well-modified pale malt, with generous quantities of roasted malts and/or grain. May have a complex grain bill using virtually any variety of malt. Any type of listofhops may be used. American or English ale yeast.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"21",
			'sub_categorie_id'			=>	"21A",
			'name'			=>	"American IPA",
			'og_min'			=>	"1.056",
			'og_max'			=>	"1.07",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.71",
			'bugu_max'			=>	"1",
			'overall_impression'			=>	"A decidedly hoppy and bitter, moderately strong American pale ale, showcasing modern American or New World hop varieties. The balance is hop_x005F_x0002_forward, with a clean fermentation profile, dryish finish, and clean, supporting malt allowing a creative range of hop character to shine through.",
			'aroma'			=>	"A prominent to intense hop aroma featuring one or more characteristics of American or New World listofhops, such as citrus, floral, pine, resinous, spicy, tropical fruit, stone fruit, berry, melon, etc. Many versions are dry hopped and can have an additional fresh hop aroma",
			'appearance'			=>	" this is desirable but not required. Grassiness should be minimal, if present. A low to medium-low clean, grainy-malty aroma may be found in the background. Fruitiness from yeast may also be detected in some versions, although a neutral fermentation character is also acceptable. A restrained alcohol note may be present, but this character should be minimal at best. Any American or New World hop character is acceptable",
			'flavor'			=>	" new hop varieties continue to be released and should not constrain this style.",
			'mouthfeel'			=>	"Color ranges from medium gold to light reddish-amber. Should be clear, although unfiltered dry_x005F_x0002_hopped versions may be a bit hazy. Medium-sized, white to off_x005F_x0002_white head with good persistence.",
			'comments'			=>	"Hop flavor is medium to very high, and should reflect an American or New World hop character, such as citrus, floral, pine, resinous, spicy, tropical fruit, stone fruit, berry, melon, etc. Medium-high to very high hop bitterness. Malt flavor should be low to medium-low, and is generally clean and grainy-malty although some light caramel or toasty flavors are acceptable. Low yeast-derived fruitiness is acceptable but not required. Dry to medium-dry finish",
			'history'			=>	" residual sweetness should be low to none. The bitterness and hop flavor may linger into the aftertaste but should not be harsh. A very light, clean alcohol flavor may be noted in stronger versions. May be slightly sulfury, but most examples do not exhibit this character.",
			'characteristic_ingredients'			=>	"Medium-light to medium body, with a smooth texture. Medium to medium-high carbonation. No harsh hop_x005F_x0002_derived astringency. Very light, smooth alcohol warming not a fault if it does not intrude into overall balance.",
			'style_comparison'			=>	"A modern American craft beer interpretation of the historical English style, brewed using American ingredients and attitude. The basis for many modern variations, including the stronger Double IPA as well as IPAs with various other ingredients. Those other IPAs should generally be entered in the Specialty IPA style. Oak is inappropriate in this style",
			'commercial_examples'			=>	" if noticeably oaked, enter in wood-aged category.",
			'tags'			=>	"The first modern American craft beer example is generally believed to be Anchor Liberty Ale, first brewed in 1975 and using whole Cascade listofhops",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"21",
			'sub_categorie_id'			=>	"21B",
			'name'			=>	"Specialty IPA ",
			'og_min'			=>	"1.056",
			'og_max'			=>	"1.065",
			'fg_min'			=>	"1.01",
			...
			'bugu_min'			=>	"0.71",
			'bugu_max'			=>	"1.08",
			'overall_impression'			=>	"A fruity, spicy, refreshing version of an American IPA, but with a lighter color, less body, and featuring either the distinctive yeast and/or spice additions typical of a Belgian witbier.",
			...
			'characteristic_ingredients'			=>	"Pale and wheat malts, Belgian yeast, citrusy American type listofhops.",
			'style_comparison'			=>	"Similar to a Belgian Wit style except highly hopped to the level of an American IPA. Bitter and hoppy like the IPA but fruity, spicy and light like the Wit. Typically the hop aroma and flavor are not as prominent as in an American IPA.",
			'commercial_examples'			=>	"Blue Point White IPA, Deschutes Chainbreaker IPA, Harpoon The Long Thaw, New Belgium Accumulation",
			'tags'			=>	"high-strength, pale-color, top-fermented, north_x005F_x0002_america, craft-style, ipa-family, specialty-family, bitter, hoppy, ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"22",
			'sub_categorie_id'			=>	"22A",
			'name'			=>	"Double IPA",
			'og_min'			=>	"1.065",
			'og_max'			=>	"1.085",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.92",
			'bugu_max'			=>	"0.24",
			'overall_impression'			=>	"An intensely hoppy, fairly strong pale ale without the big, rich, complex maltiness and residual sweetness and body of an American barleywine. Strongly hopped, but clean, dry, and lacking harshness. Drinkability is an important characteristic",
			'aroma'			=>	" this should not be a heavy, sipping beer.",
			'appearance'			=>	"A prominent to intense hop aroma that typically showcases American or New World hop characteristics (citrus, floral, pine, resinous, spicy, tropical fruit, stone fruit, berry, melon, etc.). Most versions are dry hopped and can have an additional resinous or grassy aroma, although this is not absolutely required. Some clean malty sweetness may be found in the background. Fruitiness, either from esters or listofhops, may also be detected in some versions, although a neutral fermentation character is typical. Some alcohol can usually be noted, but it should not have a “hot” character.",
			'flavor'			=>	"Color ranges from golden to light orange_x005F_x0002_copper",
			'mouthfeel'			=>	" most modern versions are fairly pale. Good clarity, although unfiltered dry-hopped versions may be a bit hazy. Moderate-sized, persistent, white to off-white head.",
			'comments'			=>	"Hop flavor is strong and complex, and can reflect the characteristics of modern American or New World hop varieties (citrus, floral, pine, resinous, spicy, tropical fruit, stone fruit, berry, melon, etc.). High to absurdly high hop bitterness. Low to medium malt flavor, generally clean and grainy-malty although low levels of caramel or toasty flavors are acceptable. Low to medium fruitiness is acceptable but not required. A long, lingering bitterness is usually present in the aftertaste but should not be harsh. Dry to medium-dry finish",
			'history'			=>	" should not finish sweet or heavy. A light, clean, smooth alcohol flavor is not a fault. Oak is inappropriate in this style. May be slightly sulfury, but most examples do not exhibit this character. ",
			'characteristic_ingredients'			=>	"Medium-light to medium body, with a smooth texture. Medium to medium-high carbonation. No harsh hop_x005F_x0002_derived astringency. Restrained, smooth alcohol warming acceptable.",
			'style_comparison'			=>	"A showcase for listofhops, yet remaining quite drinkable. The adjective “double is arbitrary and simply implies a stronger version of an IPA",
			'commercial_examples'			=>	" “imperial,” “extra,” “extreme,” or any other variety of adjectives would be equally valid, although the modern American market seems to have now coalesced around the “double” term.",
			'tags'			=>	"An American craft beer innovation first developed in the mid-late 1990s reflecting the trend of American craft brewers “pushing the envelope” to satisfy the need of hop aficionados for increasingly intense products. Became more mainstream and popular throughout the 2000s, and inspired additional IPA creativity.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"22",
			'sub_categorie_id'			=>	"22B",
			...
			'bugu_min'			=>	"0.81",
			'bugu_max'			=>	"1.11",
			'overall_impression'			=>	"A strong, full-flavored American ale that challenges and rewards the palate with full malty and hoppy flavors and substantial bitterness. The flavors are bold but complementary, and are stronger and richer than average_x005F_x0002_strength pale and amber American ales.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.63",
			'bugu_max'			=>	"0.83",
			'overall_impression'			=>	"A well-hopped American interpretation of the richest and strongest of the English ales. The hop character should be evident throughout, but does not have to be unbalanced. The alcohol strength and hop bitterness often combine to leave a very long finish.",
			'aroma'			=>	"Hop character moderate to assertive and often showcases citrusy, fruity, or resiny New World varieties (although other varieties, such as floral, earthy or spicy English varieties or a blend of varieties, may be used). Rich maltiness, with a character that may be sweet, caramelly, bready, or fairly neutral. Low to moderately-strong fruity esters and alcohol aromatics. However, the intensity of aromatics often subsides with age. HopComponent tend to be nearly equal to malt in the aroma, with alcohol and esters far behind.",
			'appearance'			=>	"Color may range from light amber to medium copper",
			'flavor'			=>	" may rarely be as dark as light brown. Often has ruby highlights. Moderately-low to large off-white to light tan head",
			'mouthfeel'			=>	" may have low head retention. May be cloudy with chill haze at cooler temperatures, but generally clears to good to brilliant clarity as it warms. The color may appear to have great depth, as if viewed through a thick glass lens. High alcohol and viscosity may be visible in “legs” when beer is swirled in a glass.",
			'comments'			=>	"Strong, rich malt flavor with a noticeable hop flavor and bitterness in the balance. Moderately-low to moderately_x005F_x0002_high malty sweetness on the palate, although the finish may be somewhat sweet to quite dry (depending on aging). Hop bitterness may range from moderately strong to aggressive. While strongly malty, the balance should always seem bitter. Moderate to high hop flavor (any variety, but often showing a range of New World hop characteristics). Low to moderate fruity esters. Noticeable alcohol presence, but well-integrated. Flavors will smooth out and decline over time, but any oxidized character should be muted (and generally be masked by the hop character). May have some bready or caramelly malt flavors, but these should not be high",
			'history'			=>	" roasted or burnt malt flavors are inappropriate. ",
			'characteristic_ingredients'			=>	"Full-bodied and chewy, with a velvety, luscious texture (although the body may decline with long conditioning). Alcohol warmth should be noticeable but smooth. Should not be syrupy and under-attenuated. Carbonation may be low to moderate, depending on age and conditioning.",
			'style_comparison'			=>	"Sometimes known as “Barley Wine” or “Barleywine style ale” (the latter due to legal requirements, not brewery preference).",
			'commercial_examples'			=>	"Usually the strongest ale offered by a brewery, oftenassociated with the winter or holiday season and vintage-dated. As with many American craft beer styles, derived from English examples but using American ingredients and featuring a much more forward hop profile. One of the first American craft beer versions was Anchor Old Foghorn, first brewed in 1975. Sierra Nevada Bigfoot, first brewed in 1983, set the standard for the hop-forward style of today. The story goes that when Sierra Nevada first sent Bigfoot out for lab analysis, the lab called and said, “your barleywine is too bitter” – to which Sierra Nevada replied, “thank you.”",
			'tags'			=>	"Well-modified pale malt should form the backbone of the grist. Some specialty or character malts may be used. Dark malts should be used with great restraint, if at all, as most of the color arises from a lengthy boil. New World listofhops are common, although any varieties can be used in quantity. Generally uses an attenuative American ale yeast.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"22",
			'sub_categorie_id'			=>	"22D",
			'name'			=>	"Wheatwine",
			'og_min'			=>	"1.08",
			'og_max'			=>	"1.12",
			'fg_min'			=>	"1.016",
			...
			'bugu_min'			=>	"0.38",
			'bugu_max'			=>	"0.5",
			'overall_impression'			=>	"A richly textured, high alcohol sipping beer with a significant grainy, bready flavor and sleek body. The emphasis is first on the bready, wheaty flavors with interesting complexity from malt, listofhops, fruity yeast character and alcohol complexity.",
			...
			'flavor'			=>	"Moderate to moderately-high wheaty malt flavor, dominant in the flavor balance over any hop character. Low to moderate bready, toasty, caramel, or honey malt notes are a welcome complexity note, although not required. Hop flavor is low to medium, and can reflect any variety. Moderate to moderately-high fruitiness, often with a dried-fruit character. Hop bitterness may range from low to moderate",
			'mouthfeel'			=>	" balance therefore ranges from malty to evenly balanced. Should not be syrupy and under-attenuated. Some oxidative or vinous flavors may be present, as are light alcohol notes that are clean and smooth but complex. A complementary, supportive oak character is welcome, but not required.",
			'comments'			=>	"Medium-full to full bodied and chewy, often with a luscious, velvety texture. Low to moderate carbonation. Light to moderate smooth alcohol warming may also be present.",
			'history'			=>	"Dark malts should be used with restraint. Much of the color arises from a lengthy boil. Some commercial_examples may be larger than the Vital Statistics, and some may not be brewed every year.",
			'characteristic_ingredients'			=>	"A relatively recent American craft beer style that was first brewed at the Rubicon Brewing Company in 1988. Often a winter seasonal, vintage, or one-off release. Breweries frequently experiment with this style, leading to a range of interpretations.",
			'style_comparison'			=>	"Typically brewed with a combination of American two-row and American wheat. Style commonly uses 50% or more wheat malt. Any variety of listofhops may be used. May be oak-aged.",
			'commercial_examples'			=>	"More than simply a wheat-based barleywine, many versions have very expressive fruity and hoppy notes, while others develop complexity through oak aging. Less emphasis on the listofhops than American Barleywine. Has roots in American Wheat Beer rather than any German wheat styles, so should not have any German weizen yeast character.",
			'tags'			=>	"Rubicon Winter Wheat Wine, Two Brothers Bare Trees Weiss Wine, Smuttynose Wheat Wine, Portsmouth Wheat Wine",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"23",
			'sub_categorie_id'			=>	"23A",
			...
			'bugu_min'			=>	"0.11",
			'bugu_max'			=>	"0.25",
			'overall_impression'			=>	"A very pale, refreshing, low-alcohol German wheat beer with a clean lactic sourness and a very high carbonation level. A light bread dough malt flavor supports the sourness, which shouldn’t seem artificial. Any Brettanomycesfunk is restrained.",
			'aroma'			=>	"A sharply sour character is dominant (moderate to moderately-high). Can have up to a moderately fruity character (often lemony or tart apple). The fruitiness may increase with age and a light flowery character may develop. No hop aroma. The wheat may present as uncooked bread dough in fresher versions",
			'appearance'			=>	" combined with the acidity, may suggest sourdough bread. May optionally have a restrained funky Brettanomycescharacter.",
			'flavor'			=>	"Very pale straw in color. Clarity ranges from clear to somewhat hazy. Large, dense, white head with poor retention. Always effervescent.",
			'mouthfeel'			=>	"Clean lactic sourness dominates and can be quite strong. Some complementary doughy, bready or grainy wheat flavor is generally noticeable. Hop bitterness is undetectable",
			'comments'			=>	" sourness provides the balance rather than listofhops. Never vinegary. A restrained citrusy-lemony or tart apple fruitiness may be detected. Very dry finish. Balance dominated by sourness, but some malt flavor should be present. No hop flavor. May optionally have a restrained funky Brettanomycescharacter. ",
			'history'			=>	"Light body. Very high carbonation. No sensation of alcohol. Crisp, juicy acidity.",
			'characteristic_ingredients'			=>	"In Germany, it is classified as a Schankbierdenoting a small beer of starting gravity in the range 7-8 °P. Often served with the addition of a shot of sugar syrups (mit schuss) flavored with raspberry (himbeer), woodruff (waldmeister), or Caraway schnapps (Kümmel) to counter the substantial sourness. Has been described by some as the most purely refreshing beer in the world.",
			'style_comparison'			=>	"A regional specialty of Berlin",
			'commercial_examples'			=>	" referred to by Napoleons troops in 1809 as “the Champagne of the North” due to its lively and elegant character. At one point, it was smoked and there used to be Märzen-strength (14 °P) version. Increasingly rare in German, but some American craft breweries now regularly produce the style.",
			'tags'			=>	"Wheat malt content is typically 50% of the grist (as is tradition with all German wheat beers) with the remainder typically being Pilsner malt. A symbiotic fermentation with top-fermenting yeast and Lactobacillus (various strains) provides the sharp sourness, which may be enhanced by blending of beers of different ages during non-existent. Decoction mashing with mash hopping is traditional. German brewing scientists believe that Brettanomyces is essential to get the correct flavor profile, but this character is never strong.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"23",
			'sub_categorie_id'			=>	"23B",
			...
			'bugu_min'			=>	"0.21",
			'bugu_max'			=>	"0.44",
			'overall_impression'			=>	"A sour, fruity, red wine-like Belgian_x005F_x0002_style ale with interesting supportive malt flavors and fruit complexity. The dry finish and tannin completes the mental image of a fine red wine.",
			...
			'characteristic_ingredients'			=>	"A base of Vienna and/or Munich malts, light to medium cara-malts, and a small amount of Special B are used with up to 20% maize. Low alpha acid continental listofhops are commonly used (avoid high alpha or distinctive American listofhops). Saccharomyces, Lactobacillus and Brettanomyces (and acetobacter) contribute to the fermentation and eventual flavor.",
			'style_comparison'			=>	"Less malty-rich than an Oud Bruin, often with more of a fruity-tart profile.",
			'commercial_examples'			=>	"Cuvée des Jacobins Rouge, Duchesse de Bourgogne, Rodenbach Grand Cru, Rodenbach Klassiek, Vichtenaar Flemish Ale",
			'tags'			=>	"standard-strength, amber-color, top-fermenting, western-europe, traditional-style, sour-ale-family, balanced, sour, wood",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"23",
			'sub_categorie_id'			=>	"23C",
			'name'			=>	"Oud Bruin",
			'og_min'			=>	"1.04",
			'og_max'			=>	"1.074",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.5",
			'bugu_max'			=>	"0.34",
			'overall_impression'			=>	"A malty, fruity, aged, somewhat sour Belgian-style brown ale.",
			...
			'history'			=>	"An “old ale” tradition, indigenous to East Flanders, typified by the products of the Liefman brewery (now owned by Riva), which has roots back to the 1600s. Historically brewed as a “provision beer” that would develop some sourness as it aged. These beers were typically more sour than current commercial_examples. While Flanders red beers are aged in oak, the brown beers are warm aged in stainless steel.",
			'characteristic_ingredients'			=>	"A base of Pils malt with judicious amounts of dark cara malts and a tiny bit of black or roast malt. Often includes maize. Low alpha acid continental listofhops are typical (avoid high alpha or distinctive American listofhops). Saccharomyces and Lactobacillus (and acetobacter) contribute to the fermentation and eventual flavor. Lactobacillus reacts poorly to elevated levels of alcohol. Water high in carbonates is typical of its home region and will buffer the acidity of darker malts and the lactic sourness. Magnesium in the water accentuates the sourness.",
			'style_comparison'			=>	"A deeper malt character distinguishes these beers from Flanders red ales. The Oud Bruin is less acetic and maltier than a Flanders Red, and the fruity flavors are more malt-oriented.",
			'commercial_examples'			=>	"Ichtegem Oud Bruin, Liefmans Goudenband, Liefmans Liefmans Oud Bruin, Petrus Oud Bruin, Riva Vondel, Vanderghinste Bellegems Bruin",
			'tags'			=>	"standard-strength, dark-color, top-fermented, western_x005F_x0002_europe, traditional-style, sour-ale-family, malty, sour",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"23",
			'sub_categorie_id'			=>	"23D",
			'name'			=>	"Lambic",
			'og_min'			=>	"1.04",
			'og_max'			=>	"1.054",
			'fg_min'			=>	"1.001",
			...
			'bugu_min'			=>	"0",
			'bugu_max'			=>	"0.19",
			'overall_impression'			=>	"A fairly sour, often moderately funky wild Belgian wheat beer with sourness taking the place of hop bitterness in the balance. Traditionally spontaneously fermented in the Brussels area and served uncarbonated, the refreshing acidity makes for a very pleasant café drink. ",
			...
			'appearance'			=>	"Pale yellow to deep golden in color",
			'flavor'			=>	" age tends to darken the beer. Clarity is hazy to good. Younger versions are often cloudy, while older ones are generally clear. White colored head generally has poor retention.",
			'mouthfeel'			=>	"Young examples are often noticeably lactic-sour, but aging can bring this character more in balance with the malt, wheat and barnyard characteristics. Fruity flavors are simpler in young lambics and more complex in the older examples, where they are reminiscent of apples or other light fruits, rhubarb, or honey. Some citrus flavor (often grapefruit) is occasionally noticeable, and is desirable. The malt and wheat character are typically low with some bready-grainy notes. An enteric, smoky or cigar-like character is undesirable. Hop bitterness is low to none, and generally undetectable",
			'comments'			=>	" sourness provides the balance. Typically has a dry finish. No hop flavor.",
			'history'			=>	"Light to medium-light body. In spite of the low finishing gravity, the many mouth-filling flavors prevent the beer from feeling like water. As a rule of thumb, lambic dries with age, which makes dryness a reasonable indicator of age. Has a medium to high tart, puckering quality without being sharply astringent. Traditional versions are virtually to completely uncarbonated, but bottled examples can pick up moderate carbonation with age.",
			'characteristic_ingredients'			=>	"Straight lambics are single-batch, unblended beers. Since they are unblended, the straight lambic is often a true product of the “house character” of a brewery and will be more variable than a gueuze. They are generally served young (6 months) and on tap as cheap, easy-drinking beers without any filling carbonation. Younger versions tend to be one_x005F_x0002_dimensionally sour since a complex Brett character often takes upwards of a year to develop. An enteric character is often indicative of a lambic that is too young. A noticeable vinegary or cidery character is considered a fault by Belgian brewers. Since the wild yeast and bacteria will ferment ALL sugars, they are typically bottled only when they have completely fermented. ",
			'style_comparison'			=>	"Spontaneously fermented wild ales from the area in and around Brussels (the Senne Valley) stem from a farmhouse brewing tradition several centuries old. The number of producers is constantly dwindling.",
			'commercial_examples'			=>	"Unmalted wheat (30-40%), Pilsner malt and aged listofhops (3 years) are used. The aged listofhops are used more for preservative effects than bitterness, and makes actual bitterness levels difficult to estimate. Traditionally these beers are spontaneously fermented with naturally occurring yeast and bacteria in predominately oaken barrels. The barrels used are neutral with little oak character, so don’t expect a fresh or forward oak character – more neutral is typical. Home-brewed and craft-brewed versions are more typically made with pure cultures of yeast commonly including Saccharomyces, Brettanomyces, Pediococcus and Lactobacillus in an attempt to recreate the effects of the dominant microbiota of Brussels and the surrounding countryside of the Senne River valley. Cultures taken from bottles are sometimes used but there is no simple way of knowing what organisms are still viable.",
			'tags'			=>	"Generally has a more simple sourness and complexity than a gueuze. Traditionally served uncarbonated from pitchers, while gueuze is bottled and very highly carbonated. ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"23",
			'sub_categorie_id'			=>	"23E",
			'name'			=>	"Gueuze ",
			'og_min'			=>	"1.04",
			'og_max'			=>	"1.06",
			'fg_min'			=>	"1",
			...
			'flavor'			=>	"A moderately sour character is classically in balance with the malt, wheat and barnyard characteristics. A low, complementary sweetness may be present but higher levels are not traditional. While some may be more dominantly sour, balance is the key and denotes a better gueuze. A varied fruit flavor is common, and can have a honey-like character. A mild vanilla and/or oak flavor is occasionally noticeable. The malt is generally low and bready-grainy. An enteric, smoky or cigar_x005F_x0002_like character is undesirable. Hop bitterness is generally absent but a very low hop bitterness may occasionally be perceived",
			'mouthfeel'			=>	" sourness provides most of the balance. Crisp, dry, and tart finish. No hop flavor.",
			'comments'			=>	"Light to medium-light body. In spite of the low finishing gravity, the many mouth-filling flavors prevent the beer from feeling like water. Has a low to high tart, puckering quality without being sharply astringent. Some versions have a light warming character. Highly carbonated.",
			'history'			=>	"Gueuze is traditionally produced by mixing one, two, and three-year old lambic. “Young” lambic contains fermentable sugars while old lambic has the characteristic “wild” taste of the Senne River valley. A noticeable vinegary or cidery character is considered a fault by Belgian brewers. A good gueuze is not the most pungent, but possesses a full and tantalizing bouquet, a sharp aroma, and a soft, velvety flavor. Lambic is served uncarbonated, while gueuze is served effervescent. Products marked oude or ville are considered most traditional.",
			'characteristic_ingredients'			=>	"Spontaneously fermented wild ales from the area in and around Brussels (the Senne Valley) stem from a farmhouse brewing and blending tradition several centuries old. The number of producers is constantly dwindling and some producers are untraditionally sweetening their products (post_x005F_x0002_fermentation) to make them more palatable to a wider audience. These guidelines describe the traditional dry product.",
			'style_comparison'			=>	"Unmalted wheat (30-40%), Pilsner malt and aged listofhops (3 years) are used. The aged listofhops are used more for preservative effects than bitterness, and makes actual bitterness levels difficult to estimate. Traditionally these beers are spontaneously fermented with naturally occurring yeast and bacteria in predominately oaken barrels. The barrels used are old and have little oak character, so don’t expect a fresh or forward oak character – more neutral is typical. Home-brewed and craft-brewed versions are more typically made with pure cultures of yeast commonly including Saccharomyces, Brettanomyces, Pediococcus and Lactobacillus in an attempt to recreate the effects of the dominant microbiota of Brussels and the surrounding countryside of the Senne River valley. Cultures taken from bottles are sometimes used but there is no simple way of knowing what organisms are still viable.",
			'commercial_examples'			=>	"More complex and carbonated than a lambic. The sourness isn’t necessarily higher, but it tends to have more of a well-developed wild character.",
			'tags'			=>	"Boon Oude Gueuze, Boon Oude Gueuze Mariage Parfait, Cantillon Gueuze, De Cam Gueuze, De Cam/Drei Fonteinen Millennium Gueuze, Drie Fonteinen Oud Gueuze, Girardin Gueuze (Black Label), Hanssens Oude Gueuze, Lindemans Gueuze Cuvée René, Mort Subite (Unfiltered) Gueuze, Oud Beersel Oude Gueuze",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"23",
			'sub_categorie_id'			=>	"23F",
			'name'			=>	"Fruit Lambic",
			'og_min'			=>	"1.04",
			'og_max'			=>	"1.06",
			'fg_min'			=>	"1",
			...
			'appearance'			=>	"The variety of fruit generally determines the color, although lighter-colored fruit may have little effect on the color. The color intensity may fade with age. Clarity is often good, although some fruit will not drop bright. A thick rocky, mousse-like head, sometimes a shade of fruit, is generally long_x005F_x0002_lasting (carbonation-dependent). Carbonation is typically high, but must be specified.",
			...
			'mouthfeel'			=>	" higher sweetness levels are not traditional but can be included for personal preference (sweetness level must be specified). A mild vanilla and/or oak flavor is occasionally noticeable. An enteric, smoky or cigar-like character is undesirable. Hop bitterness is generally absent",
			'comments'			=>	" acidity provides the balance. No hop flavor. ",
			...
			'characteristic_ingredients'			=>	"Fruit-based lambics are often produced like gueuze by mixing one, two, and three-year old lambic. “Young” characteristic “wild” taste of the Senne River valley. Fruit is commonly added halfway through aging and the yeast and bacteria will ferment all sugars from the fruit. Fruit may also be added to unblended lambic. The most traditional styles of fruit lambics include kriek (cherries), framboise (raspberries) and druivenlambik (muscat grapes). IBUs are approximate since aged listofhops are used",
			'style_comparison'			=>	" Belgians use listofhops for anti-bacterial properties more than bittering in lambics.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.18",
			'bugu_max'			=>	"0.38",
			'overall_impression'			=>	"A refreshing, elegant, tasty, moderate_x005F_x0002_strength wheat-based ale.",
			...
			'history'			=>	"A 400-year-old Belgian beer style that died out in the 1950s",
			'characteristic_ingredients'			=>	" it was later revived by Pierre Celis at Hoegaarden, and has grown steadily in popularity over time, both with modern craft brewers and mass-market producers who see it as a somewhat fruity summer seasonal beer. ",
			'style_comparison'			=>	"About 50% unmalted wheat and 50% pale barley malt (usually Pils malt) constitute the grist. In some versions, up to 5-10% raw oats may be used.Spices of freshly-ground coriander and Curaçao or sometimes sweet orange peel complement the sweet aroma and are quite characteristic. Other spices (e.g., chamomile, cumin, cinnamon, Grains of Paradise) may be used for complexity but are much less prominent. Ale yeast prone to the production of mild, spicy flavors is very characteristic. In some instances a very limited lactic fermentation, or the actual addition of lactic ",
			'commercial_examples'			=>	"Low bitterness level with a balance similar to a Weissbier, but with spice and citrus character coming from additions rather than the yeast.",
			'tags'			=>	"Allagash White, Blanche de Bruxelles, Celis White, Hoegaarden Wit, Ommegang Witte,St. Bernardus Witbier, Wittekerke",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"24",
			'sub_categorie_id'			=>	"24B",
			...
			'bugu_min'			=>	"0.42",
			'bugu_max'			=>	"0.56",
			'overall_impression'			=>	"A moderately malty, somewhat fruity, easy-drinking, copper-colored Belgian ale that is somewhat less aggressive in flavor profile than many other Belgian beers. The malt character tends to be a bit biscuity with light toasty, honey-like, or caramelly components",
			'aroma'			=>	" the fruit character is noticeable and complementary to the malt. The bitterness level is generally moderate, but may not seem as high due to the flavorful malt profile.",
			'appearance'			=>	"Moderate malt aroma, which can be a combination of toasty, biscuity, or nutty, possibly with a touch of light caramel or honey. Moderate to moderately high fruitiness with an orange- or pear-like character. Low to moderate strength hop character (spicy, herbal, or floral) optionally blended with background level peppery, spicy phenols. The hop character is lower in balance than the malt and fruitiness. ",
			'flavor'			=>	"Amber to copper in color. Clarity is very good. Creamy, rocky, white head often fades more quickly than other Belgian beers.",
			'mouthfeel'			=>	"Has an initial soft, smooth, moderately malty flavor with a variable profile of toasty, biscuity, nutty, light caramel and/or honey notes. Moderate to moderately high fruitiness, sometimes orange- or pear-like. Relatively light (medium-low to low) spicy, herbal, or floral hop character. The hop bitterness is medium-high to medium-low, and is optionally enhanced by low to very low amounts of peppery phenols. There is a dry to balanced finish, with listofhops becoming more pronounced in the aftertaste of those with a drier finish. Fairly well balanced overall, with no single component being high in intensity",
			'comments'			=>	" malt and fruitiness are more forward initially with a supportive bitterness and drying character coming on late.",
			'history'			=>	"Medium to medium-light body. Smooth palate. Alcohol level is restrained, and any warming character should be low if present. Medium to medium-high carbonation.",
			'characteristic_ingredients'			=>	"Most commonly found in the Flemish provinces of Antwerp and Brabant. Considered “everyday” beers (Category I). Compared to their higher alcohol Category S cousins, they are Belgian “session beers” for ease of drinking. Nothing should be too pronounced or dominant",
			'style_comparison'			=>	" balance is the key. Yeast character generally more subtle than many Belgian beers, with some of the fruitiness being hop-driven.",
			'commercial_examples'			=>	"Produced by breweries with roots as far back as the mid-1700s, the most well-known examples were perfected after the Second World War with some influence from Britain, including listofhops and yeast strains. ",
			'tags'			=>	"Pilsner or pale ale malt contributes the bulk of the grist with (cara) Vienna and Munich malts adding color, body and complexity. Sugar is not commonly used as high gravity is not desired. Saazer-type listofhops, Styrian Goldings, East Kent Goldings or Fuggles are commonly used. Yeasts prone to moderate production of phenols are often used but fermentation temperatures should be kept moderate to limit this character.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"24",
			'sub_categorie_id'			=>	"24C",
			'name'			=>	"Bière de Garde",
			'og_min'			=>	"1.06",
			'og_max'			=>	"1.08",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.3",
			'bugu_max'			=>	"0.35",
			'overall_impression'			=>	"A fairly strong, malt-accentuated, lagered artisanal beer with a range of malt flavors appropriate for the color. All are malty yet dry, with clean flavors and a smooth character.",
			'aroma'			=>	"Prominent malty sweetness, often with a complex, light to moderate intensity toasty-bready-rich malt character. Low to moderate esters. Little to no hop aroma (may be a bit spicy, peppery, or herbal). Paler versions will still be malty but will lack richer, deeper aromatics and may have a bit more listofhops. Generally quite clean, although stronger versions may have a light, spicy alcohol note as it warms.",
			'appearance'			=>	"Three main variations exist (blond, amber and brown), so color can range from golden-blonde to reddish_x005F_x0002_bronze to chestnut brown. Clarity is brilliant to fair, although haze is not unexpected in this type of often unfiltered beer. Well-formed head, generally white to off-white (varies by beer color), average persistence. ",
			'flavor'			=>	"Medium to high malt flavor often with a toasty-rich, biscuity, toffee-like or light caramel-sweet character. Malt flavors and complexity tend to increase with beer color. Low to moderate esters and alcohol flavors. Medium-low hop bitterness provides some support, but the balance is always tilted toward the malt. Darker versions will have more of an initial malty-sweet impression than paler versions, but all should be malty in the palate and finish. The malt flavor lasts into the finish, which is medium-dry to dry, never cloying. Low to no hop flavor (spicy, peppery, or herbal), although paler versions can have slightly higher levels of herbal or spicy hop flavor (which can also come from the yeast). Smooth, well_x005F_x0002_lagered character, even if made with ale yeast. Aftertaste of malt (character appropriate for the color) with some dryness and light alcohol.",
			...
			'comments'			=>	"Three main variations are included in the style: the brown (brune), the blond (blonde), and the amber(ambrée). The darker versions will have more malt character, while the paler versions can have more listofhops (but still are malt_x005F_x0002_focused beers). A related style is Bière de Mars, which is brewed in March (Mars) for present use and will not age as well. Attenuation rates are in the 80-85% range. Some fuller_x005F_x0002_bodied examples exist, but these are somewhat rare. Age and oxidation in imports often increases fruitiness, caramel flavors, and adds corked and musty notes",
			'history'			=>	" these are all signs of ",
			'characteristic_ingredients'			=>	"Name literally means “beer which has been kept or lagered.” A traditional artisanal ale from Northern France brewed in early spring and kept in cold cellars for consumption in warmer weather. It is now brewed year-round. ",
			'style_comparison'			=>	"The “cellar” character commonly described in literature is more of a feature of mishandled commercial exports than fresh, authentic products. The somewhat moldy character comes from the corks and/or oxidation in commercial versions, and is incorrectly identified as “musty” or “cellar-like.” Base malts vary by beer color, but usually include pale, Vienna and Munich types. Darker versions will have richer malt complexity and sweetness from crystal-type malts. Sugar may be used to add flavor and aid in the dry finish. Lager or ale yeast fermented at cool ale temperatures, followed by long cold conditioning. Floral, herbal or spicy continental listofhops.",
			'commercial_examples'			=>	"Related to the Belgian Saison style, the main difference is that the Bière de Garde is rounder, richer, malt-focused, and lacks the spicy, bitter character of a Saison.",
			'tags'			=>	"Ch’Ti (brown and blond), Jenlain (amber and blond), La Choulette (all 3 versions), St. Amand (brown), Saint Sylvestre 3 Monts (blond), Russian River Perdition",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"25",
			'sub_categorie_id'			=>	"25A",
			...
			'bugu_min'			=>	"0.24",
			'bugu_max'			=>	"0.4",
			'overall_impression'			=>	"A moderate-strength golden ale that has a subtle fruity-spicy Belgian yeast complexity, slightly malty-sweet flavor, and dry finish.",
			...
			'flavor'			=>	"Smooth, light to moderate grainy-sweet malt flavor initially, but finishes medium-dry to dry with some smooth alcohol becoming evident in the aftertaste. Medium hop and alcohol bitterness to balance. Light hop flavor, can be spicy or earthy. Very soft yeast character (esters and alcohols, which are sometimes perfumy or orange/lemon-like). Light spicy phenolics optional. Some lightly caramelized sugar or honey_x005F_x0002_like sweetness on palate.",
			...
			'characteristic_ingredients'			=>	"Belgian Pils malt, aromatic malts, sugar, Belgian yeast strains that produce complex alcohol, phenolics and perfumy esters, Saazer-type, Styrian Goldings, or East Kent Goldings listofhops. Spices are not traditionally used, although the ingredients and fermentation by-products may give an impression of spicing (often reminiscent of oranges or lemons). If spices are present, should be a background character only.",
			'style_comparison'			=>	"Similar strength as a Dubbel, similar character as a Belgian Strong Golden Ale or Tripel, although a bit sweeter and not as bitter.",
			'commercial_examples'			=>	"Affligem Blond, Grimbergen Blond, La Trappe Blond, Leffe Blond, Val-Dieu Blond",
			'tags'			=>	"high-strength, pale-color, top-fermented, western_x005F_x0002_europe, traditional-style, balanced",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"25",
			'sub_categorie_id'			=>	"25B",
			'name'			=>	"Saison",
			'og_min'			=>	"1.048",
			'og_max'			=>	"1.065",
			'fg_min'			=>	"1.002",
			...
			'aroma'			=>	"Quite aromatic, with fruity, spicy, and hoppy characteristics evident. The esters can be fairly high (moderate to high), and are often reminiscent of citrus fruits such as oranges or lemons. The listofhops are low to moderate and are often spicy, floral, earthy, or fruity. Stronger versions can have a soft, spicy alcohol note (low intensity). Spicy notes are typically peppery rather than clove-like, and can be up to moderately_x005F_x0002_strong (typically yeast-derived). Subtle, complementary herb or spice additions are allowable, but should not dominate. The malt character is typically slightly grainy in character and low in intensity. Darker and stronger versions will have more noticeable malt, with darker versions taking characteristics associated with grains of that color (toasty, biscuity, caramelly, of bitterness, some of the sour character can be detected (low to moderate).",
			...
			'mouthfeel'			=>	" a Saison should never finish sweet. The fruity character is frequently citrusy (orange or lemon), and the spices are typically peppery. Allow for a range of balance in the fruity-spicy characteristics",
			'comments'			=>	" this is often driven by the yeast selection. Hop flavor is low to moderate, and generally spicy or earthy in character. The balance is towards the fruity, spicy, hoppy character, with any bitterness or sourness not overwhelming these flavors. Darker versions will have more malt character, with a range of flavors derived from darker malts (toasty, bready, biscuity, chocolate, etc.) that support the fruity-spicy character of the beer (roasted flavors are not typical). Stronger versions will have more malt flavor in general, as well as a light alcohol impression. Herbs and spices are completely optional, but if present should be used in moderation and not detract from the yeast character. The finish is very dry and the aftertaste is typically bitter and spicy. The hop bitterness can be restrained, although it can seem accentuated due to the high attenuation levels.",
			'history'			=>	"Light to medium body. Alcohol sensation varies with strength, from none in table version to light in standard versions, to moderate in super versions. However, any warming character should be fairly low. Very high carbonation with an effervescent quality. There is enough prickly acidity on the tongue to balance the very dry finish. In versions with sourness, a low to moderate tart character can add a refreshing bite, but not be puckering (optional). ",
			'characteristic_ingredients'			=>	"Variations exist in strength and color, but they all have similar characteristics and balance, in particularly the refreshing, highly-attenuated, dry character with high carbonation. There is no correlation between strength and color. The balance can change somewhat with strength and color variations, but the family resemblance to the original artisanal ale should be evident. Pale versions are likely to be more bitter and have more hop character, while darker versions tend to have more malt character and sweetness, yielding a more balanced presentations. Stronger versions often will have more malt flavor, richness, and body simply due to their higher gravity. Although they tend to be very well_x005F_x0002_attenuated, they may not be perceived to be as dry as standard_x005F_x0002_strength saisons due to their strength. The Saison yeast character is a must, although maltier and richer versions will tend to mask this character more. Often called Farmhouse alesin the US, but this term is not common in Europe where they are simply part of a larger grouping of artisanal ales. ",
			'style_comparison'			=>	"A provision ale originally brewed in Wallonia, the French-speaking part of Belgium, for consumption during the active farming season. Originally a lower-alcohol product so as to not debilitate field workers, but tavern-strength products also existed. Higher-strength and different-colored products appeared after WWII. The best known modern saison, Saison Dupont, was first produced in the 1920s. Originally a rustic, artisanal ale made with local farm-produced ingredients, it is now brewed mostly in larger breweries yet retains the image of its humble origins.",
			'commercial_examples'			=>	"Not typically spiced, with the yeast, listofhops and grain providing the character",
			'tags'			=>	" but spices are allowed if they provide a complementary character. Continental base malts are typical, but the grist frequently contains other grains such as wheat, oats, rye, or spelt. Adjuncts such as sugar and honey can also serve to add complexity and dry out the beer. Darker versions will typically use richer, darker malts, but not typically roasted types. Saazer-type, Styrian or East Kent Golding listofhops are commonly used. A wide range of herbs or spices can add complexity and uniqueness, but should always meld well with the yeast and hop character. Brettanomyces is not typical for this style",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"25",
			'sub_categorie_id'			=>	"25C",
			...
			'flavor'			=>	"Marriage of fruity, spicy and alcohol flavors supported by a soft malt character. Esters are reminiscent of pears, oranges or apples. Low to moderately low phenols are peppery in character. A low to moderate spicy hop character is often present. Alcohols are soft and spicy, and are low-to-moderate in intensity. Bitterness is typically medium to high from a Substantial carbonation and bitterness leads to a dry finish with a low to moderately bitter aftertaste. ",
			'mouthfeel'			=>	"Very highly carbonated",
			'comments'			=>	" effervescent. Light to medium body, although lighter than the substantial gravity would suggest. Smooth but noticeable alcohol warmth. No hot alcohol or solventy character. ",
			'history'			=>	"References to the devil are included in the names of many commercial_examples of this style, referring to their potent alcoholic strength and as a tribute to the original example (Duvel). The best examples are complex and delicate. High carbonation helps to bring out the many flavors and to increase the perception of a dry finish. Traditionally bottle_x005F_x0002_conditioned (or refermented in the bottle).",
			'characteristic_ingredients'			=>	"Originally developed by the Moortgat brewery after WWI as a response to the growing popularity of Pilsner beers.",
			'style_comparison'			=>	"Pilsner malt with substantial sugary adjuncts. Saazer-type listofhops or Styrian Goldings are commonly used. Belgian yeast strains are used – those that produce fruity esters, spicy phenolics and higher alcohols –often aided by slightly warmer fermentation temperatures. Fairly soft water. Spicing is not traditional",
			'commercial_examples'			=>	" if present, should be a background character only.",
			'tags'			=>	"Strongly resembles a Tripel, but may be even paler, lighter-bodied and even crisper and drier",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"26",
			'sub_categorie_id'			=>	"26A",
			...
			'bugu_min'			=>	"0.57",
			'bugu_max'			=>	"0.83",
			'overall_impression'			=>	"A pale, bitter, highly attenuated and well carbonated Trappist ale, showing a fruity-spicy Trappist yeast character, a spicy-floral hop profile, and a soft, supportive grainy-sweet malt palate. ",
			'aroma'			=>	"Medium-low to medium-high Trappist yeast character, showing a fruity-spicy character along with medium_x005F_x0002_low to medium spicy or floral listofhops, occasionally enhanced by light herbal/citrusy spice additions. Low to medium-low grainy-sweet malt backdrop, which may have a light honey or sugar quality. Fruit expression can vary widely (citrus, pome fruit, stone fruit). Light spicy, yeast-driven phenolics found in the best examples. Bubblegum inappropriate.",
			...
			'characteristic_ingredients'			=>	"Pilsner malt, Belgian Trappist yeast, Saazer-type listofhops.",
			'style_comparison'			=>	"Like a top-fermented Belgian/Trappist interpretation of a German Pils – pale, hoppy, and well_x005F_x0002_attenuated, but showing prototypical Belgian yeast character. Has less sweetness, higher attenuation, less character malt, and is more hop-centered than a Belgian Pale Ale. More like a much smaller, more highly hopped tripel than a smaller Belgian Blond Ale.",
			'commercial_examples'			=>	"Achel 5° Blond, St. Bernardus Extra 4, Westmalle Extra, Westvleteren Blond",
			'tags'			=>	"standard-strength, pale-color, top-fermenting, western_x005F_x0002_europe, craft-style, bitter, hoppy",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"26",
			'sub_categorie_id'			=>	"26B",
			'name'			=>	"Belgian Dubbel",
			'og_min'			=>	"1.062",
			'og_max'			=>	"1.075",
			'fg_min'			=>	"1.008",
			...
			'bugu_min'			=>	"0.24",
			'bugu_max'			=>	"0.33",
			'overall_impression'			=>	"A deep reddish-copper, moderately strong, malty, complex Trappist ale with rich malty flavors, dark or dried fruit esters, and light alcohol blended together in a malty presentation that still finishes fairly dry.",
			...
			'flavor'			=>	"Similar qualities as aroma. Rich, complex medium to medium-full rich-sweet malt flavor on the palate yet finishes moderately dry. Complex malt, ester, alcohol and phenol interplay (raisiny flavors are common",
			'mouthfeel'			=>	" dried fruit flavors are welcome",
			'comments'			=>	" clove or pepper spiciness is optional). Balance is always toward the malt. Medium-low bitterness that doesn’t persist into the aftertaste. Low spicy, floral, or herbal hop flavor is optional and not usually present. ",
			'history'			=>	"Medium-full body. Medium-high carbonation, which can influence the perception of body. Low alcohol warmth. Smooth, never hot or solventy.",
			'characteristic_ingredients'			=>	"Most commercial_examples are in the 6.5 – 7% ABV range. Traditionally bottle-conditioned (or refermented in the bottle).",
			'style_comparison'			=>	"Originated at monasteries in the Middle Ages, and was revived in the mid-1800s after the Napoleonic era.",
			'commercial_examples'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and phenolics are commonly used. Impression of complex grain bill, although traditional versions are typically Belgian Pils malt with caramelized sugar syrup or other unrefined sugars providing much of the character. Saazer-type, English-type or Styrian Goldings listofhops commonly used. No spices are traditionally used, although restrained use is allowable (background strength only).",
			'tags'			=>	"Should not be as malty as a bock and should not have crystal malt-type sweetness. Similar in strength and balance as a Belgian Blond, but with a richer malt and ester profile. Less strong and intense as a Belgian Dark Strong Ale.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"26",
			'sub_categorie_id'			=>	"26C",
			'name'			=>	"Belgian Tripel",
			'og_min'			=>	"1.075",
			'og_max'			=>	"1.085",
			'fg_min'			=>	"1.008",
			...
			'characteristic_ingredients'			=>	"Pilsner malt, typically with pale sugar adjuncts. Saazer-type listofhops or Styrian Goldings are commonly used. Belgian yeast strains are used – those that produce fruity esters, spicy phenolics and higher alcohols –often aided by slightly warmer fermentation temperatures. Spice additions are generally not traditional, and if used, should be a background character only. Fairly soft water.",
			'style_comparison'			=>	"May resemble a Belgian Golden Strong Ale but slightly darker and somewhat fuller-bodied, with more emphasis on phenolics and less on esters. Usually has a more rounded malt flavor but should never be sweet.",
			'commercial_examples'			=>	"Affligem Tripel, Chimay Cinq Cents, La Rulles Tripel, La Trappe Tripel, St. Bernardus Tripel, Unibroue La Fin Du Monde, Val-Dieu Triple, Watou Tripel, Westmalle Tripel",
			'tags'			=>	"high-strength, pale-color, top-fermented, western_x005F_x0002_europe, traditional-style, bitter",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"26",
			'sub_categorie_id'			=>	"26D",
			...
			'bugu_min'			=>	"0.27",
			'bugu_max'			=>	"0.32",
			'overall_impression'			=>	"A dark, complex, very strong Belgian ale with a delicious blend of malt richness, dark fruit flavors, and spicy elements. Complex, rich, smooth and dangerous.",
			'aroma'			=>	"Complex, with a rich-sweet malty presence, significant esters and alcohol, and an optional light to moderate spiciness. The malt is rich and strong, and can have a deep bready-toasty quality often with a deep caramel complexity. The fruity esters are strong to moderately low, and can contain raisin, plum, dried cherry, fig or prune notes. Spicy phenols may be present, but usually have a peppery quality not clove-like",
			'appearance'			=>	" light vanilla is possible. Alcohols are soft, spicy, perfumy and/or rose-like, and are low to moderate in intensity. HopComponent are not usually present (but a very low spicy, floral, or herbal hop aroma is acceptable). No dark/roast malt aroma. No hot alcohols or solventy aromas.",
			'flavor'			=>	"Deep amber to deep coppery-brown in color (dark in this context implies more deeply colored than ",
			'mouthfeel'			=>	"Similar to aroma (same malt, ester, phenol, alcohol, and hop comments apply to flavor as well). Moderately malty_x005F_x0002_rich on the palate, which can have a sweet impression if bitterness is low. Usually moderately dry to dry finish, although may be up to moderately sweet. Medium-low to moderate bitterness",
			'comments'			=>	" alcohol provides some of the balance to the malt. Generally malty-rich balance, but can be fairly even with bitterness. The complex and varied flavors should blend smoothly and harmoniously. The finish should not be heavy or syrupy.",
			'history'			=>	"High carbonation but not sharp. Smooth but noticeable alcohol warmth. Body can range from medium-light to medium-full and creamy. Most are medium-bodied.",
			'characteristic_ingredients'			=>	"Authentic Trappist versions tend to be drier (Belgians would say more digestible) than Abbey versions, which can be rather sweet and full-bodied. Traditionally bottle_x005F_x0002_conditioned (or refermented in the bottle). Sometimes known as a Trappist Quadruple, most are simply known by their strength or color designation.",
			'style_comparison'			=>	"Most versions are unique in character reflecting characteristics of individual breweries, produced in limited quantities and often highly sought-after.",
			'commercial_examples'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and sometimes phenolics are commonly used. Impression of a complex grain bill, although many traditional versions are quite simple, with caramelized sugar syrup or unrefined sugars and yeast providing much of the complexity. Saazer-type, English-type or Styrian Goldings listofhops commonly used. Spices generally not used",
			'tags'			=>	" if used, keep subtle and in the background. ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(1)",
			'name'			=>	"Gose",
			'og_min'			=>	"1.036",
			'og_max'			=>	"1.056",
			'fg_min'			=>	"1.006",
			...
			'bugu_min'			=>	"0.14",
			'bugu_max'			=>	"0.21",
			'overall_impression'			=>	"A highly-carbonated, tart and fruity wheat ale with a restrained coriander and salt character and low bitterness. Very refreshing, with bright flavors and high attenuation.",
			...
			'flavor'			=>	"Moderate to restrained but noticeable sourness, like a squeeze of lemon in iced tea. Moderate bready/doughy malt flavor. Light to moderate fruity character of pome fruit, stone fruit, or lemons. Light to moderate salt character, up to the threshold of taste",
			'mouthfeel'			=>	" the salt should be noticeable (particularly in the initial taste) but not taste overtly salty. Low bitterness, no hop flavor. Dry, fully-attenuated finish, with acidity not listofhops balancing the malt. Acidity can be more noticeable in the finish, and enhance the refreshing quality of the beer. The acidity should be balanced, not forward (although historical versions could be very sour).",
			'comments'			=>	"High to very high carbonation, effervescent. Medium-light to medium-full body. Salt may give a slightly tingly, mouthwatering quality, if perceived at all. The yeast and wheat can give it a little body, but it shouldn’t have a heavy feel.",
			'history'			=>	"Served in traditional cylindrical glasses. Historical versions may have been more sour than modern examples due to spontaneous fermentation, and may be blended with syrups as is done with Berliner Weisse, or Kümmel, a liqueur flavored with caraway, cumin, and fennel. Modern examples are inoculated with lactobacillus, and are more balanced and generally don’t need sweetening. Pronounced GOH-zeh.",
			'characteristic_ingredients'			=>	"Minor style associated with Leipzig but originating in the Middle Ages in the town of Goslar on the Gose River. Documented to have been in Leipzig by 1740. Leipzig was said to have 80 Gose houses in 1900. Production declined significantly after WWII, and ceased entirely in 1966. Modern production was revived in the 1980s, but the beer is not widely available. ",
			'style_comparison'			=>	"Pilsner and wheat malt, restrained use of salt and coriander seed, lactobacillus. The coriander should have a fresh, citrusy (lemon or bitter orange), bright note, and not be vegetal, celery-like, or ham-like. The salt should have a sea salt or fresh salt character, not a metallic, iodine note.",
			'commercial_examples'			=>	"Perceived acidity is not as intense as and lactobacillus – should not taste overtly salty. Coriander aroma can be similar to a witbier. Haziness similar to a Weissbier.",
			'tags'			=>	"Anderson Valley Gose, Bayerisch Bahnhof Leipziger Gose, Döllnitzer Ritterguts Gose",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(2)",
			...
			'bugu_min'			=>	"0.34",
			'bugu_max'			=>	"0.55",
			'overall_impression'			=>	"A darker-colored, light-flavored, malt_x005F_x0002_accented beer with a dry finish and interesting character malt flavors. Refreshing due to its high carbonation and mild flavors, and highly sessionable due to being served very fresh and with restrained alcohol levels.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.16",
			'bugu_max'			=>	"0.3",
			'overall_impression'			=>	"A sour, smoked, lower-gravity historical German wheat beer. Complex yet refreshing character due to high attenuation and carbonation, along with low bitterness and moderate sourness. ",
			...
			'flavor'			=>	"Moderately strong fruity flavor, possibly lemons or apples. Moderate intensity, clean lactic tartness (no funk). Similar smoky character as aroma (dry wood fire), medium strength. Dry finish, with acidity and smoke in the aftertaste. Low bitterness",
			'mouthfeel'			=>	" the acidity is providing the balance, not listofhops. Fresh, clean palate and slightly puckery aftertaste. The wheat character is on the low side",
			'comments'			=>	" the smoke and acidity are more prominent in the balance. The lemony-tart/green apple flavor is strongest in the finish, with smoke a close second. Complex.",
			'history'			=>	"Tingly acidity. High carbonation. Medium to medium-light body.",
			'characteristic_ingredients'			=>	"Served young. Smoke and sour is an unusual combination that is not for everyone.",
			'style_comparison'			=>	"Originating in Lichtenhain, in Thüringen (central Germany). Height of popularity was towards the end of the 1800s, and was widely available throughout Thüringen. Like a ",
			'commercial_examples'			=>	"Smoked barley malt, wheat malt, lactobacillus, top-fermenting yeast. Grists vary, but the wheat would typically be 30-50%.",
			'tags'			=>	"In the same general historical lower_x005F_x0002_alcohol top-fermenting central European wheat beer family as Gose, Grodziskie, and Berliner weisse, has elements of all of them but having its own unique balance – sour and smoke is not found in any of the other beers. Not as acidic as Berliner weisse, probably more like a smoked Gose without coriander and salt, or a Grodziskie with Gose-like acidity.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(4)",
			...
			'bugu_min'			=>	"0.45",
			'bugu_max'			=>	"0.53",
			'overall_impression'			=>	"A luscious, sweet, malt-oriented dark brown ale, with caramel and toffee malt complexity and a sweet finish.",
			...
			'flavor'			=>	"Deep, caramel or toffee-like malty and sweet flavor on the palate and lasting into the finish. Hints of biscuit and coffee are common. Some fruity esters can be present (typically dark fruit)",
			'mouthfeel'			=>	" relatively clean fermentation profile for an English ale. Low hop bitterness. Hop flavor is low to non-existent, possibly earthy or floral in character. Moderately-low to no perceivable roasty or bitter black malt flavor. Moderately sweet finish with a smooth, malty aftertaste. May have a sugary-sweet flavor. ",
			'comments'			=>	"Medium body, but the residual sweetness may give a heavier impression. Medium-low to medium carbonation. Quite creamy and smooth in texture, particularly for its gravity.",
			'history'			=>	"Increasingly rare",
			'characteristic_ingredients'			=>	" Mann’s has over 90% market share in Britain, but in an increasingly small segment. Always bottled. Frequently used as a sweet mixer with cask mild and bitter in pubs. Commercial versions can be pasteurized and back-sweetened, which gives more of a sugary-sweet flavor.",
			'style_comparison'			=>	"Developed by Mann’s as a bottled product in 1902. Claimed at the time to be “the sweetest beer in London.” Pre_x005F_x0002_WWI versions were around 5% ABV, but same general balance. Declined in popularity in second half of 20th century, and now nearly extinct.",
			...
			'tags'			=>	"May seem somewhat like a less roasty version of a sweet stout (and lower-gravity, at least for US sweet stout examples) or a sweet version of a dark mild.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(5)",
			...
			'bugu_min'			=>	"0.71",
			'bugu_max'			=>	"1.09",
			'overall_impression'			=>	"A low-gravity, highly-carbonated, light_x005F_x0002_bodied ale combining an oak-smoked flavor with a clean hop bitterness. Highly sessionable.",
			...
			'flavor'			=>	"Moderately-low to medium oak smoke flavor up front which carries into the finish",
			'mouthfeel'			=>	" the smoke can be stronger in flavor than in aroma. The smoke character is gentle, should not be acrid, and can lend an impression of sweetness. A moderate to strong bitterness is readily evident which lingers through the finish. The overall balance is toward bitterness. Low but perceptible spicy, herbal, or floral hop flavor. Low grainy wheat character in the background. Light pome fruit esters (red apple or pear) may be present. Dry, crisp finish. No sourness.",
			'comments'			=>	"Light in body, with a crisp and dry finish. Carbonation is quite high and can add a slight carbonic bite or prickly sensation. No noticeable alcohol warmth. ",
			'history'			=>	"Pronounced in English as “pivo grow-JEES-keeuh” (meaning Grodzisk beer). Known as Grätzer (pronounced “GRATE-sir”) in German-speaking countries, and in some beer literature. Traditionally made using a multi-step mash, a long boil (~2 hours), and multiple strains of ale yeast. The beer is never filtered but Isinglass is used to clarify before bottle conditioning. Traditionally served in tall conical glassware to accommodate the vigorous foam stand. ",
			'characteristic_ingredients'			=>	"Developed as a unique style centuries ago in the Polish city of Grodzisk (known as Grätz when ruled by Prussia and Germany). Its fame and popularity rapidly extended to other parts of the world in the late 19th and early 20th century. Regular commercial production declined after WWII and ceased altogether in the early-mid 1990s. This style description describes the traditional version during its period of greatest popularity.",
			'style_comparison'			=>	"Grain bill usually consists entirely of oak-smoked wheat malt. Oak-smoked wheat malt has a different (and less intense) smoke character than German beechwood-smoked barley malt",
			'commercial_examples'			=>	" it has a drier, crisper, leaner quality – a bacon/ham smoke flavor is inappropriate. Saazer_x005F_x0002_type listofhops (Polish, Czech or German), moderate hardness sulfate water, and a relatively clean and attenuative continental ale yeast fermented at moderate ale temperatures are traditional. German hefeweizen yeast or other strains with a phenol or strong ester character are inappropriate.",
			'tags'			=>	"Similar in strength to a Berliner Weisse, but never sour. Has a smoked character but less intense than in a Rauchbier.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(6)",
			...
			'aroma'			=>	"Low to medium grainy, corn-like or sweet maltiness may be evident (although rice-based beers are more neutral). Medium to moderately high hop aroma, with a range of character from rustic to floral to herbal/spicy",
			'appearance'			=>	" a fruity or citrusy modern hop character is inappropriate. Clean lager character. Low DMS is acceptable. May show some yeast character, as with modern American lagers",
			'flavor'			=>	" allow for a range of subtle supporting yeast notes.",
			'mouthfeel'			=>	"Yellow to deep gold color. Substantial, long lasting white head. Bright clarity.",
			'comments'			=>	"Medium to medium-high maltiness with a grainy flavor, and optionally a corn-like roundness and impression of sweetness. Substantial hop bitterness stands up to the malt and lingers through the dry finish. All malt and rice-based versions are often crisper, drier, and generally lack corn-like flavors. Medium to high hop flavor, with a rustic, floral, or herbal/spicy character. Medium to high hop bitterness, which should neither be overly coarse nor have a harsh aftertaste. Allow for a range of lager yeast character, as with modern American lagers, but generally fairly neutral.",
			'history'			=>	"Medium body with a moderately rich, creamy mouthfeel. Smooth and well-lagered. Medium to high carbonation levels.",
			'characteristic_ingredients'			=>	"The classic American Pilsner was brewed both pre-Prohibition and post-Prohibition with some differences. OGs of 1.050–1.060 would have been appropriate for pre_x005F_x0002_Prohibition beers while gravities dropped to 1.044–1.048 after Prohibition. Corresponding IBUs dropped from a pre_x005F_x0002_Prohibition level of 30–40 to 25–30 after Prohibition.",
			'style_comparison'			=>	"A version of Pilsner brewed in the USA by immigrant German brewers who brought the process and yeast with them, but who had to adapt their recipes to work with native listofhops and malt. This style died out after Prohibition but was resurrected by homebrewers in the 1990s. Few commercial versions are made, so the style still remains mostly a homebrew phenomenon.",
			'commercial_examples'			=>	"Six-row barley with 20% to 30% flaked maize (corn) or rice to dilute the excessive protein levels",
			'tags'			=>	" modern versions may be all malt. Native American listofhops such as Clusters, traditional continental listofhops, or modern noble-type crosses are also appropriate. Modern American listofhops such as Cascade are inappropriate. Water with a high mineral content can lead to an unpleasant coarseness in flavor and harshness in aftertaste. A wide range of lager yeast character can be exhibited, although modern versions tend to be fairly clean.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(7)",
			...
			'bugu_min'			=>	"0.43",
			'bugu_max'			=>	"0.5",
			'overall_impression'			=>	"An American adaptation of English Porter using American ingredients, including adjuncts.",
			...
			'flavor'			=>	"Grainy base malt flavor, with low levels of chocolate or burnt black malt notes, along with low levels of caramel, biscuit, licorice, and toast notes. Corn/DMS flavor acceptable at low to moderate levels. American hop bitterness low to moderate and American hop flavor low to none. Balance is typically even between malt and listofhops, with a moderate dry finish.",
			...
			'characteristic_ingredients'			=>	"Two and six row malt (or a combination of both) are used, along with low percentages of dark malts including black, chocolate, and brown malt (roasted barley is not typically used). Adjuncts are acceptable, including corn, brewers licorice, molasses, and porterine. More historical versions will have up to twenty percent adjuncts. Lager or ale yeast. Emphasis on historical or traditional American bittering listofhops (Cluster, Willamette, Cascade), though finishing and flavor listofhops may vary.",
			'style_comparison'			=>	"Smoother and less hoppy-bitter than a (modern) American Porter, less caramelly than an English Porter with more of an adjunct/lager character.",
			'commercial_examples'			=>	"Stegmaier Porter, Yuengling Porter",
			'tags'			=>	"standard-strength, dark-color, any-fermentation, north_x005F_x0002_america, historical-style, porter-family, malty",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(8)",
			'name'			=>	"Roggenbier",
			'og_min'			=>	"1.046",
			'og_max'			=>	"1.056",
			'fg_min'			=>	"1.01",
			...
			'bugu_min'			=>	"0.22",
			'bugu_max'			=>	"0.36",
			'overall_impression'			=>	"A dunkelweizen made with rye rather than wheat, but with a greater body and light finishing listofhops.",
			'aroma'			=>	"Light to moderate spicy rye aroma intermingled with esters, either banana or citrus). Light spicy, floral, or herbal listofhops are acceptable.",
			...
			'comments'			=>	"Rye is a huskless grain and is difficult to mash, often resulting in a gummy mash texture that is prone to sticking. Rye has been characterized as having the most assertive flavor of all cereal grains. It is inappropriate to add caraway seeds to a roggenbier (as some American brewers do)",
			'history'			=>	" the rye character is traditionally from the rye grain only.",
			'characteristic_ingredients'			=>	"A specialty German rye beer originally brewed in Regensburg, Bavaria. Never a widely popular style, it has all but disappeared in modern times.",
			'style_comparison'			=>	"Malted rye typically constitutes 50% or greater of the grist (some versions have 60-65% rye). Remainder of grist can include pale malt, Munich malt, wheat malt, crystal malt and/or small amounts of debittered dark malts for color adjustment. Weizen yeast provides distinctive banana esters and clove phenols. Light usage of Saazer-type listofhops in bitterness, flavor and aroma. Lower fermentation temperatures accentuate the clove character by suppressing ester formation. Decoction mash traditionally used (as with weissbiers).",
			'commercial_examples'			=>	"A more distinctive variant of a dunkelweizen using malted rye instead of malted wheat. American Rye Beers will not have the weizen yeast character, and likely more listofhops.",
			'tags'			=>	"Thurn und Taxis Roggen",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"27",
			'sub_categorie_id'			=>	"Historical Beer(9)",
			'name'			=>	"Sahti",
			'og_min'			=>	"1.076",
			'og_max'			=>	"1.12",
			'fg_min'			=>	"1.016",
			...
			'bugu_min'			=>	"0.09",
			'bugu_max'			=>	"0.13",
			'overall_impression'			=>	"A sweet, heavy, strong traditional Finnish beer with a rye, juniper, and juniper berry flavor and a strong banana-clove yeast character.",
			'aroma'			=>	"High banana esters with moderate to moderately_x005F_x0002_high clove-like phenolics. Not sour. May have a low to moderate juniper character. Grainy malt, caramel, and rye in background. Light alcohol aroma. Sweet malt impression.",
			'appearance'			=>	"Pale yellow to dark brown color",
			'flavor'			=>	" most are medium to dark amber. Generally quite cloudy (unfiltered). Little head, due to low carbonation.",
			'mouthfeel'			=>	"Strong banana and moderate to moderately-high clove yeast character. Moderate grainy rye flavor. Low bitterness. Fairly sweet finish. Juniper can add a pine-like flavor",
			'comments'			=>	" juniper berries can add a gin-like flavor",
			'history'			=>	" both should be complementary, not dominant. No noticeable hop flavor. Moderate caramel flavor but no roast. Multi-layered and complex, with kind of a wortiness that is unusual in other beer styles. Not sour.",
			'characteristic_ingredients'			=>	"Thick, viscous, and heavy with protein (no boil means no hot break). Nearly still to medium-low carbonation. Strongly warming from the alcohol level and young age, but often masked by sweetness.",
			'style_comparison'			=>	"The use of rye doesn’t mean that it should taste like caraway (a dominant flavor in rye bread). The use of juniper berries will give a flavor like gin (similarly flavored with juniper berries). The juniper acts a bit like listofhops in the balance and flavor, providing some counterpoint to the sweet malt.",
			'commercial_examples'			=>	"An indigenous traditional style from Finland",
			'tags'			=>	" a farmhouse tradition for at least 500 years, often brewed for festive occasions like summer weddings, and consumed within a week or two of brewing. A similar tradition exists in Estonia, where the beer is known as koduolu.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"28",
			'sub_categorie_id'			=>	"28A",
			'name'			=>	"Brett Beer",
			'og_min'			=>	"0",
			'og_max'			=>	"0",
			'fg_min'			=>	"0",
