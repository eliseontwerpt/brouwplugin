...
class Seeder_eliseontwerpt_brouwerbouwer_bjcp_categories extends Seeder
	...
	public function run()
	{
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,2",
			'bugu_max'			=>	"0,36",
			'overall impression'			=>	"A very pale, highly-carbonated, light_x005F_x0002_bodied, well-attenuated lager with a very neutral flavor profile and low bitterness. Served very cold, it can be a very refreshing and thirst quenching drink.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'history'			=>	"Pre-prohibition Cream Ales were slightly stronger, hoppier (including some dry hopping) and more bitter (25-30+ IBUs). These versions should be entered in the historical category. Most commercial examples are in the 1.050–1.053 OG range, and bitterness rarely rises above 20 IBUs.",
			'characteristic ingredients'			=>	"A sparkling or present-use ale that existed in the 1800s and survived prohibition. An ale version of the American lager style. Produced by ale brewers to compete with lager brewers in Canada and the Northeast, Mid-Atlantic, and Midwest states. Originally known as sparkling or present use ales, lager strains were (and sometimes still are) used by some brewers, but were not historically mixed with ale strains. Many examples are kräusened to achieve carbonation. Cold conditioning isn’t traditional, although modern brewers sometimes use it.",
			'style comparison'			=>	"American ingredients most commonly used. A grain bill of six-row malt, or a combination of six-row and North American two-row, is common. Adjuncts can include up to 20% maize in the mash, and up to 20% glucose or other sugars in the boil. Any variety of hops can be used for bittering and finishing.",
			'commercial examples'			=>	"Similar to a Standard American Lager, but with more character.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Different variations exist, from an easy-drinking fairly sweet beer to a dry, aggressively-hopped beer with a strong wheat flavor. American rye beers should be entered in the Alternative Fermentables specialty category.",
			'style comparison'			=>	"An American craft beer adaptation of the German weissbier style using a cleaner yeast and more hops, first widely popularized by Widmer in the mid-1980s.",
			'commercial examples'			=>	"Clean American ale or lager yeast (German weissbier yeast is inappropriate). Large proportion of wheat malt (often 30–50%, which is lower than is typical in German weissbiers). American, German, or New World hops are typical.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Varies by country, but generally represents an adaptation of the mass-market International Lager or an evolution of indigenous styles into a more generic product.",
			'style comparison'			=>	"Two-row or six-row base malt. Color malts such as victory, amber, etc. Caramel malt adjuncts. European or American hops or a combination of both.",
			'commercial examples'			=>	"Less well-developed malt flavor than a Vienna lager, often with an adjunct taste.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Darker versions of International Pale Lagers often created by the same large, industrial breweries and meant to appeal to a broad audience. Often either a colored or sweetened adaptation of the standard pale industrial lager, or a more broadly accessible (and inexpensive) version of more traditional dark lagers.",
			'style comparison'			=>	"Two- or six-row barley, corn, rice, or sugars as adjuncts. Light use of caramel and darker malts. Commercial versions may use coloring agents.",
			'commercial examples'			=>	"Less flavor and richness than Munich Dunkel, Schwarzbier, or other dark lagers. Frequently uses adjuncts, as is typical of other International Lagers.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Josef Groll initially brewed two types of beer in 1842–3, a výčepní and a ležák, with the smaller beer having twice the production",
			'style comparison'			=>	" Evan Rail speculates that these were probably 10 °P and 12 °P beers, but that the výčepní could have been weaker. This is the most consumed type of beer in the ",
			'commercial examples'			=>	"Soft water with low sulfate and carbonate content, Saazer-type hops, Czech Pilsner malt, Czech lager yeast. Low ion water provides a distinctively soft, rounded hop profile despite high hopping rates. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Commonly associated with Pilsner Urquell, which was first brewed in 1842 after construction of a new brewhouse by burghers dissatisfied with the standard of beer brewed in Plzeň. Bavarian brewer Josef Groll is credited with first brewing the beer.",
			'style comparison'			=>	"Soft water with low sulfate and carbonate content, Saazer-type hops, Czech malt, Czech lager yeast. Low ion water provides a distinctively soft, rounded hop profile despite high hopping rates. The bitterness level of somelarger commercial examples has dropped in recent years, although not as much as in many contemporary German examples.",
			'commercial examples'			=>	"More color, malt richness, and body than a German Pils, with a fuller finish and a cleaner, softer impression. Stronger than a Czech Pale Lager.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style comparison'			=>	"The beer is the Czech equivalent of adark lager ranging in character from Munich Dunkel to Schwarzbier, but typically with greater malt richness and hop character (aroma, flavor, and/or bitterness).",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style comparison'			=>	"Similar in malt balance and bitterness to Munich Dunkel, but less malty-sweet in nature and pale rather than dark. More body and malt presence than a German Pils, with less hop character throughout. Similar malt profile as a ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'flavor'			=>	" should not have amber hues. Bright clarity. Persistent white to off-white foam stand. Most commercial examples are medium gold in color.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Base of Pils and/or Vienna malt with some Munich malt to add character (although much less than in a traditional bock). No non-malt adjuncts. Saazer_x005F_x0002_type hops. Clean lager yeast. Decoction mash is typical, but boiling is less than in Dunkles Bock to restrain color development.",
			'style comparison'			=>	"Can be thought of as either a pale version of a Dunkles Bock, or a Munich Helles brewed to bock strength. While quite malty, this beer typically has less dark and rich Dunkles Bock. Has more of a rich malt character and more alcohol than a Festbier.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,58",
			'bugu_max'			=>	"0,82",
			'overall impression'			=>	"A pale, highly-attenuated, light-bodied German lager with lower alcohol and calories than normal_x005F_x0002_strength beers. Moderately bitter with noticeable malt and hop flavors, the beer is still interesting to drink.",
			...
			'characteristic ingredients'			=>	"Traditional versions existed as drinks for physical laborers in factories or fields, but modern versions are more based on popular American products in the same class.",
			'style comparison'			=>	"Similar to a German Pils or Helles, continental Pils malt, German lager yeast, Saazer-type hops.",
			'commercial examples'			=>	"Like a lower-alcohol, lighter-bodied, slightly less aggressive German Pils or Helles.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" older examples and imports can easily show some oxidation defects. Served in Köln in a tall, narrow 200ml glass called a Stange.",
			'style comparison'			=>	"Cologne, Germany (Köln) has a top-fermenting brewing tradition since the Middle Ages, but developed the beer now known as Kölsch in the late 1800s to combat encroaching bottom-fermented pale lagers. Kölsch is an appellation protected by the Kölsch Konvention (1986), and is restricted to the 20 or so breweries in and around Köln. TheKonvention simply defines the beer as a “light, highly attenuated, hop-accentuated, clear, top-fermenting Vollbier.” ",
			'commercial examples'			=>	"Traditional German hops (Hallertau, Tettnang, Spalt or Hersbrucker). German Pils or pale malt. Attenuative, clean ale yeast. Up to 20% wheat malt Current commercial practice is to ferment warm, cold condition for a short period of time, and serve young.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"The Dortmunder style developed in the Dortmund industrial region in the 1870s in response to pale Pilsner-type beers, it became very popular after World War II but declined in the 1970s. Other Export-class beers developed independently, and reflected a slightly stronger version of existing beers. The modern German style is typically 12-13 °P.",
			'style comparison'			=>	"Minerally water with high levels of sulfates, carbonates and chlorides, German or Czech noble hops, Pilsner malt, German lager yeast. Newer commercial versions can contain adjuncts and hop extract.",
			'commercial examples'			=>	"Less finishing hops and more body than a Pils but more bitter than a Helles.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Adapted from Czech Pilsner to suit brewing conditions in Germany, particularly water with higher mineral content and domestic hop varieties. First brewed in Germany in the early 1870s. Became more popular after WWII as German brewing schools emphasized modern techniques. Along with its sister beer, Czech Pilsner, is the ancestor of the most widely produced beer styles today. Average IBUs of many well-regarded commercial examples have dropped over time.",
			'style comparison'			=>	"Continental Pilsner malt, German hop varieties (especially Saazer-type varieties such as Tettnanger, Hallertauer, and Spalt for taste and aroma",
			'commercial examples'			=>	" Saaz is less common), German lager yeast.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" this style description specifically refers to the stronger amber lager version. The modern Festbier can be thought of as a pale Märzen by these terms.",
			'style comparison'			=>	"As the name suggests, brewed as a stronger “March beer” in March and lagered in cold caves over the summer. Modern versions trace back to the lager developed by Spaten in 1841, contemporaneous to the development of Vienna lager. However, the Märzen name is much older than 1841",
			'commercial examples'			=>	" the early ones were dark brown, and in Austria the name implied a strength band (14 °P) rather than a style. The German amber lager version (in the Viennese style of the time) was first served at Oktoberfest in 1872, a tradition that lasted until 1990 when the golden Festbier was adopted as the standard festival beer. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" these should be entered in the Classic Style Smoked Beer category. This description specifically refers to the smoked Märzen version.",
			'style comparison'			=>	"A historical specialty of the city of Bamberg, in the Franconian region of Bavaria in Germany. Beechwood-smoked malt is used to make a Märzen-style amber lager. The smoke character of the malt varies by maltster",
			'commercial examples'			=>	" some breweries produce their own smoked malt (rauchmalz).",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Developed by Anton Dreher in Vienna in 1841, became popular in the mid-late 1800s. Now nearly extinct in its area of origin, the style continues in Mexico where it was brought by Santiago Graf and other Austrian immigrant brewers in the late 1800s. Authentic examples are increasingly hard to find (except perhaps in the craft beer industry) as formerly good examples become sweeter and use more adjuncts.",
			'style comparison'			=>	"Vienna malt provides a lightly toasty and complex, Maillard-rich malt profile. As with Märzens, only the finest quality malt should be used, along with Continental hops (preferably Saazer types or Styrians). Can use some caramel malts and/or darker malts to add color and sweetness, but caramel malts shouldn’t add significant aroma and flavor and dark malts shouldn’t provide any roasted character.",
			'commercial examples'			=>	"Lighter malt character, slightly less body, and slightly more bitter in the balance than a Märzen, yet with many of the same malt-derived flavors. The malt character is similar to a Märzen, but less intense and more balanced. Lower in alcohol than Märzen or Festbier. Less rich, less malty and less hop-centered compared to Czech Amber Lager.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,38",
			'bugu_max'			=>	"0,5",
			'overall impression'			=>	"Characterized by depth, richness and complexity typical of darker Munich malts with the accompanying Maillard products. Deeply bready-toasty, often with chocolate-like flavors in the freshest examples, but never harsh, roasty, or astringent",
			...
			'characteristic ingredients'			=>	"Unfiltered versions from Germany can taste like liquid bread, with a yeasty, earthy richness not found in exported filtered examples.",
			'style comparison'			=>	"The classic brown lager style of Munich which developed as a darker, more malt-accented beer than other regional lagers. While originating in Munich, the style became popular throughout Bavaria (especially Franconia). Franconian versions are often darker and more bitter.",
			'commercial examples'			=>	"Grist is traditionally made up of German Munich malt (up to 100% in some cases) with the remainder German Pilsner malt. Small amounts of crystal malt can add dextrins and color but should not introduce excessive residual sweetness. Slight additions of roasted malts (such as Carafa or chocolate) may be used to improve color but should not add strong flavors. Traditional German hop varieties and German lager yeast strains should be used. Often decoction mashed (up to a triple decoction) to enhance the malt flavors and create the depth of color.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" paler examples are a more recent development.",
			'style comparison'			=>	"Pils and/or Vienna malt for pale versions (with some Munich), Munich and Vienna malts for darker ones and occasionally a tiny bit of darker color malts (such as Carafa). Saazer-type hops. Clean lager yeast. Decoction mashing is traditional.",
			'commercial examples'			=>	"A stronger, richer, more full-bodied version of either a Dunkles Bock or a Helles Bock. Pale versions will show higher attenuation and less dark fruity character than the darker versions.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style comparison'			=>	"Eisbocks are not simply stronger doppelbocks",
			'commercial examples'			=>	" the name refers to the process of freezing and concentrating the beer and is not a statement on alcohol",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" never heavy. texture of wheat imparts the sensation of a fluffy, creamy fullness that may progress to a light, spritzy finish aided by high to very high carbonation. Always effervescent.",
			'style comparison'			=>	"These are refreshing, fast-maturing beers that are lightly hopped and show a unique banana-and-clove yeast character. These beers often don’t age well and are best enjoyed while young and fresh. The version mit hefe is served with suspended yeast",
			'commercial examples'			=>	" the krystal version is filtered for excellent clarity. The character of a krystal weizen is generally fruitier and less phenolic than that of the weissbier mit hefe. May be known as hefeweizen, particularly in the United States. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Bavaria has a wheat beer brewing traditional hundreds of years old, but the brewing right was reserved for Bavarian royalty until the late 1700s. Old-fashioned Bavarian wheat beer was often dark, as were most beer of the day. Pale weissbier started to become popular in the 1960s, but traditional dark wheat beer remained somewhat of an old person’s drink.",
			'style comparison'			=>	"By German brewing tradition, at least 50% of the grist must be malted wheat, although some versions use up to 70%",
			'commercial examples'			=>	" the remainder is usually Munich, Vienna, or dark or caramel wheat malts, or Pilsner malt with color malt. A decoction mash is traditional, but infrequently used today. Weizen ale yeasts produce the typical spicy and fruity character, although extreme fermentation temperatures can affect the balance and produce off-flavors. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Aventinus, the world’s oldest top-fermented wheat doppelbock, was created in 1907 at the Schneider Weisse Brauhaus in Munich. ",
			'style comparison'			=>	"A high percentage of malted wheat is used (by German brewing tradition must be at least 50%, although it may contain up to 70%), with the remainder being Munich- and/or Vienna-type barley malts in darker versions, and more Pils malt in paler versions. Some color malts may be used sparingly. A traditional decoction mash can give the appropriate body without cloying sweetness. Weizen ale yeasts produce the typical spicy and fruity character. Too warm or too cold fermentation will cause the phenols and esters to be out of balance and may create off-flavors. Hop choice is essentially irrelevant, but German varieties are most traditional.",
			'commercial examples'			=>	"Stronger and richer than a Weissbier or Dunkles Weissbier, but with similar yeast character. More directly comparable to the Doppelbock style, with the pale and dark variations. Can vary widely in strength, but most are in the bock to doppelbock range. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'history'			=>	"#N/A",
			'characteristic ingredients'			=>	"Pale ale, amber, and/or crystal malts. May use a touch of dark malt for color adjustment. May use sugar adjuncts, corn, or wheat. English finishing hops are most traditional, but any hops are fair game",
			'style comparison'			=>	" if American hops are used, a light touch is required. Characterful British yeast. ",
			'commercial examples'			=>	"Some modern variants are brewed exclusively with pale malt and are known as golden ales, summer ales, or golden bitters. Emphasis is on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,63",
			'bugu_max'			=>	"0,83",
			'overall impression'			=>	"An average-strength to moderately_x005F_x0002_strong British bitter ale. The balance may be fairly even between malt and hops to somewhat bitter. Drinkability is a critical component of the style. A rather broad style that allows for considerable interpretation by the brewer.",
			...
			'characteristic ingredients'			=>	"Pale ale, amber, and/or crystal malts, may use a touch of black malt for color adjustment. May use sugar adjuncts, corn or wheat. English finishing hops are most traditional, but any hops are fair game",
			'style comparison'			=>	" if American hops are used, a light touch is required. Characterful British yeast. Burton versions use medium to high sulfate water, which can increase the perception of dryness and add a minerally or sulfury aroma and flavor.",
			'commercial examples'			=>	"More evident malt and hop flavors than in a special or best bitter, as well as more alcohol. Stronger versions may overlap somewhat with British strong ales, although strong bitters will tend to be paler and more bitter. More malt flavor (particularly caramel) and esters than an American Pale Ale, with different finishing hop character.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Modern golden ales were developed in England to take on strongly-marketed lagers. While it is difficult to identify the first, Hop Backs Summer Lightning, first brewed in 1986, is thought by many to have got the style off the ground.",
			'style comparison'			=>	"Low-color pale or lager malt acting as a blank canvas for the hop character. May use sugar adjuncts, corn or wheat. English hops frequently used, although citrusy American varietals are becoming more common. Somewhat clean-fermenting British yeast.",
			'commercial examples'			=>	"More similar to an American Pale Ale than anything else, although it is often lower in alcohol and usually features British ingredients. Has no caramel and fewer esters compared to British bitters and pale ales. Dry as bitters but with less malt character to support the hops, giving a different balance. Often uses (and features) American hops, more so than most other modern British styles.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,8",
			'bugu_max'			=>	"0,8",
			'overall impression'			=>	"A hoppy, moderately-strong, very well_x005F_x0002_attenuated pale British ale with a dry finish and a hoppy aroma and flavor. Classic British ingredients provide the best flavor profile. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" however, none of the versions have strongly roasted flavors. A stronger Double Brown Ale was more popular in the past, but is very hard to find now. While London Brown Ales are marketed using the name Brown Ale, we list those as a different judging style due and alcohol strength",
			'style comparison'			=>	" that doesn’t mean that they aren’t in the same family, though.",
			'commercial examples'			=>	"Brown ale has a long history in Great Britain, although several different types of products used that name at various times. Modern brown ale is a 20th century creation as a bottled product",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style comparison'			=>	"Differs from an American Porter in that it usually has softer, sweeter and more caramelly flavors, lower gravities, and usually less alcohol",
			'commercial examples'			=>	" the American Porter will also typically have more of a hop character. More substance and roast than a British Brown Ale. Higher in gravity than a dark mild.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style comparison'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat_x005F_x0002_smoked malt is inauthentic and inappropriate.",
			'commercial examples'			=>	"Similar character to a Wee Heavy, but much smaller. Similar in color to a Dark Mild, but a little weaker in strength.",
			'tags'			=>	"McEwans 60",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"14",
			...
			'history'			=>	"Malt-focused ales that gain the vast majority of their character from specialty malts, never the process. Burning malt or wort sugars via ‘kettle caramelization’ is not traditional nor is any blatantly ‘butterscotch’ character. Most frequently a draught product. Smoke character is inappropriate as any found traditionally would have come from the peat in the source water. Scottish ales with smoke character should be entered as a Classic Style Smoked Beer.",
			'style comparison'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat_x005F_x0002_smoked malt is inauthentic and inappropriate.",
			'commercial examples'			=>	"Similar character to a Wee Heavy, but ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'history'			=>	"Malt-focused ales that gain the vast majority of their character from specialty malts, never the process. Burning malt or wort sugars via ‘kettle caramelization’ is not traditional nor is any blatantly ‘butterscotch’ character. Most frequently a draught product. Smoke character is inappropriate as any found traditionally would have come from the peat in the source water. Scottish ales with smoke character should be entered as a Classic Style Smoked Beer.",
			'style comparison'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat_x005F_x0002_smoked malt is inauthentic and inappropriate.",
			'commercial examples'			=>	"Similar character to a Wee Heavy, but much smaller.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" the flavor intensity from whatever made it black is what consumers expect in their beer. Not all breweries make a dry, roasty version typical of Guinness",
			'style comparison'			=>	" a more balanced and chocolaty version is equally acceptable. ",
			'commercial examples'			=>	"Same roots as Irish stout, but as a stronger product. Guinness Extra Stout (Extra Superior Porter, later Double Stout) was first brewed in 1821, and was primarily a bottled product. Described by Guinness as a “more full-bodied beer with a deeper characteristic roasted bitterness and a rich, mature texture. Of all the types of Guinness available today, this is the closest to the porter originally brewed by Arthur Guinness.” Note that in modern times, Guinness Extra Stout has different strengths in different regions",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'commercial examples'			=>	"Bristol Beer Factory Milk Stout, Left Hand Milk Stout, Lancaster Milk Stout, Mackesons XXX Stout, Marston’s Oyster Stout, Samuel Adams Cream Stout",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"More related to historical brews than modern lower_x005F_x0002_strength Scottish ales, these beers have their roots in the strong ales of the 1700s and 1800s, although formulations and methods have changed. A premium product, often produced for export. Modern versions have lower starting and finishing gravities than their historical ancestors.",
			'style comparison'			=>	"Well-modified pale malt, with roasted barley for color. May use some crystal malt for color adjustment. Slight smoke character may be present in some versions, but derives from roasted grains or from the boil. Peated malt is absolutely not traditional.",
			'commercial examples'			=>	"Somewhat similar to an English Barleywine.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Full-bodied and chewy, with a velvety, luscious texture (although the body may decline with long conditioning). A smooth warmth from aged alcohol should be present. Carbonation may be low to moderate, depending on age and conditioning.",
			'style comparison'			=>	"The richest and strongest of modern English Ales. The character of these ales can change significantly over time",
			'commercial examples'			=>	" both young and old versions should be appreciated for what they are. The malt profile can vary widely",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,39",
			'bugu_max'			=>	"0,52",
			'overall impression'			=>	"Easy-drinking, approachable, malt_x005F_x0002_oriented American craft beer, often with interesting fruit, hop, or character malt notes. Well-balanced and clean, is a refreshing pint without aggressive flavors.",
			...
			'characteristic ingredients'			=>	"Brewpub alternative to standard American lagers, typically offered as an entry-level craft beer.",
			'style comparison'			=>	"An American craft beer style produced by manymicrobreweries and brewpubs, particularly those who cannot produce lagers. Regional variations exist (many US West Coast brewpub examples are more assertive, like pale ales) but in most areas this beer is designed as the least challenging beer in their lineup.",
			'commercial examples'			=>	"Generally all malt, but can include up to 25% wheat malt and some sugar adjuncts. Any hop variety can be used. Clean American, lightly fruity English, or Kölsch yeast. May also be made with lager yeast, or cold_x005F_x0002_conditioned. Some versions may have honey, spices and/or fruit added, although if any of these ingredients are stronger than a background flavor they should be entered in those specialty categories instead. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"A modern American craft beer era adaptation of English pale ale, reflecting indigenous ingredients (hops, malt, yeast, and water). Prior to the explosion in popularity of IPAs, was traditionally the most well-known and popular of American craft beers.",
			'style comparison'			=>	"Pale ale malt, typically North American two-row. American or New World hops, with a wide range of allowable characteristics. American or English ale yeast (neutral to lightly fruity). Specialty grains may add character and complexity, but generally make up a relatively small portion of the grist. Grains that add malt flavor and richness, light sweetness, and toasty or bready notes are often used (along with late hops) to differentiate brands.",
			'commercial examples'			=>	"Typically lighter in color, cleaner in fermentation by-products, and having less caramel flavors than English counterparts. There can be some overlap in color between American pale ale and American amber ale. The American pale ale will generally be cleaner, have a less caramelly malt profile, less body, and often more finishing hops. Less bitterness in the balance and alcohol strength than an American IPA. More balanced and drinkable, and less intensely hop-focused and bitter than session-strength American IPAs (aka Session IPAs).",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'commercial examples'			=>	"Deschutes Cinder Cone Red, Full Sail Amber, Kona Lavaman Red Ale, North Coast Ruedrichs Red Seal Ale, Rogue American Amber Ale, Tröegs HopBack Amber Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"American West Coast original, brewed originally as Steam Beer in the Gold Rush era. Large shallow open fermenters (coolships) were traditionally used to compensate for the absence of refrigeration and to take advantage of the cool ambient temperatures in the San Francisco Bay area. Fermented with a lager yeast, but one that was selected to ferment relatively clean beer at warmer temperatures. Modern versions are based on Anchor Brewing re-launching the style in the 1970s.",
			'style comparison'			=>	"Pale ale malt, non-citrusy hops (often Northern Brewer), small amounts of toasted malt and/or crystal malts. Lager yeast",
			'commercial examples'			=>	" however, some strains (often with the mention of “California” in the name) work better than others at the warmer fermentation temperatures (55 to 60 °F) typically used. Note that some German yeast strains produce inappropriate sulfury character. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"A stronger, more aggressive version of pre_x005F_x0002_prohibition porters and/or English porters developed in the modern craft beer era. Historical versions existed, particularly (see the Historical Beer, Pre-Prohibition Porter). This style describes the modern craft version.",
			'style comparison'			=>	"May contain several malts, prominently dark malts, which often include black malt (chocolate malt is also often used). American hops typically used for bittering, but US or UK finishing hops can be used",
			'commercial examples'			=>	" a clashing citrus quality is generally undesirable. Ale yeast can either be clean US versions or characterful English varieties.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Medium-light to medium body, with a smooth texture. Medium to medium-high carbonation. No harsh hop_x005F_x0002_derived astringency. Very light, smooth alcohol warming not a fault if it does not intrude into overall balance.",
			'style comparison'			=>	"A modern American craft beer interpretation of the historical English style, brewed using American ingredients and attitude. The basis for many modern variations, including the stronger Double IPA as well as IPAs with various other ingredients. Those other IPAs should generally be entered in the Specialty IPA style. Oak is inappropriate in this style",
			'commercial examples'			=>	" if noticeably oaked, enter in wood-aged category.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,92",
			'bugu_max'			=>	"0,24",
			'overall impression'			=>	"An intensely hoppy, fairly strong pale ale without the big, rich, complex maltiness and residual sweetness and body of an American barleywine. Strongly hopped, but clean, dry, and lacking harshness. Drinkability is an important characteristic",
			...
			'characteristic ingredients'			=>	"Medium-light to medium body, with a smooth texture. Medium to medium-high carbonation. No harsh hop_x005F_x0002_derived astringency. Restrained, smooth alcohol warming acceptable.",
			'style comparison'			=>	"A showcase for hops, yet remaining quite drinkable. The adjective “double is arbitrary and simply implies a stronger version of an IPA",
			'commercial examples'			=>	" “imperial,” “extra,” “extreme,” or any other variety of adjectives would be equally valid, although the modern American market seems to have now coalesced around the “double” term.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,81",
			'bugu_max'			=>	"1,11",
			'overall impression'			=>	"A strong, full-flavored American ale that challenges and rewards the palate with full malty and hoppy flavors and substantial bitterness. The flavors are bold but complementary, and are stronger and richer than average_x005F_x0002_strength pale and amber American ales.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'history'			=>	"Dark malts should be used with restraint. Much of the color arises from a lengthy boil. Some commercial examples may be larger than the Vital Statistics, and some may not be brewed every year.",
			'characteristic ingredients'			=>	"A relatively recent American craft beer style that was first brewed at the Rubicon Brewing Company in 1988. Often a winter seasonal, vintage, or one-off release. Breweries frequently experiment with this style, leading to a range of interpretations.",
			'style comparison'			=>	"Typically brewed with a combination of American two-row and American wheat. Style commonly uses 50% or more wheat malt. Any variety of hops may be used. May be oak-aged.",
			'commercial examples'			=>	"More than simply a wheat-based barleywine, many versions have very expressive fruity and hoppy notes, while others develop complexity through oak aging. Less emphasis on the hops than American Barleywine. Has roots in American Wheat Beer rather than any German wheat styles, so should not have any German weizen yeast character.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,11",
			'bugu_max'			=>	"0,25",
			'overall impression'			=>	"A very pale, refreshing, low-alcohol German wheat beer with a clean lactic sourness and a very high carbonation level. A light bread dough malt flavor supports the sourness, which shouldn’t seem artificial. Any Brettanomycesfunk is restrained.",
			...
			'characteristic ingredients'			=>	"In Germany, it is classified as a Schankbierdenoting a small beer of starting gravity in the range 7-8 °P. Often served with the addition of a shot of sugar syrups (mit schuss) flavored with raspberry (himbeer), woodruff (waldmeister), or Caraway schnapps (Kümmel) to counter the substantial sourness. Has been described by some as the most purely refreshing beer in the world.",
			'style comparison'			=>	"A regional specialty of Berlin",
			'commercial examples'			=>	" referred to by Napoleons troops in 1809 as “the Champagne of the North” due to its lively and elegant character. At one point, it was smoked and there used to be Märzen-strength (14 °P) version. Increasingly rare in German, but some American craft breweries now regularly produce the style.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,21",
			'bugu_max'			=>	"0,44",
			'overall impression'			=>	"A sour, fruity, red wine-like Belgian_x005F_x0002_style ale with interesting supportive malt flavors and fruit complexity. The dry finish and tannin completes the mental image of a fine red wine.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Spontaneously fermented wild ales from the area in and around Brussels (the Senne Valley) stem from a farmhouse brewing and blending tradition several centuries old. The number of producers is constantly dwindling and some producers are untraditionally sweetening their products (post_x005F_x0002_fermentation) to make them more palatable to a wider audience. These guidelines describe the traditional dry product.",
			'style comparison'			=>	"Unmalted wheat (30-40%), Pilsner malt and aged hops (3 years) are used. The aged hops are used more for preservative effects than bitterness, and makes actual bitterness levels difficult to estimate. Traditionally these beers are spontaneously fermented with naturally occurring yeast and bacteria in predominately oaken barrels. The barrels used are old and have little oak character, so don’t expect a fresh or forward oak character – more neutral is typical. Home-brewed and craft-brewed versions are more typically made with pure cultures of yeast commonly including Saccharomyces, Brettanomyces, Pediococcus and Lactobacillus in an attempt to recreate the effects of the dominant microbiota of Brussels and the surrounding countryside of the Senne River valley. Cultures taken from bottles are sometimes used but there is no simple way of knowing what organisms are still viable.",
			'commercial examples'			=>	"More complex and carbonated than a lambic. The sourness isn’t necessarily higher, but it tends to have more of a well-developed wild character.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Fruit-based lambics are often produced like gueuze by mixing one, two, and three-year old lambic. “Young” characteristic “wild” taste of the Senne River valley. Fruit is commonly added halfway through aging and the yeast and bacteria will ferment all sugars from the fruit. Fruit may also be added to unblended lambic. The most traditional styles of fruit lambics include kriek (cherries), framboise (raspberries) and druivenlambik (muscat grapes). IBUs are approximate since aged hops are used",
			'style comparison'			=>	" Belgians use hops for anti-bacterial properties more than bittering in lambics.",
			'commercial examples'			=>	"Spontaneously fermented wild ales from the area in and around Brussels (the Senne Valley) stem from a farmhouse brewing and blending tradition several centuries old. The number of producers is constantly dwindling and some are untraditionally sweetening their products (post-fermentation) with sugar or sweet fruit to make them more palatable to a wider audience. Fruit was traditionally added to lambic or gueuze, either by the blender or publican, to increase the variety of beers available in local cafes.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,18",
			'bugu_max'			=>	"0,38",
			'overall impression'			=>	"A refreshing, elegant, tasty, moderate_x005F_x0002_strength wheat-based ale.",
			...
			'characteristic ingredients'			=>	" it was later revived by Pierre Celis at Hoegaarden, and has grown steadily in popularity over time, both with modern craft brewers and mass-market producers who see it as a somewhat fruity summer seasonal beer. ",
			'style comparison'			=>	"About 50% unmalted wheat and 50% pale barley malt (usually Pils malt) constitute the grist. In some versions, up to 5-10% raw oats may be used.Spices of freshly-ground coriander and Curaçao or sometimes sweet orange peel complement the sweet aroma and are quite characteristic. Other spices (e.g., chamomile, cumin, cinnamon, Grains of Paradise) may be used for complexity but are much less prominent. Ale yeast prone to the production of mild, spicy flavors is very characteristic. In some instances a very limited lactic fermentation, or the actual addition of lactic ",
			'commercial examples'			=>	"Low bitterness level with a balance similar to a Weissbier, but with spice and citrus character coming from additions rather than the yeast.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,42",
			'bugu_max'			=>	"0,56",
			'overall impression'			=>	"A moderately malty, somewhat fruity, easy-drinking, copper-colored Belgian ale that is somewhat less aggressive in flavor profile than many other Belgian beers. The malt character tends to be a bit biscuity with light toasty, honey-like, or caramelly components",
			...
			'characteristic ingredients'			=>	"Most commonly found in the Flemish provinces of Antwerp and Brabant. Considered “everyday” beers (Category I). Compared to their higher alcohol Category S cousins, they are Belgian “session beers” for ease of drinking. Nothing should be too pronounced or dominant",
			'style comparison'			=>	" balance is the key. Yeast character generally more subtle than many Belgian beers, with some of the fruitiness being hop-driven.",
			'commercial examples'			=>	"Produced by breweries with roots as far back as the mid-1700s, the most well-known examples were perfected after the Second World War with some influence from Britain, including hops and yeast strains. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'history'			=>	"References to the devil are included in the names of many commercial examples of this style, referring to their potent alcoholic strength and as a tribute to the original example (Duvel). The best examples are complex and delicate. High carbonation helps to bring out the many flavors and to increase the perception of a dry finish. Traditionally bottle_x005F_x0002_conditioned (or refermented in the bottle).",
			'characteristic ingredients'			=>	"Originally developed by the Moortgat brewery after WWI as a response to the growing popularity of Pilsner beers.",
			'style comparison'			=>	"Pilsner malt with substantial sugary adjuncts. Saazer-type hops or Styrian Goldings are commonly used. Belgian yeast strains are used – those that produce fruity esters, spicy phenolics and higher alcohols –often aided by slightly warmer fermentation temperatures. Fairly soft water. Spicing is not traditional",
			'commercial examples'			=>	" if present, should be a background character only.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style comparison'			=>	"Like a top-fermented Belgian/Trappist interpretation of a German Pils – pale, hoppy, and well_x005F_x0002_attenuated, but showing prototypical Belgian yeast character. Has less sweetness, higher attenuation, less character malt, and is more hop-centered than a Belgian Pale Ale. More like a much smaller, more highly hopped tripel than a smaller Belgian Blond Ale.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Most commercial examples are in the 6.5 – 7% ABV range. Traditionally bottle-conditioned (or refermented in the bottle).",
			'style comparison'			=>	"Originated at monasteries in the Middle Ages, and was revived in the mid-1800s after the Napoleonic era.",
			'commercial examples'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and phenolics are commonly used. Impression of complex grain bill, although traditional versions are typically Belgian Pils malt with caramelized sugar syrup or other unrefined sugars providing much of the character. Saazer-type, English-type or Styrian Goldings hops commonly used. No spices are traditionally used, although restrained use is allowable (background strength only).",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Authentic Trappist versions tend to be drier (Belgians would say more digestible) than Abbey versions, which can be rather sweet and full-bodied. Traditionally bottle_x005F_x0002_conditioned (or refermented in the bottle). Sometimes known as a Trappist Quadruple, most are simply known by their strength or color designation.",
			'style comparison'			=>	"Most versions are unique in character reflecting characteristics of individual breweries, produced in limited quantities and often highly sought-after.",
			'commercial examples'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and sometimes phenolics are commonly used. Impression of a complex grain bill, although many traditional versions are quite simple, with caramelized sugar syrup or unrefined sugars and yeast providing much of the complexity. Saazer-type, English-type or Styrian Goldings hops commonly used. Spices generally not used",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Minor style associated with Leipzig but originating in the Middle Ages in the town of Goslar on the Gose River. Documented to have been in Leipzig by 1740. Leipzig was said to have 80 Gose houses in 1900. Production declined significantly after WWII, and ceased entirely in 1966. Modern production was revived in the 1980s, but the beer is not widely available. ",
			'style comparison'			=>	"Pilsner and wheat malt, restrained use of salt and coriander seed, lactobacillus. The coriander should have a fresh, citrusy (lemon or bitter orange), bright note, and not be vegetal, celery-like, or ham-like. The salt should have a sea salt or fresh salt character, not a metallic, iodine note.",
			'commercial examples'			=>	"Perceived acidity is not as intense as and lactobacillus – should not taste overtly salty. Coriander aroma can be similar to a witbier. Haziness similar to a Weissbier.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,34",
			'bugu_max'			=>	"0,55",
			'overall impression'			=>	"A darker-colored, light-flavored, malt_x005F_x0002_accented beer with a dry finish and interesting character malt flavors. Refreshing due to its high carbonation and mild flavors, and highly sessionable due to being served very fresh and with restrained alcohol levels.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Served young. Smoke and sour is an unusual combination that is not for everyone.",
			'style comparison'			=>	"Originating in Lichtenhain, in Thüringen (central Germany). Height of popularity was towards the end of the 1800s, and was widely available throughout Thüringen. Like a ",
			'commercial examples'			=>	"Smoked barley malt, wheat malt, lactobacillus, top-fermenting yeast. Grists vary, but the wheat would typically be 30-50%.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	" Mann’s has over 90% market share in Britain, but in an increasingly small segment. Always bottled. Frequently used as a sweet mixer with cask mild and bitter in pubs. Commercial versions can be pasteurized and back-sweetened, which gives more of a sugary-sweet flavor.",
			'style comparison'			=>	"Developed by Mann’s as a bottled product in 1902. Claimed at the time to be “the sweetest beer in London.” Pre_x005F_x0002_WWI versions were around 5% ABV, but same general balance. Declined in popularity in second half of 20th century, and now nearly extinct.",
			'commercial examples'			=>	"English pale ale malt as a base with a healthy proportion of darker caramel malts and often some roasted (black) malt and wheat malt (this is Mann’s traditional grist – others can rely on dark sugars for color and flavor). Moderate to high carbonate water. English hop varieties are most authentic, though with low flavor and bitterness almost any type could be used. Post-fermentation sweetening with lactose or artificial sweeteners, or sucrose (if pasteurized).",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0,71",
			'bugu_max'			=>	"1,09",
			'overall impression'			=>	"A low-gravity, highly-carbonated, light_x005F_x0002_bodied ale combining an oak-smoked flavor with a clean hop bitterness. Highly sessionable.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"The classic American Pilsner was brewed both pre-Prohibition and post-Prohibition with some differences. OGs of 1.050–1.060 would have been appropriate for pre_x005F_x0002_Prohibition beers while gravities dropped to 1.044–1.048 after Prohibition. Corresponding IBUs dropped from a pre_x005F_x0002_Prohibition level of 30–40 to 25–30 after Prohibition.",
			'style comparison'			=>	"A version of Pilsner brewed in the USA by immigrant German brewers who brought the process and yeast with them, but who had to adapt their recipes to work with native hops and malt. This style died out after Prohibition but was resurrected by homebrewers in the 1990s. Few commercial versions are made, so the style still remains mostly a homebrew phenomenon.",
			'commercial examples'			=>	"Six-row barley with 20% to 30% flaked maize (corn) or rice to dilute the excessive protein levels",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"A specialty German rye beer originally brewed in Regensburg, Bavaria. Never a widely popular style, it has all but disappeared in modern times.",
			'style comparison'			=>	"Malted rye typically constitutes 50% or greater of the grist (some versions have 60-65% rye). Remainder of grist can include pale malt, Munich malt, wheat malt, crystal malt and/or small amounts of debittered dark malts for color adjustment. Weizen yeast provides distinctive banana esters and clove phenols. Light usage of Saazer-type hops in bitterness, flavor and aroma. Lower fermentation temperatures accentuate the clove character by suppressing ester formation. Decoction mash traditionally used (as with weissbiers).",
			'commercial examples'			=>	"A more distinctive variant of a dunkelweizen using malted rye instead of malted wheat. American Rye Beers will not have the weizen yeast character, and likely more hops.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic ingredients'			=>	"Thick, viscous, and heavy with protein (no boil means no hot break). Nearly still to medium-low carbonation. Strongly warming from the alcohol level and young age, but often masked by sweetness.",
			'style comparison'			=>	"The use of rye doesn’t mean that it should taste like caraway (a dominant flavor in rye bread). The use of juniper berries will give a flavor like gin (similarly flavored with juniper berries). The juniper acts a bit like hops in the balance and flavor, providing some counterpoint to the sweet malt.",
			'commercial examples'			=>	"An indigenous traditional style from Finland",
