...
class Seeder_eliseontwerpt_brouwerbouwer_bjcp_categories extends Seeder
	...
	public function run()
	{
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"An American craft beer adaptation of the German weissbier style using a cleaner yeast and more hops, first widely popularized by Widmer in the mid-1980s.",
			'commercial_examples'			=>	"Clean American ale or lager yeast (German weissbier yeast is inappropriate). Large proportion of wheat malt (often 30–50%, which is lower than is typical in German weissbiers). American, German, or New World hops are typical.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"Two-row or six-row base malt. Color malts such as victory, amber, etc. Caramel malt adjuncts. European or American hops or a combination of both.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'appearance'			=>	" the balance between the malt and hops may vary. Faint hint of caramel is acceptable. Light (but never intrusive) diacetyl and light, fruity hop-derived esters are acceptable, but need not be present. No sulfur.",
			...
			'commercial_examples'			=>	"Soft water with low sulfate and carbonate content, Saazer-type hops, Czech Pilsner malt, Czech lager yeast. Low ion water provides a distinctively soft, rounded hop profile despite high hopping rates. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'appearance'			=>	" though the balance between the malt and hops may vary, the interplay is rich and complex. Light diacetyl, or very low fruity hop-derived esters are acceptable, but need not be present. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'aroma'			=>	"Moderate malty richness, with an emphasis on toasty_x005F_x0002_doughy aromatics and an impression of sweetness. Low to medium-low floral, herbal, or spicy hops. The malt should not have a deeply toasted, caramel, or biscuity quality. Clean lager fermentation character.",
			...
			'tags'			=>	"Less intense and less richly toasted thana Märzen. More rich-heavy in body than a Helles, with more hop flavor and higher alcohol. Less rich in malt intensity than a Maibock. The malt complexity is similar to a higher-gravity Czech Premium Pale Lager, although without the associated hops.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"4",
			'sub_categorie_id'			=>	"4C",
			...
			'characteristic_ingredients'			=>	"Base of Pils and/or Vienna malt with some Munich malt to add character (although much less than in a traditional bock). No non-malt adjuncts. Saazer_x005F_x0002_type hops. Clean lager yeast. Decoction mash is typical, but boiling is less than in Dunkles Bock to restrain color development.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"Similar to a German Pils or Helles, continental Pils malt, German lager yeast, Saazer-type hops.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'commercial_examples'			=>	"Traditional German hops (Hallertau, Tettnang, Spalt or Hersbrucker). German Pils or pale malt. Attenuative, clean ale yeast. Up to 20% wheat malt Current commercial practice is to ferment warm, cold condition for a short period of time, and serve young.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"Minerally water with high levels of sulfates, carbonates and chlorides, German or Czech noble hops, Pilsner malt, German lager yeast. Newer commercial versions can contain adjuncts and hop extract.",
			'commercial_examples'			=>	"Less finishing hops and more body than a Pils but more bitter than a Helles.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'mouthfeel'			=>	"Initial malt flavor often suggests sweetness, but finish is moderately-dry to dry. Distinctive and complex maltiness often includes a bready, toasty aspect. Hop bitterness is moderate, and the hop flavor is low to none (German types: complex, floral, herbal, or spicy). Hops provide sufficient balance that the malty palate and finish do not seem sweet. The aftertaste is malty, with the same elegant, rich malt flavors lingering. Noticeable caramel, biscuit, or roasted flavors are inappropriate. Clean lager fermentation profile.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'tags'			=>	"German Rauchmalz (beechwood-smoked Vienna-type malt) typically makes up 20-100% of the grain bill, with the remainder being German malts typically used in a Märzen. Some breweries adjust the color slightly with a bit of roasted malt. German lager yeast. German or Czech hops.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"6",
			'sub_categorie_id'			=>	"6C",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"Vienna malt provides a lightly toasty and complex, Maillard-rich malt profile. As with Märzens, only the finest quality malt should be used, along with Continental hops (preferably Saazer types or Styrians). Can use some caramel malts and/or darker malts to add color and sweetness, but caramel malts shouldn’t add significant aroma and flavor and dark malts shouldn’t provide any roasted character.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic_ingredients'			=>	"Grist varies, although traditional German versions emphasized Franconian pale and color malt. The notion of elegance is derived from the high_x005F_x0002_quality local ingredients, particularly the malts. Spalt or other typically spicy local hops are most common. Frugal Franconian brewers rarely used decoction brewing due to the cost of energy.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.22",
			'bugu_max'			=>	"0.23",
			'overall_impression'			=>	"A strong, rich, and very malty German lager that can have both pale and dark variants. The darker versions have more richly-developed, deeper malt flavors, while the paler versions have slightly more hops and dryness.",
			...
			'style_comparison'			=>	"Pils and/or Vienna malt for pale versions (with some Munich), Munich and Vienna malts for darker ones and occasionally a tiny bit of darker color malts (such as Carafa). Saazer-type hops. Clean lager yeast. Decoction mashing is traditional.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'history'			=>	"#N/A",
			'characteristic_ingredients'			=>	"Pale ale, amber, and/or crystal malts. May use a touch of dark malt for color adjustment. May use sugar adjuncts, corn, or wheat. English finishing hops are most traditional, but any hops are fair game",
			'style_comparison'			=>	" if American hops are used, a light touch is required. Characterful British yeast. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.63",
			'bugu_max'			=>	"0.83",
			'overall_impression'			=>	"An average-strength to moderately_x005F_x0002_strong British bitter ale. The balance may be fairly even between malt and hops to somewhat bitter. Drinkability is a critical component of the style. A rather broad style that allows for considerable interpretation by the brewer.",
			...
			'characteristic_ingredients'			=>	"Pale ale, amber, and/or crystal malts, may use a touch of black malt for color adjustment. May use sugar adjuncts, corn or wheat. English finishing hops are most traditional, but any hops are fair game",
			'style_comparison'			=>	" if American hops are used, a light touch is required. Characterful British yeast. Burton versions use medium to high sulfate water, which can increase the perception of dryness and add a minerally or sulfury aroma and flavor.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'aroma'			=>	"Hop aroma is moderately low to moderately high, and can use any variety of hops – floral, herbal, or earthy English hops and citrusy American hops are most common. Frequently a single hop varietal will be showcased. Little to no malt aroma",
			'appearance'			=>	" no caramel. Medium-low to low fruity aroma from the hops rather than esters. Little to no diacetyl.",
			...
			'style_comparison'			=>	"Low-color pale or lager malt acting as a blank canvas for the hop character. May use sugar adjuncts, corn or wheat. English hops frequently used, although citrusy American varietals are becoming more common. Somewhat clean-fermenting British yeast.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'tags'			=>	"Superficially similar to English Pale Ales, although much more highly carbonated, with less caramel, less late hops, and showcasing the signature yeast strain and hop variety. More bitter than IBUs might suggest due to high attenuation, low final gravity, and somewhat coarse hops. ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"12",
			...
			'style_comparison'			=>	"Pale ale malt. English hops are traditional, particularly as finishing hops. Attenuative British ale yeast. Refined sugar may be used in some versions. Some versions may show a sulfate character from Burton-type water, but this is not essential to the style.",
			'commercial_examples'			=>	"Generally will have more finish hops and Has less hop intensity and a more pronounced malt flavor than typical American versions.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'tags'			=>	"Pale British base malts (often fairly dextrinous), crystal malt, dark malts or dark sugar adjuncts, may also include adjuncts such as flaked maize, and may be colored with brewer’s caramel. Characterful British ale yeast. Any type of hops, since their character is muted and rarely is noticeable.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"13",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"Pale, caramel and dark roasted malts (often chocolate) and grains. Oatmeal or malted oats (5-20% or more) used to enhance fullness of body and complexity of flavor. Hops primarily for bittering. Can use brewing sugars or syrups. English ale yeast.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic_ingredients'			=>	"Pale and dark roasted malts and grains, historically also could have used brown and amber malts. Hops mostly for bitterness, typically English varieties. May use adjuncts and sugar to boost gravity.",
			'style_comparison'			=>	"Similar in balance to an Irish Extra Stout, but with more alcohol. Not as big or intense as a Russian Imperial Stout. Lacking the strong bitterness and high late hops of American Stouts. Similar gravity as Tropical Stout, but with a drier finish, higher bitterness, and less esters.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'appearance'			=>	" peat smoke is inappropriate. Diacetyl should be low to none. Low to moderate esters and alcohol are often present in stronger versions. Hops are very low to none, and can be slightly earthy or floral.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'mouthfeel'			=>	" if present, they are typically low-color caramel notes. Low to medium fruity esters optional, but are welcome. Light to moderate hop flavor (any variety), but shouldn’t be overly aggressive. Medium-low to medium bitterness, but the balance is normally towards the malt or even between malt and hops. Finishes medium-dry to slightly malty-sweet",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic_ingredients'			=>	"A modern American craft beer era adaptation of English pale ale, reflecting indigenous ingredients (hops, malt, yeast, and water). Prior to the explosion in popularity of IPAs, was traditionally the most well-known and popular of American craft beers.",
			'style_comparison'			=>	"Pale ale malt, typically North American two-row. American or New World hops, with a wide range of allowable characteristics. American or English ale yeast (neutral to lightly fruity). Specialty grains may add character and complexity, but generally make up a relatively small portion of the grist. Grains that add malt flavor and richness, light sweetness, and toasty or bready notes are often used (along with late hops) to differentiate brands.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic_ingredients'			=>	"Pale ale malt, typically North American two-row. Medium to dark crystal malts. May also contain specialty grains which add additional character and uniqueness. American or New World hops, often with citrusy flavors, are common but others may also be used.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'comments'			=>	"This style is narrowly defined around the prototypical Anchor Steam example, although allowing other typical ingredients of the era. Northern Brewer hops are not a strict requirement for the style",
			'history'			=>	" modern American and New World-type hops (especially citrusy ones) are inappropriate, however.",
			...
			'style_comparison'			=>	"Pale ale malt, non-citrusy hops (often Northern Brewer), small amounts of toasted malt and/or crystal malts. Lager yeast",
			...
			'tags'			=>	"Superficially similar to an American Amber Ale, but with specific choices for malt and hopping –the hop flavor/aroma is traditional (not modern) American hops, malt flavors are more toasty, the hopping is always assertive, and a warm-fermented lager yeast is used. Less attenuated, less carbonated and less fruity than Australian ",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"19",
			...
			'characteristic_ingredients'			=>	"Well-modified pale malt, plus crystal and darker malts (typically chocolate). American hops are typical, but continental or New World hops can also be used. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"May contain several malts, prominently dark malts, which often include black malt (chocolate malt is also often used). American hops typically used for bittering, but US or UK finishing hops can be used",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'tags'			=>	"Well-modified pale malt, with generous quantities of roasted malts and/or grain. May have a complex grain bill using virtually any variety of malt. Any type of hops may be used. American or English ale yeast.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"21",
			...
			'aroma'			=>	"A prominent to intense hop aroma featuring one or more characteristics of American or New World hops, such as citrus, floral, pine, resinous, spicy, tropical fruit, stone fruit, berry, melon, etc. Many versions are dry hopped and can have an additional fresh hop aroma",
			...
			'tags'			=>	"The first modern American craft beer example is generally believed to be Anchor Liberty Ale, first brewed in 1975 and using whole Cascade hops",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"21",
			...
			'characteristic_ingredients'			=>	"Pale and wheat malts, Belgian yeast, citrusy American type hops.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"A showcase for hops, yet remaining quite drinkable. The adjective “double is arbitrary and simply implies a stronger version of an IPA",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'comments'			=>	" burnt malt flavors are inappropriate. While strongly malty on the palate, the finish should seem bitter to bittersweet. Should not be syrupy and under-attenuated. The aftertaste typically has malt, hops, and alcohol noticeable. ",
			...
			'tags'			=>	" some character malts would be appropriate, medium to dark crystal malts are typical. Citrusy or piney American hops are common, although any American or New World varieties can be used in quantity, provided they do not clash with the malt character. Generally uses an attenuative American yeast.",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			'categorie_id'			=>	"22",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.38",
			'bugu_max'			=>	"0.5",
			'overall_impression'			=>	"A richly textured, high alcohol sipping beer with a significant grainy, bready flavor and sleek body. The emphasis is first on the bready, wheaty flavors with interesting complexity from malt, hops, fruity yeast character and alcohol complexity.",
			...
			'style_comparison'			=>	"Typically brewed with a combination of American two-row and American wheat. Style commonly uses 50% or more wheat malt. Any variety of hops may be used. May be oak-aged.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'comments'			=>	" sourness provides the balance rather than hops. Never vinegary. A restrained citrusy-lemony or tart apple fruitiness may be detected. Very dry finish. Balance dominated by sourness, but some malt flavor should be present. No hop flavor. May optionally have a restrained funky Brettanomycescharacter. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	"Unmalted wheat (30-40%), Pilsner malt and aged hops (3 years) are used. The aged hops are used more for preservative effects than bitterness, and makes actual bitterness levels difficult to estimate. Traditionally these beers are spontaneously fermented with naturally occurring yeast and bacteria in predominately oaken barrels. The barrels used are old and have little oak character, so don’t expect a fresh or forward oak character – more neutral is typical. Home-brewed and craft-brewed versions are more typically made with pure cultures of yeast commonly including Saccharomyces, Brettanomyces, Pediococcus and Lactobacillus in an attempt to recreate the effects of the dominant microbiota of Brussels and the surrounding countryside of the Senne River valley. Cultures taken from bottles are sometimes used but there is no simple way of knowing what organisms are still viable.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'style_comparison'			=>	" Belgians use hops for anti-bacterial properties more than bittering in lambics.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'commercial_examples'			=>	"Produced by breweries with roots as far back as the mid-1700s, the most well-known examples were perfected after the Second World War with some influence from Britain, including hops and yeast strains. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'aroma'			=>	"Quite aromatic, with fruity, spicy, and hoppy characteristics evident. The esters can be fairly high (moderate to high), and are often reminiscent of citrus fruits such as oranges or lemons. The hops are low to moderate and are often spicy, floral, earthy, or fruity. Stronger versions can have a soft, spicy alcohol note (low intensity). Spicy notes are typically peppery rather than clove-like, and can be up to moderately_x005F_x0002_strong (typically yeast-derived). Subtle, complementary herb or spice additions are allowable, but should not dominate. The malt character is typically slightly grainy in character and low in intensity. Darker and stronger versions will have more noticeable malt, with darker versions taking characteristics associated with grains of that color (toasty, biscuity, caramelly, of bitterness, some of the sour character can be detected (low to moderate).",
			...
			'commercial_examples'			=>	"Not typically spiced, with the yeast, hops and grain providing the character",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'characteristic_ingredients'			=>	"Pilsner malt, Belgian Trappist yeast, Saazer-type hops.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'appearance'			=>	" light vanilla is possible. Alcohols are soft, spicy, perfumy and/or rose-like, and are low to moderate in intensity. Hops are not usually present (but a very low spicy, floral, or herbal hop aroma is acceptable). No dark/roast malt aroma. No hot alcohols or solventy aromas.",
			...
			'commercial_examples'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and sometimes phenolics are commonly used. Impression of a complex grain bill, although many traditional versions are quite simple, with caramelized sugar syrup or unrefined sugars and yeast providing much of the complexity. Saazer-type, English-type or Styrian Goldings hops commonly used. Spices generally not used",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'mouthfeel'			=>	" the acidity is providing the balance, not hops. Fresh, clean palate and slightly puckery aftertaste. The wheat character is on the low side",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_sub_categories')->insert([
			...
			'bugu_min'			=>	"0.22",
			'bugu_max'			=>	"0.36",
			'overall_impression'			=>	"A dunkelweizen made with rye rather than wheat, but with a greater body and light finishing hops.",
			'aroma'			=>	"Light to moderate spicy rye aroma intermingled with esters, either banana or citrus). Light spicy, floral, or herbal hops are acceptable.",
			...
			'commercial_examples'			=>	"A more distinctive variant of a dunkelweizen using malted rye instead of malted wheat. American Rye Beers will not have the weizen yeast character, and likely more hops.",
