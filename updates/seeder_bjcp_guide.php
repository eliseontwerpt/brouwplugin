...
class Seeder_eliseontwerpt_brouwerbouwer_bjcp_guide extends Seeder
	...
	public function run()
	{
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Genesee Cream Ale, Liebotschaner Cream Ale, Little Kings Cream Ale, New Glarus Spotted Cow, Old Style, Sleeman Cream Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Bell’s Oberon, Boulevard Unfiltered Wheat Beer, Goose Island 312 Urban Wheat Ale, Widmer Hefeweizen",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'notes'			=>	"Brooklyn Lager, Capital Winter Skål, Dos Equis Amber, Schell’s Oktoberfest, Yuengling Lager",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Baltika #4 Original, Devils Backbone Old Virginia Dark, Dixie Blackened Voodoo, Saint Pauli Girl Dark, San Miguel Dark, Session Black Dark Lager, Shiner Bock",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Březňák Světlé výčepní pivo, Notch Session Pils, Pivovar Kout na Šumavě Koutská 10°, Únětické pivo 10°",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Bernard Sváteční ležák, Gambrinus Premium, Kout na Šumavě Koutská 12°, Pilsner Urquell, Pivovar Jihlava Ježek 11°, Primátor Premium, Únětická 12°",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'notes'			=>	"Augustiner Oktoberfest, Hacker-Pschorr Superior Festbier, Hofbräu Festbier, Löwenbräu Oktoberfestbier, Paulaner Wiesn, Schönramer Gold, Weihenstephaner Festbier",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Beck’s Light, Bitburger Light, Mahr’s Leicht, Paulaner Münchner Hell Leicht, Paulaner Premium Leicht",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Früh Kölsch, Gaffel Kölsch, Mühlen Kölsch, Reissdorf Kölsch, Sion Kölsch, Sünner Kölsch",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"DAB Original, Dortmunder Kronen, Dortmunder Union Export, Flensburger Gold, Gordon Biersch Golden Export, Great Lakes Dortmunder Gold",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"König Pilsener, Left Hand Polestar Pils, Paulaner Premium Pils, Schönramer Pils, Stoudt Pils, Tröegs Sunshine Pils, Trumer Pils",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Buergerliches Ur-Saalfelder, Hacker-Pschorr Original Oktoberfest, Paulaner Oktoberfest, Weltenburg Kloster Anno 1050",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Eisenbahn Rauchbier, Kaiserdom Rauchbier, Schlenkerla Rauchbier Märzen, Spezial Rauchbier Märzen Victory Scarlet Fire Rauchbier",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Cuauhtémoc Noche Buena, Chuckanut Vienna Lager, Devils Backbone Vienna Lager, Figueroa Mountain Danish-style Red Lager, Heavy Seas Cutlass Amber Lager, Schell’s Firebrick",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Bolten Alt, Diebels Alt, Füchschen Alt, Original Schlüssel Alt, Schlösser Alt, Schumacher Alt, Uerige Altbier",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pilsner malt, German hops, German lager yeast, same as a Munich Helles.",
			'style_comparison'			=>	"Most commonly, a young, unfiltered and unpasteurized version of a Munich Helles, though it can be a young, unfiltered and unpasteurized version of other golden German lagers, such as a Pilsner or a seasonal golden lager made specifically for serving young.",
			'commercial_examples'			=>	"(local) Paulaner, Paulaner Brauhaus, Hofbrau, Tegernseer Tal. (bottled) Ayinger Kellerbier, Hacker-Pschorr Munchner Kellerbier Anno 1417, Hofbrau Munchner Sommer Naturtrub, Wolnzacher Hell Naturtrüb",
			'notes'			=>	"A very common seasonal summer beer brewed by many of the Munich area breweries and served in the beer gardens, where they are very popular.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'notes'			=>	"The original style of Kellerbier from the Franconia area of Germany. A much older style compared to the relatively more recent pale Helles-Style Kellerbier that is popular in the Munich area today.",
			'bjcp_categories_id'			=>	"07C",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pils and/or Vienna malt for pale versions (with some Munich), Munich and Vienna malts for darker ones and occasionally a tiny bit of darker color malts (such as Carafa). Saazer-type hops. Clean lager yeast. Decoction mashing is traditional.",
			'style_comparison'			=>	"A stronger, richer, more full-bodied version of either a Dunkles Bock or a Helles Bock. Pale versions will show higher attenuation and less dark fruity character than the darker versions.",
			'commercial_examples'			=>	"Dark Versions –Andechser Doppelbock Dunkel, Ayinger Celebrator, Paulaner Salvator, Spaten Optimator, Tröegs Troegenator, Weihenstephaner Korbinian,, Pale Versions – Eggenberg Urbock 23º, EKU 28, Plank Bavarian Heller Doppelbock",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'style_comparison'			=>	"Eisbocks are not simply stronger doppelbocks, the name refers to the process of freezing and concentrating the beer and is not a statement on alcohol, some doppelbocks are stronger than Eisbocks. Not as thick, rich, or sweet as a Wheatwine.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'style_comparison'			=>	"Much less roasted and smoother than an Imperial Stout, typically with less alcohol. Lacks the roasty qualities of stouts in general, more taking on the roasted-but-not-burnt characteristics of a schwarzbier. Quite fruity compared to other porters. Higher alcohol than other porters.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"By German brewing tradition, at least 50% of the grist must be malted wheat, although some versions use up to 70%, the remainder is typically Pilsner malt. A decoction mash is traditional, although modern brewers typically don’t follow this practice. Weizen ale yeast produces the typical spicy and fruity character, although high fermentation temperatures can affect the balance and produce off-flavors. ",
			'commercial_examples'			=>	"Ayinger Bräu Weisse, Hacker-Pschorr Weisse, Paulaner Hefe-Weizen Naturtrüb, Schneider Weisse Unser Original, Weihenstephaner Hefeweissbier",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"By German brewing tradition, at least 50% of the grist must be malted wheat, although some versions use up to 70%, the remainder is usually Munich, Vienna, or dark or caramel wheat malts, or Pilsner malt with color malt. A decoction mash is traditional, but infrequently used today. Weizen ale yeasts produce the typical spicy and fruity character, although extreme fermentation temperatures can affect the balance and produce off-flavors. ",
			'style_comparison'			=>	"Reflecting the best yeast and wheat character of a weissbier blended with the malty richness of a Munich dunkel. The banana and clove character is often less apparent than in a weissbier due to the increased maltiness.",
			'commercial_examples'			=>	"Ayinger Ur-Weisse, Ettaler Weissbier Dunkel, Franziskaner Hefe-Weisse Dunkel, Hacker-Pschorr Weisse Dark, Tucher Dunkles Hefe Weizen, Weihenstephaner Hefeweissbier Dunkel",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"A high percentage of malted wheat is used (by German brewing tradition must be at least 50%, although it may contain up to 70%), with the remainder being Munich- and/or Vienna-type barley malts in darker versions, and more Pils malt in paler versions. Some color malts may be used sparingly. A traditional decoction mash can give the appropriate body without cloying sweetness. Weizen ale yeasts produce the typical spicy and fruity character. Too warm or too cold fermentation will cause the phenols and esters to be out of balance and may create off-flavors. Hop choice is essentially irrelevant, but German varieties are most traditional.",
			'style_comparison'			=>	"Stronger and richer than a Weissbier or Dunkles Weissbier, but with similar yeast character. More directly comparable to the Doppelbock style, with the pale and dark variations. Can vary widely in strength, but most are in the bock to doppelbock range. ",
			'commercial_examples'			=>	"Dark –Eisenbahn Weizenbock, Plank Bavarian Dunkler Weizenbock, Penn Weizenbock, Schneider Unser Aventinus, Pale –Plank Bavarian Heller Weizenbock, Weihenstephaner Vitus",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pale ale, amber, and/or crystal malts. May use a touch of dark malt for color adjustment. May use sugar adjuncts, corn, or wheat. English finishing hops are most traditional, but any hops are fair game, if American hops are used, a light touch is required. Characterful British yeast. ",
			'style_comparison'			=>	"Some modern variants are brewed exclusively with pale malt and are known as golden ales, summer ales, or golden bitters. Emphasis is on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales.",
			'commercial_examples'			=>	"Adnams Southwold Bitter, Brains Bitter, Fullers Chiswick Bitter, Greene King IPA, Tetley’s Original Bitter, Youngs Bitter",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'history'			=>	"See comments in category introduction.",
			'characteristic_ingredients'			=>	"Pale ale, amber, and/or crystal malts. May use a touch of dark malt for color adjustment. May use sugar adjuncts, corn or wheat. English finishing hops are most traditional, but any hops are fair game, if American hops are used, a light touch is required. Characterful British yeast.",
			'style_comparison'			=>	"More alcohol than an ordinary bitter, and often using higher-quality ingredients. Less alcohol than a strong bitter. More caramel or base malt character and color than a British Golden Ale. Emphasis is on the bittering hop addition as opposed to the aggressive middle and late hopping seen in American ales.",
			'commercial_examples'			=>	"Adnams SSB, Coniston Bluebird Bitter, Fullers London Pride, Harvey’s Sussex Best Bitter, Shepherd Neame Master Brew Kentish Ale, Timothy Taylor Landlord,  Young’s Special",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.01",
			'fg_max'			=>	"1.016",
			'overall_impression'			=>	"An average-strength to moderately-strong British bitter ale. The balance may be fairly even between malt and hops to somewhat bitter. Drinkability is a critical component of the style. A rather broad style that allows for considerable interpretation by the brewer.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'history'			=>	"Modern golden ales were developed in England to take on strongly-marketed lagers. While it is difficult to identify the first, Hop Backs Summer Lightning, first brewed in 1986, is thought by many to have got the style off the ground.",
			'characteristic_ingredients'			=>	"Low-color pale or lager malt acting as a blank canvas for the hop character. May use sugar adjuncts, corn or wheat. English hops frequently used, although citrusy American varietals are becoming more common. Somewhat clean-fermenting British yeast.",
			'style_comparison'			=>	"More similar to an American Pale Ale than anything else, although it is often lower in alcohol and usually features British ingredients. Has no caramel and fewer esters compared to British bitters and pale ales. Dry as bitters but with less malt character to support the hops, giving a different balance. Often uses (and features) American hops, more so than most other modern British styles.",
			'commercial_examples'			=>	"Crouch Vale Brewers Gold, Fullers Discovery, Golden Hill Exmoor Gold, Hop Back Summer Lightning, Kelham Island Pale Rider, Morland Old Golden Hen, Oakham JHB",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Lightly kilned Australian 2-row pale malt, lager varieties may be used. Small amounts of crystal malt for color adjustment only. Modern examples use no adjuncts, cane sugar for priming only. Historical examples using 45% 2 row, 30% higher protein malt (6 row) would use around 25% sugar to dilute the nitrogen content. Traditionally used Australian hops, Cluster, and Goldings until replaced from mid-1960s by Pride of Ringwood. Highly attenuative Burton-type yeast (Australian-type strain typical). Variable water profile, typically with low carbonate and moderate sulfate.",
			'style_comparison'			=>	"Superficially similar to English Pale Ales, although much more highly carbonated, with less caramel, less late hops, and showcasing the signature yeast strain and hop variety. More bitter than IBUs might suggest due to high attenuation, low final gravity, and somewhat coarse hops. ",
			'commercial_examples'			=>	"Coopers Original Pale Ale, Coopers Sparkling Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.01",
			'fg_max'			=>	"1.018",
			'overall_impression'			=>	"A hoppy, moderately-strong, very well-attenuated pale British ale with a dry finish and a hoppy aroma and flavor. Classic British ingredients provide the best flavor profile. ",
			...
			'characteristic_ingredients'			=>	"Pale ale malt. English hops are traditional, particularly as finishing hops. Attenuative British ale yeast. Refined sugar may be used in some versions. Some versions may show a sulfate character from Burton-type water, but this is not essential to the style.",
			'style_comparison'			=>	"Generally will have more finish hops and less fruitiness and/or caramel than British pale ales and bitters. Has less hop intensity and a more pronounced malt flavor than typical American versions.",
			'commercial_examples'			=>	"Freeminer Trafalgar IPA, Fullers Bengal Lancer IPA, Meantime India Pale Ale, Ridgeway IPA, Summit True Brit IPA, Thornbridge Jaipur, Worthington White Shield",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Style Comparison: Some versions may seem like lower-gravity modern English porters. Much less sweet than London Brown Ale.",
			'style_comparison'			=>	"Characteristic Ingredients: Pale British base malts (often fairly dextrinous), crystal malt, dark malts or dark sugar adjuncts, may also include adjuncts such as flaked maize, and may be colored with brewer’s caramel. Characterful British ale yeast. Any type of hops, since their character is muted and rarely is noticeable.",
			'commercial_examples'			=>	"Bankss Mild, Cains Dark Mild, Highgate Dark Mild, Brain’s Dark, Moorhouse Black Cat, Rudgate Ruby Mild, Theakston Traditional Mild",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Maxim Double Maxim, Newcastle Brown Ale, Riggwelter Yorkshire Ale, Samuel Smith’s Nut Brown Ale, Wychwood Hobgoblin",
			'bjcp_categories_id'			=>	"13B",
			'styles'			=>	"British Brown Ale",
			'bugu_min'			=>	"0.38",
			'bugu_max'			=>	"0.5",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'style_comparison'			=>	"Differs from an American Porter in that it usually has softer, sweeter and more caramelly flavors, lower gravities, and usually less alcohol, the American Porter will also typically have more of a hop character. More substance and roast than a British Brown Ale. Higher in gravity than a dark mild.",
			'commercial_examples'			=>	"Burton Bridge Burton Porter, Fullers London Porter, Nethergate Old Growler Porter, RCH Old Slug Porter, Samuel Smith Taddy Porter",
			'notes'			=>	"Simply called “Porter” in Britain, the name “English Porter” is used to differentiate it from other porters described in these guidelines. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat-smoked malt is inauthentic and inappropriate.",
			'style_comparison'			=>	"Similar character to a Wee Heavy, but much smaller. Similar in color to a Dark Mild, but a little weaker in strength.",
			'commercial_examples'			=>	"McEwans 60",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'commercial_examples'			=>	"Broughton Greenmantle Ale, Caledonia Smooth, McEwans 70, Orkney Raven Ale, Tennent’s Special Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Originally used Scottish pale malt, grits or flaked maize, and brewers caramel for color. Later adapted to use additional ingredients, such as amber and brown malts, crystal and wheat malts, and roasted grains or dark sugars for color but not for the ‘roasty’ flavor. Sugar adjuncts are traditional. Clean or slightly fruity yeast. Peat-smoked malt is inauthentic and inappropriate.",
			'style_comparison'			=>	"Similar character to a Wee Heavy, but much smaller.",
			'commercial_examples'			=>	"Belhaven Scottish Ale, Broughton Exciseman’s Ale, Orkney Dark Island, Pelican MacPelican’s Scottish Style Ale, Weasel Boy Plaid Ferret Scottish Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Guinness is made using roasted barley, flaked barley, and pale malt, but other breweries don’t necessarily use roasted barley, they can use chocolate or other dark and specialty malts. Whatever combination of malts or grains is used, the resulting product should be black. Cork-type stouts are perhaps closer to historical London-type stouts in composition with a varied grist not dominated by roasted barley.",
			'style_comparison'			=>	"Lower strength than an Irish Extra Stout, but with similar flavors. Darker in color (black) than an English porter (brown).",
			'commercial_examples'			=>	"Beamish Irish Stout, Guinness Draught, Harpoon Boston Irish Stout, Murphys Irish Stout, O’Hara’s Irish Stout, Porterhouse Wrasslers 4X",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'style_comparison'			=>	"Midway between an Irish Stout and a Foreign Extra Stout in strength and flavor intensity, although with a similar balance. More body, richness, and often malt complexity than an Irish Stout. Black in color, not brown like a porter.",
			'commercial_examples'			=>	"Guinness Extra Stout (US version), O’Hara’s Leann Folláin, Sheaf Stout",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pale, caramel and dark roasted malts (often chocolate) and grains. Oatmeal or malted oats (5-20% or more) used to enhance fullness of body and complexity of flavor. Hops primarily for bittering. Can use brewing sugars or syrups. English ale yeast.",
			'style_comparison'			=>	"Most are like a cross between an Irish Extra Stout and a Sweet Stout with oatmeal added. Several variations exist, with the sweeter versions more like a Sweet Stout with oatmeal instead of lactose, and the drier versions more like a more nutty, flavorful Irish Extra Stout. Both tend to emphasize the body and mouthfeel.",
			'commercial_examples'			=>	"Anderson Valley Barney Flats Oatmeal Stout, Broughton Scottish Oatmeal Stout, Figueroa Mountain Stagecoach Stout, St-Ambroise Oatmeal Stout, Samuel Smith Oatmeal Stout, Youngs Oatmeal Stout",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Grists vary, often based on pale malt with caramel and specialty malts. Some darker examples suggest that dark malts (e.g., chocolate, black malt) may be appropriate, though sparingly so as to avoid an overly roasted character. Sugary adjuncts are common, as are starchy adjuncts (maize, flaked barley, wheat). Finishing hops are traditionally English. ",
			'style_comparison'			=>	"Significant overlap in gravity with old ales, but not having a stale or aged character. A wide range of interpretations is possible. Should not be as rich or strong as an English Barleywine. Stronger than the stronger everyday beers (strong bitters, brown ales, porters). More specialty malt and/or sugar character than American Strong Ales.",
			'commercial_examples'			=>	"Fuller’s 1845, Harvey’s Elizabethan Ale, J.W. Lees Manchester Star, Samuel Smith’s Winter Welcome, Youngs Winter Warmer",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Composition varies, although generally similar to British Strong Ales. The age character is the biggest driver of the final style profile, which is more handling than brewing. May be aged in wood, but should not have a strong wood character.",
			'style_comparison'			=>	"Roughly overlapping the British Strong Ale and the lower end of the English Barleywine styles, but always having an aged quality. The distinction between an Old Ale and a Barleywine is somewhat arbitrary above 7% ABV, and generally means having a more significant aged quality (particularly from wood). Barleywines tend to develop more of a ‘mature’ quality, while Old Ales can show more of the barrel qualities (lactic, Brett, vinous, etc.).",
			'commercial_examples'			=>	"Burton Bridge Olde Expensive, Gale’s Prize Old Ale, Greene King Strong Suffolk Ale, Marston Owd Roger, Theakston Old Peculier",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Well-modified pale malt, with roasted barley for color. May use some crystal malt for color adjustment. Slight smoke character may be present in some versions, but derives from roasted grains or from the boil. Peated malt is absolutely not traditional.",
			'style_comparison'			=>	"Somewhat similar to an English Barleywine.",
			'commercial_examples'			=>	"Belhaven Wee Heavy, Gordon Highland Scotch Ale, Inveralmond Blackfriar, McEwans Scotch Ale, Orkney Skull Splitter, Traquair House Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"High-quality, well-modified pale malt should form the backbone of the grist, with judicious amounts of caramel malts. Dark malts should be used with great restraint, if at all, as most of the color arises from a lengthy boil. English hops such as Northdown, Target, East Kent Goldings and Fuggles are typical. Characterful British yeast.",
			'style_comparison'			=>	"Although often a hoppy beer, the English Barleywine places less emphasis on hop character than the American Barleywine and features English hops. English versions can be darker, maltier, fruitier, and feature richer specialty malt flavors than American Barleywines. Has some overlap British Old Ale on the lower end, but generally does not have the vinous qualities of age, rather, it tends to display the mature, elegant signs of age. ",
			'commercial_examples'			=>	"Adnams Tally-Ho, Burton Bridge Thomas Sykes Old Ale, Coniston No. 9 Barley Wine, Fuller’s Golden Pride, J.W. Lee’s Vintage Harvest Ale, Robinson’s Old Tom",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.008",
			'fg_max'			=>	"1.013",
			'overall_impression'			=>	"Easy-drinking, approachable, malt-oriented American craft beer, often with interesting fruit, hop, or character malt notes. Well-balanced and clean, is a refreshing pint without aggressive flavors.",
			...
			'characteristic_ingredients'			=>	"Generally all malt, but can include up to 25% wheat malt and some sugar adjuncts. Any hop variety can be used. Clean American, lightly fruity English, or Kölsch yeast. May also be made with lager yeast, or cold-conditioned. Some versions may have honey, spices and/or fruit added, although if any of these ingredients are stronger than a background flavor they should be entered in those specialty categories instead. ",
			'style_comparison'			=>	"Typically has more flavor than American Lagers and Cream Ales. Less bitterness than an American Pale Ale.",
			'commercial_examples'			=>	"Kona Big Wave Golden Ale, Pelican Kiwanda Cream Ale, Russian River Aud Blonde, Victory Summer Love, Widmer Citra Summer Blonde Brew",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pale ale malt, typically North American two-row. American or New World hops, with a wide range of allowable characteristics. American or English ale yeast (neutral to lightly fruity). Specialty grains may add character and complexity, but generally make up a relatively small portion of the grist. Grains that add malt flavor and richness, light sweetness, and toasty or bready notes are often used (along with late hops) to differentiate brands.",
			'style_comparison'			=>	"Typically lighter in color, cleaner in fermentation by-products, and having less caramel flavors than English counterparts. There can be some overlap in color between American pale ale and American amber ale. The American pale ale will generally be cleaner, have a less caramelly malt profile, less body, and often more finishing hops. Less bitterness in the balance and alcohol strength than an American IPA. More balanced and drinkable, and less intensely hop-focused and bitter than session-strength American IPAs (aka Session IPAs).",
			'commercial_examples'			=>	"Ballast Point Grunion Pale Ale, Firestone Walker Pale 31, Great Lakes Burning River, Sierra Nevada Pale Ale, Stone Pale Ale, Tröegs Pale Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pale ale malt, non-citrusy hops (often Northern Brewer), small amounts of toasted malt and/or crystal malts. Lager yeast, however, some strains (often with the mention of “California” in the name) work better than others at the warmer fermentation temperatures (55 to 60 °F) typically used. Note that some German yeast strains produce inappropriate sulfury character. ",
			'style_comparison'			=>	"Superficially similar to an American Amber Ale, but with specific choices for malt and hopping – the hop flavor/aroma is traditional (not modern) American hops, malt flavors are more toasty, the hopping is always assertive, and a warm-fermented lager yeast is used. Less attenuated, less carbonated and less fruity than Australian Sparkling ale.",
			'commercial_examples'			=>	"Anchor Steam, Flying Dog Old Scratch Amber Lager, Schlafly Pi Common, Steamworks Steam Engine Lager",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"May contain several malts, prominently dark malts, which often include black malt (chocolate malt is also often used). American hops typically used for bittering, but US or UK finishing hops can be used, a clashing citrus quality is generally undesirable. Ale yeast can either be clean US versions or characterful English varieties.",
			'style_comparison'			=>	"More bitter and often stronger with more dark malt qualities and dryness than English Porters or Pre-Prohibition Porters. Less strong and assertive than American Stouts.",
			'commercial_examples'			=>	"Anchor Porter, Boulevard Bully! Porter, Deschutes Black Butte Porter, Founders Porter, Great Lakes Edmund Fitzgerald Porter, Smuttynose Robust Porter, Sierra Nevada Porter",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Well-modified pale malt, with generous quantities of roasted malts and/or grain. May have a complex grain bill using virtually any variety of malt. Any type of hops may be used. American or English ale yeast.",
			'style_comparison'			=>	"Like a black barleywine with every dimension of flavor coming into play. More complex, with a broader range of possible flavors than lower-gravity stouts. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pale ale or 2-row brewers malt as the base, American or New World hops, American or English yeast with a clean or slightly fruity profile. Generally all-malt, but mashed at lower temperatures for high attenuation. Sugar additions to aid attenuation are acceptable. Restrained use of crystal malts, if any, as high amounts can lead to a sweet finish and clash with the hop character.",
			'style_comparison'			=>	"Stronger and more highly hopped than an American Pale Ale. Compared to an English IPA, has less of the “English” character from malt, hops, and yeast (less caramel, bread, and toast, more American/New World hops than English, less yeast-derived esters), less body, and often has a more hoppy balance and is slightly stronger than most examples. Less alcohol than a Double IPA, but with a similar balance.",
			'commercial_examples'			=>	"Alpine Duet, Bell’s Two-Hearted Ale, Fat Heads Head Hunter IPA, Firestone Walker Union Jack, Lagunitas IPA, Russian River Blind Pig IPA, Stone IPA",
			'bjcp_categories_id'			=>	"21A",
			'styles'			=>	"American IPA",
			'bugu_min'			=>	"0.83",
			'bugu_max'			=>	"0.93",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.008",
			'fg_max'			=>	"1.016",
			'overall_impression'			=>	"An IPA with the fruitiness and spiciness derived from the use of Belgian yeast. The examples from Belgium tend to be lighter in color and more attenuated, similar to a tripel that has been brewed with more hops. This beer has a more complex flavor profile and may be higher in alcohol than a typical IPA.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.01",
			'fg_max'			=>	"1.018",
			'overall_impression'			=>	"A beer with the dryness, hop-forward balance, and flavor characteristics of an American IPA, only darker in color – but without strongly roasted or burnt flavors. The flavor of darker malts is gentle and supportive, not a major flavor component. Drinkability is a key characteristic.",
			...
			'characteristic_ingredients'			=>	"Debittered roast malts for color and some flavor without harshness and burnt qualities, American or New World hop varieties that don’t clash with roasted malts. Hop characteristics cited are typical of these type of hops, others characteristics are possible, particularly if derived from newer varietals.",
			'style_comparison'			=>	"Balance and overall impression of an American or Double IPA with restrained roast similar to the type found in Schwarzbiers. Not as roasty-burnt as American stouts and porters, and with less body and increased smoothness and drinkability. ",
			'commercial_examples'			=>	"21st Amendment Back in Black (standard), Deschutes Hop in the Dark CDA (standard), Rogue Dad’s Little Helper (standard), Southern Tier Iniquity (double), Widmer Pitch Black IPA (standard)",
			'notes'			=>	"Specialty IPA isn’t a distinct style, but is more appropriately thought of as a competition entry category. Beers entered as this style are not experimental beers, they are a collection of currently produced types of beer that may or may not have any market longevity. This category also allows for expansion, so potential future IPA variants (St. Patrick’s Day Green IPA, Romulan Blue IPA, Zima Clear IPA, etc.) have a place to be entered without redoing the style guidelines. The only common element is that they have the balance and overall impression of an IPA (typically, an American IPA) but with some minor tweak. The term ‘IPA’ is used as a singular descriptor of a type of hoppy, bitter beer. It is not meant to be spelled out as ‘India Pale Ale’ when used in the context of a Specialty IPA. None of these beers ever historically went to India, and many aren’t pale. But the craft beer market knows what to expect in balance when a beer is described as an ‘IPA’ – so the modifiers used to differentiate them are based on that concept alone.",
			'bjcp_categories_id'			=>	"21B",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Similar to an American IPA, but with medium or dark crystal malts, lightly roasted chocolate-type malts, or other intermediate color character malts. May use sugar adjuncts, including brown sugar. American or New World finishing hops with tropical, fruity, citrusy, piney, berry, or melon aspects, the choice of hops and character malts is synergistic – they very much have to complement each other and not clash.",
			'style_comparison'			=>	"A stronger and more bitter version of an American Brown Ale, with the balance of an American IPA.",
			'commercial_examples'			=>	"Dogfish Head Indian Brown Ale, Grand Teton Bitch Creek, Harpoon Brown IPA, Russian River Janet’s Brown Ale",
			'notes'			=>	"Specialty IPA isn’t a distinct style, but is more appropriately thought of as a competition entry category. Beers entered as this style are not experimental beers, they are a collection of currently produced types of beer that may or may not have any market longevity. This category also allows for expansion, so potential future IPA variants (St. Patrick’s Day Green IPA, Romulan Blue IPA, Zima Clear IPA, etc.) have a place to be entered without redoing the style guidelines. The only common element is that they have the balance and overall impression of an IPA (typically, an American IPA) but with some minor tweak. The term ‘IPA’ is used as a singular descriptor of a type of hoppy, bitter beer. It is not meant to be spelled out as ‘India Pale Ale’ when used in the context of a Specialty IPA. None of these beers ever historically went to India, and many aren’t pale. But the craft beer market knows what to expect in balance when a beer is described as an ‘IPA’ – so the modifiers used to differentiate them are based on that concept alone.",
			'bjcp_categories_id'			=>	"21B",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Similar to an American IPA, but with medium or dark crystal malts, possibly some character malts with a light toasty aspect. May use sugar adjuncts. American or New World finishing hops with tropical, fruity, citrusy, piney, berry, or melon aspects, the choice of hops and character malts is synergistic – they very much have to complement each other and not clash.",
			'style_comparison'			=>	"Similar to the difference between an American Amber Ale and an American Pale Ale, a Red IPA will differ from an American IPA with the addition of some darker crystal malts giving a slightly sweeter, more caramelly and dark fruit-based balance. A Red IPA differs from an American Strong Ale in that the malt profile is less intense and there is less body, a Red IPA still has an IPA balance and doesn’t trend towards a barleywine-like malt character. A Red IPA is like a stronger, hoppier American Amber Ale, with the characteristic dry finish, medium-light body, and strong late hop character.",
			'commercial_examples'			=>	"Green Flash Hop Head Red Double Red IPA (double), Midnight Sun Sockeye Red, Sierra Nevada Flipside Red IPA, Summit Horizon Red IPA, Odell Runoff Red IPA",
			'notes'			=>	"Specialty IPA isn’t a distinct style, but is more appropriately thought of as a competition entry category. Beers entered as this style are not experimental beers, they are a collection of currently produced types of beer that may or may not have any market longevity. This category also allows for expansion, so potential future IPA variants (St. Patrick’s Day Green IPA, Romulan Blue IPA, Zima Clear IPA, etc.) have a place to be entered without redoing the style guidelines. The only common element is that they have the balance and overall impression of an IPA (typically, an American IPA) but with some minor tweak. The term ‘IPA’ is used as a singular descriptor of a type of hoppy, bitter beer. It is not meant to be spelled out as ‘India Pale Ale’ when used in the context of a Specialty IPA. None of these beers ever historically went to India, and many aren’t pale. But the craft beer market knows what to expect in balance when a beer is described as an ‘IPA’ – so the modifiers used to differentiate them are based on that concept alone.",
			'bjcp_categories_id'			=>	"21B",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pale ale or 2-row brewers malt as the base, 15-20% Rye malt, American or New World hops, American or English yeast with a clean or slightly fruity profile. Generally all-malt, but mashed at lower temperatures for high attenuation. Sugar additions to aid attenuation are acceptable. Water character varies from soft to moderately sulfate. Restrained use of crystal malts, if any, as high amounts can lead to a sweet finish and clash with the hop character.",
			'style_comparison'			=>	"Drier and slightly spicier than an American IPA. Bitterness and spiciness from rye lingers longer than an American IPA. Does not have the intense rye malt character of a Roggenbier. Some examples are stronger like a Double IPA.",
			'commercial_examples'			=>	"Arcadia Sky High Rye, Bear Republic Hop Rod Rye, Founders Reds Rye, Great Lakes Rye of the Tiger, Sierra Nevada Ruthless Rye",
			'notes'			=>	"Specialty IPA isn’t a distinct style, but is more appropriately thought of as a competition entry category. Beers entered as this style are not experimental beers, they are a collection of currently produced types of beer that may or may not have any market longevity. This category also allows for expansion, so potential future IPA variants (St. Patrick’s Day Green IPA, Romulan Blue IPA, Zima Clear IPA, etc.) have a place to be entered without redoing the style guidelines. The only common element is that they have the balance and overall impression of an IPA (typically, an American IPA) but with some minor tweak. The term ‘IPA’ is used as a singular descriptor of a type of hoppy, bitter beer. It is not meant to be spelled out as ‘India Pale Ale’ when used in the context of a Specialty IPA. None of these beers ever historically went to India, and many aren’t pale. But the craft beer market knows what to expect in balance when a beer is described as an ‘IPA’ – so the modifiers used to differentiate them are based on that concept alone.",
			'bjcp_categories_id'			=>	"21B",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.008",
			'fg_max'			=>	"1.018",
			'overall_impression'			=>	"An intensely hoppy, fairly strong pale ale without the big, rich, complex maltiness and residual sweetness and body of an American barleywine. Strongly hopped, but clean, dry, and lacking harshness. Drinkability is an important characteristic, this should not be a heavy, sipping beer.",
			...
			'characteristic_ingredients'			=>	"Clean 2-row malt is typical as a base grain, an excessively complex grist can be distracting. Crystal-type malts often muddy the hop flavors, and are generally considered undesirable in significant quantities. Sugar or other highly fermentable adjuncts are often used to increase attenuation, as are lower-temperature mash rests. Can use a complex variety of hops, typically American or New World, often with cutting-edge profiles providing distinctive differences. Modern hops with unusual characteristics are not out of style. American yeast that can give a clean or slightly fruity profile.",
			'style_comparison'			=>	"Bigger than either an English or American IPA in both alcohol strength and overall hop level (bittering and finish). Less malty, lower body, less rich and a greater overall hop intensity than an American Barleywine. Typically not as high in gravity/alcohol as a barleywine, since high alcohol and malt tend to limit drinkability.",
			'commercial_examples'			=>	"Avery Maharaja, Fat Heads Hop Juju, Firestone Walker Double Jack, Port Brewing Hop 15, Russian River Pliny the Elder, Stone Ruination IPA, Three Floyds Dreadnaught",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.014",
			'fg_max'			=>	"1.024",
			'overall_impression'			=>	"A strong, full-flavored American ale that challenges and rewards the palate with full malty and hoppy flavors and substantial bitterness. The flavors are bold but complementary, and are stronger and richer than average-strength pale and amber American ales.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Well-modified pale malt should form the backbone of the grist. Some specialty or character malts may be used. Dark malts should be used with great restraint, if at all, as most of the color arises from a lengthy boil. New World hops are common, although any varieties can be used in quantity. Generally uses an attenuative American ale yeast.",
			'style_comparison'			=>	"The American version of the Barleywine tends to have a greater emphasis on hop bitterness, flavor and aroma than the English Barleywine, and often features American hop varieties. Typically paler than the darker English Barleywines (and lacking in the deeper malt flavors) but darker than the golden English Barleywines. Differs from a Double IPA in that the hops are not extreme, the malt is more forward, and the body is fuller and often richer. An American Barleywine typically has more residual sweetness than a Double IPA, which affects the overall drinkability (sipping vs. drinking).",
			'commercial_examples'			=>	"Avery Hog Heaven Barleywine, Anchor Old Foghorn, Great Divide Old Ruffian, Rogue Old Crustacean, Sierra Nevada Bigfoot, Victory Old Horizontal",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Typically brewed with a combination of American two-row and American wheat. Style commonly uses 50% or more wheat malt. Any variety of hops may be used. May be oak-aged.",
			'style_comparison'			=>	"More than simply a wheat-based barleywine, many versions have very expressive fruity and hoppy notes, while others develop complexity through oak aging. Less emphasis on the hops than American Barleywine. Has roots in American Wheat Beer rather than any German wheat styles, so should not have any German weizen yeast character.",
			'commercial_examples'			=>	"Rubicon Winter Wheat Wine, Two Brothers Bare Trees Weiss Wine, Smuttynose Wheat Wine, Portsmouth Wheat Wine",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.003",
			'fg_max'			=>	"1.006",
			'overall_impression'			=>	"A very pale, refreshing, low-alcohol German wheat beer with a clean lactic sourness and a very high carbonation level. A light bread dough malt flavor supports the sourness, which shouldn’t seem artificial. Any Brettanomyces funk is restrained.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.002",
			'fg_max'			=>	"1.012",
			'overall_impression'			=>	"A sour, fruity, red wine-like Belgian-style ale with interesting supportive malt flavors and fruit complexity. The dry finish and tannin completes the mental image of a fine red wine.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'style_comparison'			=>	"More complex and carbonated than a lambic. The sourness isn’t necessarily higher, but it tends to have more of a well-developed wild character.",
			'commercial_examples'			=>	"Boon Oude Gueuze, Boon Oude Gueuze Mariage Parfait, Cantillon Gueuze, De Cam Gueuze, De Cam/Drei Fonteinen Millennium Gueuze, Drie Fonteinen Oud Gueuze, Girardin Gueuze (Black Label), Hanssens Oude Gueuze, Lindemans Gueuze Cuvée René, Mort Subite (Unfiltered) Gueuze, Oud Beersel Oude Gueuze",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.008",
			'fg_max'			=>	"1.012",
			'overall_impression'			=>	"A refreshing, elegant, tasty, moderate-strength wheat-based ale.",
			...
			'characteristic_ingredients'			=>	"About 50% unmalted wheat and 50% pale barley malt (usually Pils malt) constitute the grist. In some versions, up to 5-10% raw oats may be used. Spices of freshly-ground coriander and Curaçao or sometimes sweet orange peel complement the sweet aroma and are quite characteristic. Other spices (e.g., chamomile, cumin, cinnamon, Grains of Paradise) may be used for complexity but are much less prominent. Ale yeast prone to the production of mild, spicy flavors is very characteristic. In some instances a very limited lactic fermentation, or the actual addition of lactic acid, is done.",
			'style_comparison'			=>	"Low bitterness level with a balance similar to a Weissbier, but with spice and citrus character coming from additions rather than the yeast.",
			'commercial_examples'			=>	"Allagash White, Blanche de Bruxelles, Celis White, Hoegaarden Wit, Ommegang Witte, St. Bernardus Witbier, Wittekerke",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pilsner or pale ale malt contributes the bulk of the grist with (cara) Vienna and Munich malts adding color, body and complexity. Sugar is not commonly used as high gravity is not desired. Saazer-type hops, Styrian Goldings, East Kent Goldings or Fuggles are commonly used. Yeasts prone to moderate production of phenols are often used but fermentation temperatures should be kept moderate to limit this character.",
			'style_comparison'			=>	"Fairly similar to pale ales from England (Strong Bitter category), typically with a slightly different yeast character and a more varied malt profile. Less yeast character than many other Belgian beers, though.",
			'commercial_examples'			=>	"De Koninck, De Ryck Special, Palm Dobble, Palm Speciale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and phenolics are commonly used. Impression of complex grain bill, although traditional versions are typically Belgian Pils malt with caramelized sugar syrup or other unrefined sugars providing much of the character. Saazer-type, English-type or Styrian Goldings hops commonly used. No spices are traditionally used, although restrained use is allowable (background strength only).",
			'style_comparison'			=>	"Should not be as malty as a bock and should not have crystal malt-type sweetness. Similar in strength and balance as a Belgian Blond, but with a richer malt and ester profile. Less strong and intense as a Belgian Dark Strong Ale.",
			'commercial_examples'			=>	"Affligem Dubbel, Chimay Première, Corsendonk Pater, Grimbergen Double, La Trappe Dubbel, St. Bernardus Pater 6, Trappistes Rochefort 6, Westmalle Dubbel",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Belgian yeast strains prone to production of higher alcohols, esters, and sometimes phenolics are commonly used. Impression of a complex grain bill, although many traditional versions are quite simple, with caramelized sugar syrup or unrefined sugars and yeast providing much of the complexity. Saazer-type, English-type or Styrian Goldings hops commonly used. Spices generally not used, if used, keep subtle and in the background. ",
			'style_comparison'			=>	"Like a larger dubbel, with a fuller body and increased malt richness. Not as bitter or hoppy as a tripel, but of similar strength.",
			'commercial_examples'			=>	"Achel Extra Brune, Boulevard The Sixth Glass, Chimay Grande Réserve, Gouden Carolus Grand Cru of the Emperor, Rochefort 8 & 10, St. Bernardus Abt 12, Westvleteren 12",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Pilsner and wheat malt, restrained use of salt and coriander seed, lactobacillus. The coriander should have a fresh, citrusy (lemon or bitter orange), bright note, and not be vegetal, celery-like, or ham-like. The salt should have a sea salt or fresh salt character, not a metallic, iodine note.",
			'style_comparison'			=>	"Perceived acidity is not as intense as Berliner Weisse or Gueuze. Restrained use of salt, coriander, and lactobacillus – should not taste overtly salty. Coriander aroma can be similar to a witbier. Haziness similar to a Weissbier.",
			'commercial_examples'			=>	"Anderson Valley Gose, Bayerisch Bahnhof Leipziger Gose, Döllnitzer Ritterguts Gose",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.01",
			'fg_max'			=>	"1.018",
			'overall_impression'			=>	"A darker-colored, light-flavored, malt-accented beer with a dry finish and interesting character malt flavors. Refreshing due to its high carbonation and mild flavors, and highly sessionable due to being served very fresh and with restrained alcohol levels.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"English pale ale malt as a base with a healthy proportion of darker caramel malts and often some roasted (black) malt and wheat malt (this is Mann’s traditional grist – others can rely on dark sugars for color and flavor). Moderate to high carbonate water. English hop varieties are most authentic, though with low flavor and bitterness almost any type could be used. Post-fermentation sweetening with lactose or artificial sweeteners, or sucrose (if pasteurized).",
			'style_comparison'			=>	"May seem somewhat like a less roasty version of a sweet stout (and lower-gravity, at least for US sweet stout examples) or a sweet version of a dark mild.",
			'commercial_examples'			=>	"Harveys Bloomsbury Brown Ale, Manns Brown Ale",
			'bjcp_categories_id'			=>	"27A",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"1.006",
			'fg_max'			=>	"1.012",
			'overall_impression'			=>	"A low-gravity, highly-carbonated, light-bodied ale combining an oak-smoked flavor with a clean hop bitterness. Highly sessionable.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Malted barley along with malted and unmalted grains, often rye. Low hops. Juniper boughs used for lautering (traditionally in a hollowed-out log), but often producing a juniper/berry character. Often uses top-fermenting baker’s yeast in a fast, warm fermentation (German Weizen yeast is a good substitute). Not boiled, a long mash steep is used, with a separately added hop tea.",
			'style_comparison'			=>	"Strong resemblance to Weizenbocks, but sweet and thick with a rye and juniper character.",
			'commercial_examples'			=>	"Now made year-round by several breweries in Finland.",
			'bjcp_categories_id'			=>	"27A",
			'styles'			=>	"Sahti",
		]);
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'characteristic_ingredients'			=>	"Virtually any style of beer, fermented in any manner, then finished with one or more strains of Brett. Alternatively, a beer made with Brett as the sole fermentation strain.",
			...
			'commercial_examples'			=>	"Boulevard Saison Brett, Hill Farmstead Arthur, Logsdon Seizoen Bretta, Russian River Sanctification, The Bruery Saison Rue, Victory Helios",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A sour and/or funky version of a base style of beer.",
			...
			'flavor'			=>	" some haze is not a fault. Head retention can be poor due to high levels of acid or anti-foam properties of some lactobacillus strains.",
			'mouthfeel'			=>	"Variable by base style. Look for an agreeable balance between the base beer and the fermentation character. A range of results is possible from fairly high acidity/funk to a subtle, pleasant, harmonious beer. The best examples are pleasurable to drink with the esters and phenols complementing the malt and/or hops. The wild character can be prominent, but does not need to be dominating in a style with an otherwise strong malt/hop profile. Acidity should be firm yet enjoyable, but should not be biting or vinegary, prominent or objectionable/offensive acetic acid is a fault. Bitterness tends to be low, especially as sourness increases.",
			'comments'			=>	"Variable by base style. Generally a light body, almost always lighter than what might be expected from the base style. Generally moderate to high carbonation, although often lower in higher alcohol examples.",
			'history'			=>	"These beers may be aged in wood, but any wood character should not be a primary or dominant flavor. Sour beers are typically not bitter as these flavors clash. The base beer style becomes less relevant because the various yeast and bacteria tend to dominate the profile. Inappropriate characteristics include diacetyl, solvent, ropy/viscous texture, and heavy oxidation.",
			'characteristic_ingredients'			=>	"Modern American craft beer interpretations of Belgian sour ales, or experimentations inspired by Belgian sour ales.",
			'style_comparison'			=>	"Virtually any style of beer. Usually fermented by Lactobacillus and/or Pediococcus, often in conjunction with Saccharomyces and/or Brettanomyces. Can also be a blend of styles. Wood or barrel aging is very common, but not required.",
			'commercial_examples'			=>	"A sour and/or funky version of a base style.",
			'notes'			=>	"Boulevard Love Child, Cascade Vlad the Imp Aler, Jester King Le Petit Prince, Jolly Pumpkin Calabaza Blanca, Russian River Temptation, The Bruery Rueuze, The Bruery Tart of Darkness",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A sour and/or funky version of a fruit, herb, or spice beer, or a wild beer aged in wood. If wood-aged, the wood should not be the primary or dominant character.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious marriage of fruit and beer, but still recognizable as a beer. The fruit character should be evident but in balance with the beer, not so forward as to suggest an artificial product.",
			...
			'mouthfeel'			=>	"Mouthfeel may vary depending on the base beer selected and as appropriate to that base beer. Body and carbonation levels should be appropriate to the declared base beer style. Fruit generally adds fermentables that tend to thin out the beer",
			'comments'			=>	" the resulting beer may seem lighter than expected for the declared base style. Smaller and darker fruit have a tendency to add a tannic depth that should overwhelm the base beer.",
			'history'			=>	"Overall balance is the key to presenting a well-made fruit beer. The fruit should complement the original style and not overwhelm it. The key attributes of the underlying style will be different with the addition of fruit",
			'characteristic_ingredients'			=>	" do not expect the base beer to taste the same as the unadulterated version. Judge the beer based on the pleasantness and balance of the resulting combination.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious marriage of fruit, spice, and beer, but still recognizable as a beer. The fruit and spice character should each be evident but in balance with the beer, not so forward as to suggest an artificial product.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious marriage of fruit, sugar, and beer, but still recognizable as a beer. The fruit and sugar character should both be evident but in balance with the beer, not so forward as to suggest an artificial product.",
			...
			'notes'			=>	"A Specialty Fruit Beer is a fruit beer with some additional ingredients or processes, such as fermentable sugars (honey, brown sugar, invert sugar, etc.) added.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious marriage of SHV and beer, but still recognizable as a beer. The SHV character should be evident but in balance with the beer, not so forward as to suggest an artificial product. ",
			...
			'commercial_examples'			=>	"Alesmith Speedway Stout, Bell’s Java Stout, Elysian Avatar Jasmine IPA, Founders Breakfast Stout, Rogue Chipotle Ale, Traquair Jacobite Ale, Young’s Double Chocolate Stout,",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"An amber to copper, spiced beer that often has a moderately rich body and slightly warming finish suggesting a good accompaniment for the cool fall season, and often evocative of Thanksgiving traditions.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A stronger, darker, spiced beer that often has a rich body and warming finish suggesting a good accompaniment for the cold winter season.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A base beer enhanced by or featuring the character of additional grain or grains. The specific character depends greatly on the character of the added grains.",
			...
			'commercial_examples'			=>	"Green’s Indian Pale Ale, Lakefront New Grist, New Planet Pale Ale",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious marriage of sugar and beer, but still recognizable as a beer. The sugar character should both be evident but in balance with the beer, not so forward as to suggest an artificial product.",
			...
			'commercial_examples'			=>	"Bell’s Hopslam, Fullers Honey Dew, Lagunitas Brown Shugga’",
			'notes'			=>	"An Alternative Fermentables Beer is a standard beer (Classic Style or not) with additional fermentable sugars (e.g., honey, brown sugar, invert sugar, molasses, treacle, maple syrup, sorghum, etc.) added.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A smoke-enhanced beer showing good balance between the smoke and beer character, while remaining pleasant to drink. Balance in the use of smoke, hops and malt character is exhibited by the better examples.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A smoke-enhanced beer showing good balance between the smoke, the beer character, and the added ingredients, while remaining pleasant to drink. Balance in the use of smoke, hops and malt character is exhibited by the better examples.",
			...
			'notes'			=>	"A Specialty Smoked Beer is either a smoked beer based on something other than a Classic Style, or any type of smoked beer with additional ingredients (fruits, vegetables, spices) or processes employed that transform the beer into something more unique.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious blend of the base beer style with characteristics from aging in contact with wood. The best examples will be smooth, flavorful, well-balanced and well-aged. ",
			...
			'characteristic_ingredients'			=>	"Varies with base style. Aged in wooden casks or barrels, or using wood-based additives (wood chips, wood staves, oak essence). Fuller-bodied, higher-gravity base styles often are used since they can best stand up to the additional flavors, although experimentation is encouraged.",
			'commercial_examples'			=>	"Bush Prestige, Cigar City Humidor India Pale Ale, Faust Holzfassgereifter Eisbock, Firestone Walker Double Barrel Ale, Great Divide Oak Aged Yeti Imperial Stout, Petrus Aged Pale, Samuel Smith Yorkshire Stingo",
			'notes'			=>	"This style is intended for beer aged in wood without added alcohol character from previous use of the barrel. Bourbon-barrel or other similar beers should be entered as a Specialty Wood-Aged Beer.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"A harmonious blend of the base beer style with characteristics from aging in contact with wood (including alcoholic products previously in contact with the wood). The best examples will be smooth, flavorful, well-balanced and well-aged. ",
			...
			'characteristic_ingredients'			=>	"Varies with base style. Aged in wooden casks or barrels previously used to store alcohol (e.g., whiskey, bourbon, port, sherry, Madeira, wine, etc). Fuller-bodied, higher-gravity base styles often are used since they can best stand up to the additional flavors, although experimentation is encouraged.",
			'commercial_examples'			=>	"Founders Kentucky Breakfast Stout, Goose Island Bourbon County Stout, J.W. Lees Harvest Ale in Port, Sherry, Lagavulin Whisky or Calvados Casks, The Lost Abbey Angel’s Share Ale, many microbreweries have specialty beers served only on premises often directly from the cask.",
			'notes'			=>	"This style is intended for beer aged in wood with added alcohol character from previous use of the barrel. Bourbon-barrel or other similar beers should be entered here.",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'fg_min'			=>	"0",
			'fg_max'			=>	"0",
			'overall_impression'			=>	"Based on the declared base styles. As with all Specialty-Type Beers, the resulting combination of beer styles needs to be harmonious and balanced, and be pleasant to drink.",
			...
			'notes'			=>	"This style is intended for combinations of existing styles (Classic Beers or Specialty-Type) that are not defined elsewhere in the guidelines. If a ‘mixed-style beer’ does fit another style, do not enter it here. ",
		...
		DB::table('eliseontwerpt_brouwerbouwer_bjcp_guide')->insert([
			...
			'notes'			=>	"This is explicitly a catch-all category for any beer that does not fit into an existing style description. No beer is ever “out of style” in this style, unless it fits elsewhere. This is the last resort for any beer entered into a competition.",
			'bjcp_categories_id'			=>	"34C",
			'styles'			=>	"Experimental Beer",
		]);
	}
}